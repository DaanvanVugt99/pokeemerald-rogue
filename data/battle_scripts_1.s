...
BattleScript_PsychicNoiseAromaVeil::
	savetarget
	copybyte gBattlerTarget, gEffectBattler
...
BattleScript_EffectPsychicNoiseHit::
...
BattleScript_SpicyExtractDoMoveAnimation:
	...
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript_SpicyExtractLowerDefense
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_SpicyExtractLowerDefense
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_SpicyExtractLowerDefense:
	setbyte sSTAT_ANIM_PLAYED, FALSE
	...
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_SpicyExtractEnd
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_EffectOrderUp:
	setmoveeffect MOVE_EFFECT_ORDER_UP | MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN
	goto BattleScript_EffectHit
...
BattleScript_EffectAromaticMistWorks:
	jumpifstat BS_TARGET, CMP_LESS_THAN, STAT_SPATK, MAX_STAT_STAGE, BattleScript_AromaticMistAnim
	jumpifstat BS_TARGET, CMP_EQUAL, STAT_SPDEF, MAX_STAT_STAGE, BattleScript_AromaticMistCantRaiseMultipleStats
BattleScript_AromaticMistAnim:
	attackanimation
	waitanimation
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_TARGET, BIT_SPATK | BIT_SPDEF, 0
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript_AromaticMistTrySpDef
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_AromaticMistTrySpDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_AromaticMistTrySpDef:
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript_EffectAromaticMistEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_EffectAromaticMistEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_EffectAromaticMistEnd
BattleScript_AromaticMistCantRaiseMultipleStats:
	copybyte gBattlerAttacker, gBattlerTarget
	pause B_WAIT_TIME_SHORT
	orhalfword gMoveResultFlags, MOVE_RESULT_FAILED
...
BattleScript_ShellSmashShellGame:
	...
	setstatchanger STAT_DEF, 1, TRUE
	statbuffchange STAT_CHANGE_ALLOW_PTR | STAT_CHANGE_NOT_PROTECT_AFFECTED, BattleScript_ShellSmashShellGameTrySpDef
...
BattleScript_ShellSmashShellGameTrySpDef:
	setstatchanger STAT_SPDEF, 1, TRUE
	statbuffchange STAT_CHANGE_ALLOW_PTR | STAT_CHANGE_NOT_PROTECT_AFFECTED, BattleScript_ShellSmashShellGameFinish
...
BattleScript_RockPolishDoMoveAnim:
	...
	waitanimation
	setbyte sSTAT_ANIM_PLAYED, FALSE
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPEED, MAX_STAT_STAGE, BattleScript_RockPolishDoSpDefOnly
...
BattleScript_RockPolishEnd:
	goto BattleScript_MoveEnd
BattleScript_RockPolishDoSpDefOnly:
	playstatchangeanimation BS_ATTACKER, BIT_SPDEF, 0
	goto BattleScript_RockPolishTrySpDef
...
.endif
	...
	waitmessage B_WAIT_TIME_LONG
	jumpifmove MOVE_SPIDER_WEB, BattleScript_SpiderWebLowerSpeed
	goto BattleScript_MoveEnd
BattleScript_SpiderWebLowerSpeed:
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_TARGET, BIT_SPEED, STAT_CHANGE_NEGATIVE
	setstatchanger STAT_SPEED, 1, TRUE
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript_MoveEnd
...
BattleScript_OverworldEclipseStarts::
	printfromtable gMoveWeatherChangeStringIds
	waitmessage B_WAIT_TIME_LONG
	playanimation_var BS_BATTLER_0, sB_ANIM_ARG1
	call BattleScript_ActivateWeatherAbilities
...
BattleScript_CrystalWandActivates::
	copybyte sBATTLER, gBattlerAttacker
	statbuffchange MOVE_EFFECT_AFFECTS_USER, BattleScript_CrystalWandActivatesRet
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_CrystalWandActivatesRet
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_EFFECT
	waitanimation
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	...
	printstring STRINGID_USINGITEMSTATOFPKMNROSE
	waitmessage B_WAIT_TIME_LONG
BattleScript_CrystalWandActivatesRet:
	return

BattleScript_HourglassActivates::
	copybyte sBATTLER, gBattlerAttacker
	statbuffchange MOVE_EFFECT_AFFECTS_USER, BattleScript_HourglassActivatesRet
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_HourglassActivatesRet
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_EFFECT
	waitanimation
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	...
	printstring STRINGID_USINGITEMSTATOFPKMNROSE
	waitmessage B_WAIT_TIME_LONG
BattleScript_HourglassActivatesRet:
	end2
...
BattleScript_MaliceOrbPhysical::
	copybyte sBATTLER, gBattlerAttacker
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_EFFECT
	waitanimation
	setbyte sSTAT_ANIM_PLAYED, FALSE
	...
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_MaliceOrbPhysicalTryDefense
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_MaliceOrbPhysicalTryDefense
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_MaliceOrbPhysicalTryDefense:
	playstatchangeanimation BS_ATTACKER, BIT_DEF, STAT_CHANGE_NEGATIVE
	setstatchanger STAT_DEF, 1, TRUE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_MaliceOrbEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_MaliceOrbEnd
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_MaliceOrbEnd

BattleScript_MaliceOrbSpecial::
	copybyte sBATTLER, gBattlerAttacker
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_EFFECT
	waitanimation
	setbyte sSTAT_ANIM_PLAYED, FALSE
	...
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_MaliceOrbSpecialTryDefense
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_MaliceOrbSpecialTryDefense
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_MaliceOrbSpecialTryDefense:
...
BattleScript_IronStampHazardsActivates::
	call BattleScript_AbilityPopUp
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	healthbarupdate BS_TARGET
	datahpupdate BS_TARGET
...
BattleScript_MoodyActivates::
	call BattleScript_AbilityPopUp
BattleScript_MoodyCharmActivates::
...
BattleScript_FlashFirestormActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
...
BattleScript_AvalancheHideActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
...
BattleScript_InfestedSurgeActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	printstring STRINGID_TERRAINBECOMESINFESTED
	waitmessage B_WAIT_TIME_LONG
	playanimation BS_SCRIPTING, B_ANIM_RESTORE_BG
	call BattleScript_ActivateTerrainEffects
	end3

BattleScript_CallAlliesActivates::
	call BattleScript_AbilityPopUp
	printstring STRINGID_TERRAINBECOMESINFESTED
	waitmessage B_WAIT_TIME_LONG
	playanimation BS_SCRIPTING, B_ANIM_RESTORE_BG
...
BattleScript_FlashFreezeActivates_PPLoss::
	ppreduce
...
BattleScript_IceFaceNullsDamageBlackIce::
	call BattleScript_TargetFormChangeWithString
	swapattackerwithtarget
	copybyte gBattlerAbility, gBattlerAttacker
	sethword sABILITY_OVERWRITE, ABILITY_BLACK_ICE
	call BattleScript_AbilityPopUp
	waitmessage B_WAIT_TIME_SHORT
	setbyte sB_ANIM_TURN, 0
	setbyte sB_ANIM_TARGETS_HIT, 0
...
BattleScript_FauxliageActivates::
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNCHANGEDTYPEWITH
	waitmessage B_WAIT_TIME_LONG
	copybyte sSAVED_BATTLER, gBattlerAttacker
	copybyte gBattlerAttacker, gBattlerTarget
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN, BattleScript_FauxliageTryDefense
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printstring STRINGID_TARGETABILITYSTATRAISE
	waitmessage B_WAIT_TIME_LONG
BattleScript_FauxliageTryDefense:
	setstatchanger STAT_DEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN, BattleScript_FauxliageEnd
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printstring STRINGID_TARGETABILITYSTATRAISE
	waitmessage B_WAIT_TIME_LONG
BattleScript_FauxliageEnd:
	copybyte gBattlerAttacker, sSAVED_BATTLER
	return
...
BattleScript_InterrogationActivates::
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNMOVEWASDISABLED
	waitmessage B_WAIT_TIME_LONG
	setbyte sSTAT_ANIM_PLAYED, FALSE
	statbuffchange STAT_CHANGE_ALLOW_PTR | STAT_CHANGE_NOT_PROTECT_AFFECTED, BattleScript_InterrogationEnd
	jumpifbyte CMP_LESS_THAN, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_InterrogationDoAnim
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_FELL_EMPTY, BattleScript_InterrogationEnd
	goto BattleScript_InterrogationPrintString
BattleScript_InterrogationDoAnim:
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
BattleScript_InterrogationPrintString:
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_InterrogationEnd:
	end3
...
BattleScript_RetaliateCharmActivates::
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_ATK | BIT_SPATK, 0
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_RetaliateCharmTrySpAtk
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_RetaliateCharmTrySpAtk
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_RetaliateCharmTrySpAtk:
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_RetaliateCharmEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_RetaliateCharmEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_RetaliateCharmEnd:
	end3

BattleScript_StandCharmActivates::
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_ATK | BIT_DEF | BIT_SPEED | BIT_SPATK | BIT_SPDEF, 0
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_StandCharmDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_StandCharmDef:
	setstatchanger STAT_DEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_StandCharmSpeed
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_StandCharmSpeed:
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_StandCharmSpAtk
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_StandCharmSpAtk:
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_StandCharmSpDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_StandCharmSpDef:
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_StandCharmEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_StandCharmEnd:
	end3

BattleScript_MomentumCharmActivates::
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_MomentumCharmEnd
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	waitanimation
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_MomentumCharmEnd:
	return
...
BattleScript_RedlineEndTurn::
	call BattleScript_AbilityPopUp
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR | STAT_CHANGE_NOT_PROTECT_AFFECTED | MOVE_EFFECT_CERTAIN, BattleScript_RedlineEndTurn_End
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	waitanimation
	printfromtable gStatDownStringIds
...
BattleScript_UnmovableIngrain:
	...
	swapattackerwithtarget
	return
BattleScript_UnmovableSuctionCups:
	printstring STRINGID_PKMNANCHORSITSELFWITH
	waitmessage B_WAIT_TIME_LONG
	swapattackerwithtarget
	return
BattleScript_UnmovableDynamaxed:
	printstring STRINGID_MOVEBLOCKEDBYDYNAMAX
	waitmessage B_WAIT_TIME_LONG
	swapattackerwithtarget
	return
...
BattleScript_ItemHealHP_RemoveItemRet_Anim:
	jumpifnotberry BS_SCRIPTING, BattleScript_ItemHealHP_RemoveItemRet_ItemAnim
	playanimation BS_SCRIPTING, B_ANIM_HELD_ITEM_BERRY
	goto BattleScript_ItemHealHP_RemoveItemRet_AnimContinue
BattleScript_ItemHealHP_RemoveItemRet_ItemAnim:
	playanimation BS_SCRIPTING, B_ANIM_HELD_ITEM_EFFECT
...
BattleScript_ItemHealHP_RemoveItemEnd2_Anim:
	jumpifnotberry BS_ATTACKER, BattleScript_ItemHealHP_RemoveItemEnd2_ItemAnim
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_BERRY
	goto BattleScript_ItemHealHP_RemoveItemEnd2_AnimContinue
BattleScript_ItemHealHP_RemoveItemEnd2_ItemAnim:
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_EFFECT
BattleScript_ItemHealHP_RemoveItemEnd2_AnimContinue:
	printstring STRINGID_PKMNSITEMRESTOREDHEALTH
	waitmessage B_WAIT_TIME_LONG
	orword gHitMarker, HITMARKER_IGNORE_BIDE | HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	healthbarupdate BS_ATTACKER
...
BattleScript_BerryStatRaiseEnd2_Anim:
	...
	setgraphicalstatchangevalues
	jumpifnotberry BS_ATTACKER, BattleScript_BerryStatRaiseEnd2_ItemAnim
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_BERRY
	goto BattleScript_BerryStatRaiseEnd2_AnimContinue
BattleScript_BerryStatRaiseEnd2_ItemAnim:
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_EFFECT, sB_ANIM_ARG1
BattleScript_BerryStatRaiseEnd2_AnimContinue:
...
BattleScript_BerryStatRaiseRet_Anim:
	...
	setgraphicalstatchangevalues
	jumpifnotberry BS_SCRIPTING, BattleScript_BerryStatRaiseRet_ItemAnim
	playanimation BS_SCRIPTING, B_ANIM_HELD_ITEM_BERRY
	goto BattleScript_BerryStatRaiseRet_AnimContinue
BattleScript_BerryStatRaiseRet_ItemAnim:
	playanimation BS_SCRIPTING, B_ANIM_HELD_ITEM_EFFECT, sB_ANIM_ARG1
BattleScript_BerryStatRaiseRet_AnimContinue:
	setbyte cMULTISTRING_CHOOSER, B_MSG_STAT_ROSE_ITEM
	call BattleScript_StatUp
	removeitem BS_SCRIPTING
...
BattleScript_BerryFocusEnergyRet::
	jumpifnotberry BS_SCRIPTING, BattleScript_BerryFocusEnergyRet_ItemAnim
	playanimation BS_SCRIPTING, B_ANIM_HELD_ITEM_BERRY
	goto BattleScript_BerryFocusEnergyRet_AnimContinue
BattleScript_BerryFocusEnergyRet_ItemAnim:
	playanimation BS_SCRIPTING, B_ANIM_HELD_ITEM_EFFECT
BattleScript_BerryFocusEnergyRet_AnimContinue:
