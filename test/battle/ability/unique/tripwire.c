...
SINGLE_BATTLE_TEST("Tripwire confuses attackers on contact but not on non-contact")
{
    u16 move;
    bool8 shouldConfuse;
    ...
    GIVEN {
        PLAYER(SPECIES_STUNFISK) { Ability(ABILITY_STATIC); UniqueAbility(ABILITY_TRIPWIRE); Moves(MOVE_CELEBRATE); }
