...
SINGLE_BATTLE_TEST("Liechi Berry raises Attack and Gluttony boosts it again when HP drops to 1/2 or below")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Unique Gluttony triggers Liechi Berry at half HP")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET) { MaxHP(80); HP(80); Item(ITEM_LIECHI_BERRY); UniqueAbility(ABILITY_GLUTTONY); }
        OPPONENT(SPECIES_WOBBUFFET);
    } WHEN {
        TURN { MOVE(opponent, MOVE_DRAGON_RAGE); }
    } SCENE {
