...
extern const u32 gItemIconPalette_VowOfSilence[];
...
extern const u32 gItemIcon_AcidRock[];
extern const u32 gItemIconPalette_AcidRock[];
...
extern const u32 gItemIconPalette_AshenCrown[];
extern const u32 gItemIconPalette_WitchsThread[];
extern const u32 gItemIconPalette_PetrifiedHeart[];
extern const u32 gItemIconPalette_FalseIdol[];
extern const u32 gItemIconPalette_GamblersClaw[];
extern const u32 gItemIconPalette_TempoDial[];
extern const u32 gItemIconPalette_TurnaboutTotem[];
extern const u32 gItemIconPalette_JesterSwitch[];
extern const u32 gItemIconPalette_WaywardIncense[];
extern const u32 gItemIconPalette_ChaosCharm[];
extern const u32 gItemIconPalette_MischiefQuill[];
extern const u32 gItemIconPalette_FinaleBell[];
// Treasure concept icons
extern const u32 gItemIcon_TreasureBellJewel[];
extern const u32 gItemIconPalette_TreasureBellJewel[];
extern const u32 gItemIcon_TreasureBerserkersGreaves[];
extern const u32 gItemIconPalette_TreasureBerserkersGreaves[];
extern const u32 gItemIcon_TreasureBufferShield[];
extern const u32 gItemIconPalette_TreasureBufferShield[];
extern const u32 gItemIcon_TreasureChampionsBand[];
extern const u32 gItemIconPalette_TreasureChampionsBand[];
extern const u32 gItemIcon_TreasureCompoundLens[];
extern const u32 gItemIconPalette_TreasureCompoundLens[];
extern const u32 gItemIcon_TreasureEchoScepter[];
extern const u32 gItemIconPalette_TreasureEchoScepter[];
extern const u32 gItemIcon_TreasureElectricTiki[];
extern const u32 gItemIconPalette_TreasureElectricTiki[];
extern const u32 gItemIcon_TreasureFinalStand[];
extern const u32 gItemIconPalette_TreasureFinalStand[];
extern const u32 gItemIcon_TreasureFocusLens[];
extern const u32 gItemIconPalette_TreasureFocusLens[];
extern const u32 gItemIcon_TreasureGamblersVest[];
extern const u32 gItemIconPalette_TreasureGamblersVest[];
extern const u32 gItemIcon_TreasureGlassCannon[];
extern const u32 gItemIconPalette_TreasureGlassCannon[];
extern const u32 gItemIcon_TreasureGlyphCodex[];
...
extern const u32 gItemIconPalette_TreasureGrassyTiki[];
extern const u32 gItemIcon_TreasureGreedyGlove[];
extern const u32 gItemIconPalette_TreasureGreedyGlove[];
extern const u32 gItemIcon_TreasureHailTotem[];
extern const u32 gItemIconPalette_TreasureHailTotem[];
extern const u32 gItemIcon_TreasureHexingWand[];
extern const u32 gItemIconPalette_TreasureHexingWand[];
extern const u32 gItemIcon_TreasureMistyTiki[];
extern const u32 gItemIconPalette_TreasureMistyTiki[];
extern const u32 gItemIcon_TreasurePsychicTiki[];
extern const u32 gItemIconPalette_TreasurePsychicTiki[];
extern const u32 gItemIcon_TreasureMoodyHat[];
extern const u32 gItemIconPalette_TreasureMoodyHat[];
extern const u32 gItemIcon_TreasureQuickTalon[];
extern const u32 gItemIconPalette_TreasureQuickTalon[];
extern const u32 gItemIcon_TreasureRainTotem[];
extern const u32 gItemIconPalette_TreasureRainTotem[];
extern const u32 gItemIcon_TreasureAcidRainTotem[];
extern const u32 gItemIconPalette_TreasureAcidRainTotem[];
extern const u32 gItemIcon_TreasureRampingStaff[];
extern const u32 gItemIconPalette_TreasureRampingStaff[];
extern const u32 gItemIcon_TreasureSandTotem[];
extern const u32 gItemIconPalette_TreasureSandTotem[];
extern const u32 gItemIcon_TreasureSpecialistJewel[];
extern const u32 gItemIconPalette_TreasureSpecialistJewel[];
extern const u32 gItemIcon_TreasureSunTotem[];
extern const u32 gItemIconPalette_TreasureSunTotem[];
extern const u32 gItemIcon_TreasureEclipseTotem[];
extern const u32 gItemIconPalette_TreasureEclipseTotem[];
extern const u32 gItemIcon_TreasureWonderShield[];
extern const u32 gItemIconPalette_TreasureWonderShield[];
extern const u32 gItemIcon_TreasureChampionsSpecs[];
extern const u32 gItemIconPalette_TreasureChampionsSpecs[];
extern const u32 gItemIcon_TreasureChoiceJewel[];
extern const u32 gItemIconPalette_TreasureChoiceJewel[];
extern const u32 gItemIcon_TreasureClearArmor[];
extern const u32 gItemIconPalette_TreasureClearArmor[];
extern const u32 gItemIcon_TreasureCrush[];
extern const u32 gItemIconPalette_TreasureCrush[];
extern const u32 gItemIcon_TreasureDrainBlade[];
extern const u32 gItemIconPalette_TreasureDrainBlade[];
extern const u32 gItemIcon_TreasureGrandPlaza[];
extern const u32 gItemIconPalette_TreasureGrandPlaza[];
extern const u32 gItemIcon_TreasureGutsSword[];
extern const u32 gItemIconPalette_TreasureGutsSword[];
extern const u32 gItemIcon_TreasureHealingLamp[];
extern const u32 gItemIconPalette_TreasureHealingLamp[];
extern const u32 gItemIcon_TreasureHoOhPlume[];
extern const u32 gItemIconPalette_TreasureHoOhPlume[];
extern const u32 gItemIcon_TreasureHourglass[];
extern const u32 gItemIconPalette_TreasureHourglass[];
extern const u32 gItemIcon_TreasureMonotonousArmor[];
extern const u32 gItemIconPalette_TreasureMonotonousArmor[];
extern const u32 gItemIcon_TreasureMonotype[];
extern const u32 gItemIconPalette_TreasureMonotype[];
extern const u32 gItemIcon_TreasureNoGuardBelt[];
extern const u32 gItemIconPalette_TreasureNoGuardBelt[];
extern const u32 gItemIcon_TreasureRenegadeOrb[];
extern const u32 gItemIconPalette_TreasureRenegadeOrb[];
extern const u32 gItemIcon_TreasureShamanStaff[];
extern const u32 gItemIconPalette_TreasureShamanStaff[];
extern const u32 gItemIcon_TreasureThornmail[];
extern const u32 gItemIconPalette_TreasureThornmail[];
extern const u32 gItemIcon_TreasureTintedShield[];
extern const u32 gItemIconPalette_TreasureTintedShield[];
extern const u32 gItemIcon_TreasureTrickyBox[];
extern const u32 gItemIconPalette_TreasureTrickyBox[];
extern const u32 gItemIcon_TreasureVestJewel[];
extern const u32 gItemIconPalette_TreasureVestJewel[];
extern const u32 gItemIcon_TreasureWoodCannon[];
extern const u32 gItemIconPalette_TreasureWoodCannon[];
extern const u32 gItemIcon_TreasureXAncient[];
extern const u32 gItemIconPalette_TreasureXAncient[];
extern const u32 gItemIcon_TreasureElredBerry[];
extern const u32 gItemIconPalette_TreasureElredBerry[];
extern const u32 gItemIcon_TreasureHoneyBadge[];
extern const u32 gItemIconPalette_TreasureHoneyBadge[];
extern const u32 gItemIcon_TreasureItem692[];
extern const u32 gItemIconPalette_TreasureItem692[];
extern const u32 gItemIcon_TreasureItem693[];
extern const u32 gItemIconPalette_TreasureItem693[];
extern const u32 gItemIcon_TreasureMegaphone[];
extern const u32 gItemIconPalette_TreasureMegaphone[];
extern const u32 gItemIcon_TreasurePinwheel[];
extern const u32 gItemIconPalette_TreasurePinwheel[];
extern const u32 gItemIcon_TreasurePixieDust[];
extern const u32 gItemIconPalette_TreasurePixieDust[];
extern const u32 gItemIcon_TreasureShockBracer[];
extern const u32 gItemIconPalette_TreasureShockBracer[];
extern const u32 gItemIcon_TreasureVitalHerb[];
extern const u32 gItemIconPalette_TreasureVitalHerb[];
extern const u32 gItemIcon_TreasureCharcoalFilter[];
extern const u32 gItemIconPalette_TreasureCharcoalFilter[];
extern const u32 gItemIcon_TreasureExpAll[];
extern const u32 gItemIconPalette_TreasureExpAll[];
extern const u32 gItemIcon_TreasureFoodSupply[];
extern const u32 gItemIconPalette_TreasureFoodSupply[];
extern const u32 gItemIcon_TreasureNameCard[];
extern const u32 gItemIconPalette_TreasureNameCard[];
extern const u32 gItemIcon_TreasurePokeFoodCan[];
extern const u32 gItemIconPalette_TreasurePokeFoodCan[];
extern const u32 gItemIcon_TreasureRaincoat[];
extern const u32 gItemIconPalette_TreasureRaincoat[];
extern const u32 gItemIcon_TreasureSleepingBag[];
extern const u32 gItemIconPalette_TreasureSleepingBag[];
extern const u32 gItemIcon_TreasureStrSalve[];
extern const u32 gItemIconPalette_TreasureStrSalve[];
extern const u32 gItemIcon_TreasureTentBag[];
extern const u32 gItemIconPalette_TreasureTentBag[];
extern const u32 gItemIcon_TreasureWaterBottle[];
extern const u32 gItemIconPalette_TreasureWaterBottle[];
extern const u32 gItemIcon_TreasureWildFruitBook[];
extern const u32 gItemIconPalette_TreasureWildFruitBook[];
...
extern const u32 gItemIconPalette_CursedLens[];
...
extern const u32 gItemIconPalette_BloodOath[];
extern const u32 gItemIconPalette_HollowSun[];
...
extern const u32 gItemIconPalette_RustedAnchor[];
...
extern const u32 gItemIcon_RottenBerry[];
extern const u32 gItemIconPalette_RottenBerry[];
...
extern const u32 gBattleAnimSpritePal_EclipseRay[];
