...
// Rogue weather forms
#define SPECIES_CASTFORM_SANDY                          SPECIES_GLIMMORA_MEGA + 1
#define SPECIES_CASTFORM_ECLIPSE                        SPECIES_CASTFORM_SANDY + 1
#define SPECIES_CASTFORM_ACID_RAIN                      SPECIES_CASTFORM_ECLIPSE + 1

#define SPECIES_EGG SPECIES_CASTFORM_ACID_RAIN + 1
