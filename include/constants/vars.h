...
#define VAR_ROGUE_ROUTE_EVENT_STATE          0x404E
#define VAR_ROGUE_ROUTE_EVENT_HISTORY        0x404F
#define VAR_ROGUE_ROUTE_EVENT_HISTORY_2      0x4050
...
#define VAR_ROGUE_ADVENTURE_MONEY_TIER       0x40A1
