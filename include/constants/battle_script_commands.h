...
#define VARIOUS_TRY_WILD_GROWTH_HEAL                 170
...
#define VARIOUS_TRY_ACTIVATE_PENDING_MOONLIGHT       175
#define VARIOUS_TRY_ACTIVATE_MOMENTUM_CHARM          176
#define VARIOUS_TRY_ACTIVATE_RAPID_REPLICA            177
#define VARIOUS_TRY_ACTIVATE_ASHEN_CROWN              178
#define VARIOUS_TRY_ACTIVATE_VICTORS_BAND             179

// Argument labels for VARIOUS_PREPARE_RANDOM_MOVE_FROM_POOL
#define RANDOM_MOVE_POOL_CHEMICAL        0
#define RANDOM_MOVE_POOL_FEAR            1
#define RANDOM_MOVE_POOL_OVERGROWTH      2
#define RANDOM_MOVE_POOL_STATIC          3
#define RANDOM_MOVE_POOL_CHEAP_TRICK     4
#define RANDOM_MOVE_POOL_MENTAL          5
