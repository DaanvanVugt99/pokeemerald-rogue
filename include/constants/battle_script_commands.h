...
#define VARIOUS_TRY_ACTIVATE_RAMPAGE 152
#define VARIOUS_TRY_ACTIVATE_SCAVENGER 153
#define VARIOUS_TRY_ACTIVATE_FEAST 154
#define VARIOUS_VARIOUS_SETCLOUDY 155
#define VARIOUS_TRY_RAISE_HIGHEST_STAT 156

// Cmd_manipulatedamage
#define DMG_CHANGE_SIGN 0
#define DMG_RECOIL_FROM_MISS 1
#define DMG_DOUBLED 2
#define DMG_1_4_TARGET_HP 3
