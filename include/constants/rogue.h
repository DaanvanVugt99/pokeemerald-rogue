...
//#define ROGUE_FEATURE_MULTIPLAYER // Multiplayer is disabled while its replacement is in development
...
#define ITEM_BATTLE_CHECKER             (ITEM_ROGUE_ITEM_FIRST + 19)
...
#define ADVPATH_FRONTIER_BRAIN_COUNT        3
...
#define TRAINER_FLAG_CLASS_MINIBOSS              (1 << 18)

#define TRAINER_FLAG_CLASS_ANY                  (TRAINER_FLAG_CLASS_BOSS | TRAINER_FLAG_CLASS_RIVAL | TRAINER_FLAG_CLASS_ROUTE | TRAINER_FLAG_CLASS_TEAM | TRAINER_FLAG_CLASS_MINIBOSS)
...
// TRAINER_FLAG_CLASS_MINIBOSS
//
#define CLASS_FLAG_MINIBOSS_ANABEL              (1 << 0)
#define CLASS_FLAG_MINIBOSS_TUCKER              (1 << 1)
#define CLASS_FLAG_MINIBOSS_SPENSER             (1 << 2)
#define CLASS_FLAG_MINIBOSS_GRETA               (1 << 3)
#define CLASS_FLAG_MINIBOSS_NOLAND              (1 << 4)
#define CLASS_FLAG_MINIBOSS_LUCY                (1 << 5)
#define CLASS_FLAG_MINIBOSS_BRANDON             (1 << 6)
#define CLASS_FLAG_MINIBOSS_ANY                 (CLASS_FLAG_MINIBOSS_ANABEL | CLASS_FLAG_MINIBOSS_TUCKER | CLASS_FLAG_MINIBOSS_SPENSER | CLASS_FLAG_MINIBOSS_GRETA | CLASS_FLAG_MINIBOSS_NOLAND | CLASS_FLAG_MINIBOSS_LUCY | CLASS_FLAG_MINIBOSS_BRANDON)
...
#define SPECIES_COLRESS_ACE             SPECIES_GENESECT
...
#define CONFIG_TOGGLE_BAG_CLAUSE            9
#define CONFIG_TOGGLE_SPECIES_CLAUSE        10
#define CONFIG_TOGGLE_HELD_ITEM_CLAUSE      11
#define CONFIG_TOGGLE_TRAINER_ROGUE         12
#define CONFIG_TOGGLE_TRAINER_KANTO         13
#define CONFIG_TOGGLE_TRAINER_JOHTO         14
#define CONFIG_TOGGLE_TRAINER_HOENN         15
#ifdef ROGUE_EXPANSION
#define CONFIG_TOGGLE_TRAINER_SINNOH        16
#define CONFIG_TOGGLE_TRAINER_UNOVA         17
#define CONFIG_TOGGLE_TRAINER_KALOS         18
#define CONFIG_TOGGLE_TRAINER_ALOLA         19
...
#define DYNAMIC_UNIQUE_MON_COUNT    8
