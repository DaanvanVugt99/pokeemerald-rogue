...
#define OBJ_EVENT_GFX_DECOR_CAULDRON             (OBJ_EVENT_GFX_FLAG_ADVENTURE + 9)

#define OBJ_EVENT_GFX_BRENDAN_ALT                (OBJ_EVENT_GFX_DECOR_CAULDRON + 1)
#define OBJ_EVENT_GFX_MAY_ALT                    (OBJ_EVENT_GFX_DECOR_CAULDRON + 2)
#define OBJ_EVENT_GFX_RED_ALT                    (OBJ_EVENT_GFX_DECOR_CAULDRON + 3)
#define OBJ_EVENT_GFX_LEAF_ALT                   (OBJ_EVENT_GFX_DECOR_CAULDRON + 4)
#define OBJ_EVENT_GFX_LYRA_ALT                   (OBJ_EVENT_GFX_DECOR_CAULDRON + 5)
#define OBJ_EVENT_GFX_ETHAN_ALT                  (OBJ_EVENT_GFX_DECOR_CAULDRON + 6)
...
#define OBJ_EVENT_GFX_UNIQUE_DEN_GRASS           (OBJ_EVENT_GFX_FOLLOW_MON_LAST + 1)
#define OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE       (OBJ_EVENT_GFX_UNIQUE_DEN_GRASS + 1)

#define OBJ_EVENT_GFX_ROUTE_PROP_SPIRIT_STONE     (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 1)
#define OBJ_EVENT_GFX_ROUTE_PROP_OCCULT_ALTAR     (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 2)
#define OBJ_EVENT_GFX_ROUTE_PROP_SUPPLY_CRATE     (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 3)
#define OBJ_EVENT_GFX_ROUTE_PROP_STORAGE_BARREL   (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 4)
#define OBJ_EVENT_GFX_ROUTE_PROP_STUMP            (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 5)
#define OBJ_EVENT_GFX_ROUTE_PROP_MOSSY_STONE      (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 6)
#define OBJ_EVENT_GFX_ROUTE_PROP_STONE_PILE       (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 7)
#define OBJ_EVENT_GFX_ROUTE_PROP_SPLIT_ROCK       (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 8)
#define OBJ_EVENT_GFX_ROUTE_PROP_DRIFTWOOD        (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 9)
#define OBJ_EVENT_GFX_ROUTE_PROP_DIG_MOUND        (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 10)
#define OBJ_EVENT_GFX_ROUTE_PROP_ROUND_STONE      (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 11)
#define OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE    (OBJ_EVENT_GFX_GOLD_LEGENDARY_STATUE + 12)

#define OBJ_EVENT_GFX_ROUTE_MARKER_SOLO_NPC        (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 1)
#define OBJ_EVENT_GFX_ROUTE_MARKER_STALL_NPC       (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 2)
#define OBJ_EVENT_GFX_ROUTE_MARKER_STALL_DECOR     (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 3)
#define OBJ_EVENT_GFX_ROUTE_MARKER_CAMP_NPC        (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 4)
#define OBJ_EVENT_GFX_ROUTE_MARKER_CAMP_DECOR      (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 5)
#define OBJ_EVENT_GFX_ROUTE_MARKER_WORKBENCH_NPC   (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 6)
#define OBJ_EVENT_GFX_ROUTE_MARKER_WORKBENCH_DECOR (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 7)
#define OBJ_EVENT_GFX_ROUTE_MARKER_RELIC_NPC       (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 8)
#define OBJ_EVENT_GFX_ROUTE_MARKER_RELIC_DECOR     (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 9)
#define OBJ_EVENT_GFX_ROUTE_MARKER_CREATURE_NPC    (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 10)
#define OBJ_EVENT_GFX_ROUTE_MARKER_CREATURE_DECOR  (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 11)
#define OBJ_EVENT_GFX_ROUTE_MARKER_COLLECTABLE     (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 12)
#define OBJ_EVENT_GFX_ROUTE_MARKER_PLANT_PATCH     (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 13)
#define OBJ_EVENT_GFX_ROUTE_MARKER_WATER_NPC       (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 14)
#define OBJ_EVENT_GFX_ITEM_MACHINE_PART            (OBJ_EVENT_GFX_ROUTE_PROP_APRICORN_TREE + 15)

#define OBJ_EVENT_GFX_WILD_DEN_BUG               (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 1)
#define OBJ_EVENT_GFX_WILD_DEN_DARK              (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 2)
#define OBJ_EVENT_GFX_WILD_DEN_DRAGON            (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 3)
#define OBJ_EVENT_GFX_WILD_DEN_ELECTRIC          (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 4)
#define OBJ_EVENT_GFX_WILD_DEN_FAIRY             (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 5)
#define OBJ_EVENT_GFX_WILD_DEN_FIGHTING          (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 6)
#define OBJ_EVENT_GFX_WILD_DEN_FIRE              (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 7)
#define OBJ_EVENT_GFX_WILD_DEN_FLYING             (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 8)
#define OBJ_EVENT_GFX_WILD_DEN_GHOST             (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 9)
#define OBJ_EVENT_GFX_WILD_DEN_GRASS             (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 10)
#define OBJ_EVENT_GFX_WILD_DEN_GROUND            (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 11)
#define OBJ_EVENT_GFX_WILD_DEN_ICE               (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 12)
#define OBJ_EVENT_GFX_WILD_DEN_MYSTERY           (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 13)
#define OBJ_EVENT_GFX_WILD_DEN_NORMAL            (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 14)
#define OBJ_EVENT_GFX_WILD_DEN_POISON            (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 15)
#define OBJ_EVENT_GFX_WILD_DEN_PSYCHIC           (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 16)
#define OBJ_EVENT_GFX_WILD_DEN_ROCK              (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 17)
#define OBJ_EVENT_GFX_WILD_DEN_STEEL             (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 18)
#define OBJ_EVENT_GFX_WILD_DEN_WATER             (OBJ_EVENT_GFX_ITEM_MACHINE_PART + 19)

#define OBJ_EVENT_GFX_ADVENTURE_CONSOLE          (OBJ_EVENT_GFX_WILD_DEN_WATER + 1)

#define NUM_OBJ_EVENT_GFX                        (OBJ_EVENT_GFX_ADVENTURE_CONSOLE + 1)
