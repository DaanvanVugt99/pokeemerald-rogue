...
#define QUEST_CONST_TRIAL_DEFAULT           (QUEST_CONST_IS_TRIAL)
#define QUEST_CONST_MON_MASTERY_DEFAULT     (QUEST_CONST_IS_MON_MASTERY)
#define QUEST_CONST_ACHIEVEMENT_DEFAULT     (QUEST_CONST_IS_ACHIEVEMENT)
...
#define QUEST_TRIGGER_MON_UNIQUE_CAUGHT             (1 << 22)
#define QUEST_TRIGGER_MON_UNIQUE_LEGEND_CAUGHT      (1 << 23)
...
#define QUEST_REWARD_HUGE_MONEY             10000
