...
#define HUB_UPGRADE_LAB_UNIQUE_MON_RARITY_LEGENDARY     (HUB_UPGRADE_FIRST + 9)

#define HUB_UPGRADE_HOME_LOWER_FLOOR                    (HUB_UPGRADE_FIRST + 10)
#define HUB_UPGRADE_HOME_UPPER_FLOOR                    (HUB_UPGRADE_FIRST + 11) // reserved not actually planned to be used
#define HUB_UPGRADE_HOME_EDIT_STYLE                     (HUB_UPGRADE_FIRST + 12)

#define HUB_UPGRADE_BERRY_FIELD_BREWING                 (HUB_UPGRADE_FIRST + 13)
#define HUB_UPGRADE_BERRY_FIELD_BREWING_UPGRADE         (HUB_UPGRADE_FIRST + 14) // resetved, not used yet
...
#define HUB_UPGRADE_DAY_CARE_PHONE0                     (HUB_UPGRADE_FIRST + 34)
#define HUB_UPGRADE_DAY_CARE_PHONE                      HUB_UPGRADE_DAY_CARE_PHONE0
...
#define HUB_UPGRADE_MARKET_UNUSED_0                     (HUB_UPGRADE_FIRST + 39)
...
// 2.1
#define HUB_UPGRADE_DAY_CARE_PHONE1                     (HUB_UPGRADE_FIRST + 44)
#define HUB_UPGRADE_DAY_CARE_PHONE2                     (HUB_UPGRADE_FIRST + 45)

#define HUB_UPGRADE_LAB_UNIQUE_TYPINGS                  (HUB_UPGRADE_FIRST + 46)

#define HUB_UPGRADE_ADVENTURE_ENTRANCE_TRIAL_CONSOLE  (HUB_UPGRADE_FIRST + 47)
