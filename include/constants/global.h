...
#define OPTIONS_ANIM_SPEED_1X           0
#define OPTIONS_ANIM_SPEED_2X           1
#define OPTIONS_ANIM_SPEED_3X           2
#define OPTIONS_ANIM_SPEED_4X           3
#define OPTIONS_ANIM_SPEED_COUNT        4
