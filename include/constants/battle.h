...
#define STATUS4_COILED (1 << 7) // Used for ability Coil Up
...
#define MOVE_RESULT_SKIN_SHED (1 << 10)
...
#define B_WEATHER_ANY (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_ACID_RAIN)
...
#define B_WEATHER_ACID_RAIN_PERMANENT (1 << 15)
#define B_WEATHER_ACID_RAIN (B_WEATHER_ACID_RAIN_TEMPORARY | B_WEATHER_ACID_RAIN_PERMANENT)
