...
#define STATUS4_CANT_SCORE_A_CRIT       (1 << 7)
...
#define STATUS_FIELD_INFESTED_TERRAIN               (1 << 13)
#define STATUS_FIELD_PLAIN_TERRAIN                  (1 << 14)

#define STATUS_FIELD_TERRAIN_ANY        (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_INFESTED_TERRAIN | STATUS_FIELD_PLAIN_TERRAIN)
...
#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_ACID_RAIN | B_WEATHER_ECLIPSE)
...
#define B_WEATHER_ACID_RAIN_TEMPORARY (1 << 14)
#define B_WEATHER_ACID_RAIN_PERMANENT 0
#define B_WEATHER_ACID_RAIN           B_WEATHER_ACID_RAIN_TEMPORARY
#define B_WEATHER_ECLIPSE_TEMPORARY   (1 << 15)
...
#define ENUM_WEATHER_ECLIPSE             10
