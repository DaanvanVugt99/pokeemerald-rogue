...
extern const u8 BattleScript_ColdPremonitionSetsFutureSight[];
...
extern const u8 BattleScript_BogBodyActivates[];
...
extern const u8 BattleScript_DriveProtocolClearsHazards[];
...
extern const u8 BattleScript_SandCommandActivates[];
...
extern const u8 BattleScript_BreachPointActivates[];
...
extern const u8 BattleScript_MoltInstinctActivates[];
...
extern const u8 BattleScript_GroundFaultActivates[];
extern const u8 BattleScript_PrismRefractionActivates[];
...
extern const u8 BattleScript_TikiActivates_Ret[];
extern const u8 BattleScript_TikiActivates_End2[];
...
extern const u8 BattleScript_WitchsThreadActivates[];
...
extern const u8 BattleScript_MoveUsedVowOfSilencePrevents[];
...
extern const u8 BattleScript_GlyphCodexActivates[];
...
extern const u8 BattleScript_AstralReignActivates[];
...
extern const u8 BattleScript_FuryMantleActivates[];
extern const u8 BattleScript_BriarBracerActivates[];
...
extern const u8 BattleScript_BitterRuseUsesCalledMove[];
...
extern const u8 BattleScript_DisguiseWithoutFormChange[];
...
extern const u8 BattleScript_MoodyCharmActivates[];
extern const u8 BattleScript_FickleHatActivates[];
...
extern const u8 BattleScript_RetaliateCharmActivates[];
extern const u8 BattleScript_StandCharmActivates[];
extern const u8 BattleScript_MomentumCharmActivates[];
...
extern const u8 BattleScript_AshenCrownActivates[];
extern const u8 BattleScript_AshenCrownStatsOnly[];
...
extern const u8 BattleScript_NaturalOrderStatChange[];
extern const u8 BattleScript_NaturalOrderStatRose[];
extern const u8 BattleScript_NaturalOrderStatFell[];
...
extern const u8 BattleScript_WorldEngineSunActivates[];
extern const u8 BattleScript_WorldEngineRainActivates[];
extern const u8 BattleScript_WorldEngineSnowActivates[];
extern const u8 BattleScript_WorldEngineSandstormActivates[];
extern const u8 BattleScript_WorldEngineAcidRainActivates[];
extern const u8 BattleScript_WorldEngineEclipseActivates[];
extern const u8 BattleScript_CrashProtocolActivates[];
