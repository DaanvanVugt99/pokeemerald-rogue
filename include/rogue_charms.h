...
enum RogueCharmEffects
{
    ...
    EFFECT_TECHNICIAN_DAMAGE,
    EFFECT_TINTED_DAMAGE,
    EFFECT_IRON_FIST_DAMAGE,
    EFFECT_SHARPNESS_DAMAGE,
    EFFECT_STRONG_JAW_DAMAGE,
    EFFECT_SKILL_MULTI_HIT,
    EFFECT_REACH_DAMAGE,
    EFFECT_ACCURACY,
    EFFECT_RECOVERY,
    EFFECT_RECOIL_PROTECTION,
    EFFECT_GUARD,
    EFFECT_CONVERSION_TYPE,
    EFFECT_RETALIATE_CHARM,
    EFFECT_MOMENTUM_CHARM,
    EFFECT_STAND_CHARM,
    EFFECT_PREP_CHARM,
