...
#define RESOURCE_FLAG_STEADFAST_PENDING 0x8
#define RESOURCE_FLAG_TRACED            0x10
#define RESOURCE_FLAG_EMERGENCY_EXIT    0x20
#define RESOURCE_FLAG_NEUTRALIZING_GAS  0x40
#define RESOURCE_FLAG_ICE_FACE          0x80
#define RESOURCE_FLAG_STEADFAST_USED    0x100
#define RESOURCE_FLAG_BOOSTER_ENERGY    0x200
...
struct BattleStruct
{
    ...
    u8 savingGraceEligibleBattlers;
    ...
    u8 moveEndAttacker;
    u16 successfulForceSwitchMove[MAX_BATTLERS_COUNT];
    ...
    u8 hoOhPlumeUsed[NUM_BATTLE_SIDES];
...
extern uq4_12_t gMoveResultEffectiveness;
