...
#define IS_EFFECT_RECOIL(effect) (effect == EFFECT_RECOIL_25 || effect == EFFECT_RECOIL_IF_MISS || effect == EFFECT_RECOIL_50 || effect == EFFECT_RECOIL_33 || effect == EFFECT_RECOIL_33_STATUS)
