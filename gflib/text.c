...
{
    u8 fitFontId = GetFontIdToFit(start, fontId, 0, widthPx);

    if (fitFontId != fontId)
    {
        memmove(&start[3], start, end - start);
...
static void DecompressGlyph_Small(u16 glyphId, bool32 isJapanese)
{
    ...
    if (isJapanese == 1)
    {
        DecompressGlyph_Small(CHAR_QUESTION_MARK, FALSE);
        return;
    }
    else
    {
...
{
    if (isJapanese == TRUE)
        return gFontSmallLatinGlyphWidths[CHAR_QUESTION_MARK];
    else
...
static void DecompressGlyph_Narrow(u16 glyphId, bool32 isJapanese)
{
    ...
    if (isJapanese == TRUE)
    {
        DecompressGlyph_Narrow(CHAR_QUESTION_MARK, FALSE);
        return;
    }
    else
    {
...
{
    if (isJapanese == TRUE)
        return gFontNarrowLatinGlyphWidths[CHAR_QUESTION_MARK];
    else
...
static void DecompressGlyph_Narrower(u16 glyphId, bool32 isJapanese)
{
    ...
    if (isJapanese == TRUE)
    {
        DecompressGlyph_Narrower(CHAR_QUESTION_MARK, FALSE);
        return;
    }
...
{
    if (isJapanese == TRUE)
        return gFontNarrowerLatinGlyphWidths[CHAR_QUESTION_MARK];
    else
...
static void DecompressGlyph_SmallNarrow(u16 glyphId, bool32 isJapanese)
{
    ...
    if (isJapanese == TRUE)
    {
        DecompressGlyph_SmallNarrow(CHAR_QUESTION_MARK, FALSE);
        return;
    }
    else
    {
...
{
    if (isJapanese == TRUE)
        return gFontSmallNarrowLatinGlyphWidths[CHAR_QUESTION_MARK];
    else
...
static void DecompressGlyph_Short(u16 glyphId, bool32 isJapanese)
{
    ...
    if (isJapanese == TRUE)
    {
        DecompressGlyph_Short(CHAR_QUESTION_MARK, FALSE);
        return;
    }
    else
    {
...
{
    if (isJapanese == TRUE)
        return gFontShortLatinGlyphWidths[CHAR_QUESTION_MARK];
    else
...
static void DecompressGlyph_Normal(u16 glyphId, bool32 isJapanese)
{
    ...
    if (isJapanese == TRUE)
    {
        DecompressGlyph_Normal(CHAR_QUESTION_MARK, FALSE);
        return;
    }
    else
    {
...
{
    if (isJapanese == TRUE)
        return gFontNormalLatinGlyphWidths[CHAR_QUESTION_MARK];
    else
