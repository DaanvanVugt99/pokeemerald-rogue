...
static const struct WindowTemplate sBattleArenaWindowTemplates[] = {[B_WIN_MSG] =
                                                                        {
                                                                            .bg = 0,
                                                                            .tilemapLeft = 2,
                                                                            .tilemapTop = 15,
...
const struct BattleBackground sBattleTerrainTable[] = {
    [BATTLE_TERRAIN_GRASS] = {.tileset = gBattleTerrainTiles_TallGrass,
    ...
    [BATTLE_TERRAIN_LONG_GRASS] = {.tileset = gBattleTerrainTiles_TallGrass,
                                   .tilemap = gBattleTerrainTilemap_TallGrass,
    ...
    [BATTLE_TERRAIN_PLAIN] = {.tileset = gBattleTerrainTiles_Plain,
...
{
  if (gBattleTypeFlags &
      (BATTLE_TYPE_LINK | BATTLE_TYPE_FRONTIER | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_RECORDED_LINK))
  {
...
void DrawBattleEntryBackground(void)
{
  if (gBattleTypeFlags & BATTLE_TYPE_LINK)
  {
    ...
    LoadCompressedSpriteSheetUsingHeap(&sVsLettersSpriteSheet);
             ...
             (BATTLE_TYPE_FRONTIER | BATTLE_TYPE_LINK | BATTLE_TYPE_RECORDED_LINK | BATTLE_TYPE_EREADER_TRAINER))
  {
