...
#define SINGLES_MEGA_TRIGGER_POS_X_OPTIMAL (38)
#define SINGLES_MEGA_TRIGGER_POS_X_PRIORITY (39)
...
#define DOUBLES_MEGA_TRIGGER_POS_X_PRIORITY (39)
...
#define SINGLES_BURST_TRIGGER_POS_X_OPTIMAL (38)
#define SINGLES_BURST_TRIGGER_POS_X_PRIORITY (39)
#define SINGLES_BURST_TRIGGER_POS_X_SLIDE (15)
#define SINGLES_BURST_TRIGGER_POS_Y_DIFF (-8)

#define DOUBLES_BURST_TRIGGER_POS_X_OPTIMAL (38)
#define DOUBLES_BURST_TRIGGER_POS_X_PRIORITY (39)
#define DOUBLES_BURST_TRIGGER_POS_X_SLIDE (15)
#define DOUBLES_BURST_TRIGGER_POS_Y_DIFF (-1)
...
#define ABILITY_POP_UP_TILE_TAG_BASE 0xD730
#define ABILITY_POP_UP_TILE_TAG(battler) (ABILITY_POP_UP_TILE_TAG_BASE + (battler))
...
void CreateAbilityPopUp(u8 battlerId, u32 ability, bool32 isDoubleBattle)
{
    ...
    struct SpriteSheet spriteSheet = {
        ...
        ABILITY_POP_UP_TILE_TAG(battlerId)
    };

    if (B_ABILITY_POP_UP == FALSE)
        return;

    if (gBattleScripting.abilityPopupOverwrite != 0 && battlerId == gBattlerAbility)
    ...
    {
        spriteId1 = CreateSprite(&spriteTemplate,
