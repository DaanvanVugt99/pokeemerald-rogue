...
static const u8 sText_PkmnCoveredByVeil[] = _("{B_ATK_PREFIX2}'s side is covered\nby a mystical veil!");
static const u8 sText_PkmnUsedSafeguard[] = _("{B_DEF_NAME_WITH_PREFIX}'s side is protected\nby Safeguard!");
static const u8 sText_PkmnSafeguardExpired[] = _("{B_ATK_PREFIX3}'s side is no longer\nprotected by Safeguard!");
...
static const u8 sText_AcidRainHeals[] = _("The acid rain restored\n{B_ATK_NAME_WITH_PREFIX}'s HP a little!");
...
static const u8 sText_SplitInstinctSpeed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s SPLIT INSTINCT\nsurges its SPEED!");
static const u8 sText_TidalFloodWashedAway[] = _("{B_ATK_NAME_WITH_PREFIX}'s Tidal Flood\nwashed away the hazards and restored HP!");
static const u8 sText_PickupClearedHazards[] = _("{B_ATK_NAME_WITH_PREFIX}'s Pickup\ncleared away the hazards!");
static const u8 sText_DesertShroudSoftened[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nsoftened the attack!");
static const u8 sText_PsychicParryReady[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\nreadied a parry!");
static const u8 sText_PsychicParried[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\nparried the attack!");
static const u8 sText_RootNetworkRestored[] = _("{B_DEF_NAME_WITH_PREFIX} restored HP\nthrough {B_BUFF1}!");
static const u8 sText_ScorchingRelayGuarded[] = _("{B_DEF_NAME_WITH_PREFIX} was guarded\nby {B_BUFF1}!");
static const u8 sText_TidalSwitchCharged[] = _("{B_DEF_NAME_WITH_PREFIX} was charged\nby {B_BUFF1}!");
static const u8 sText_RksRelayTransferred[] = _("The RKS System transferred\nbattle effects to {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_ControlMaskStabilized[] = _("{B_ATK_NAME_WITH_PREFIX}'s control mask\nstabilized its stat changes!");
static const u8 sText_GeodeHeartCharged[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\nstored special energy!");
static const u8 sText_GeodeHeartReleased[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\nreleased stored energy!");
static const u8 sText_MoodSwingElated[] = _("{B_ATK_NAME_WITH_PREFIX} became elated!");
static const u8 sText_MoodSwingAnxious[] = _("{B_ATK_NAME_WITH_PREFIX} became anxious!");
static const u8 sText_PkmnMainTypeChanged[] = _("{B_ATK_NAME_WITH_PREFIX}'s main type\nchanged to {B_BUFF1}!");
...
static const u8 sText_SplitInstinctHeal[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s SPLIT INSTINCT\nkicks in to recover!");
static const u8 sText_SplitInstinctDebuff[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s SPLIT INSTINCT\nhinders its foe!");
...
static const u8 sText_TerrainBecomesPlain[] = _("Plain terrain spread\nacross the battlefield!");
static const u8 sText_PlainTerrainEnds[] = _("The plain terrain\nfaded away.");
...
static const u8 sText_PoisonPuppeteer[] = _("{B_ATK_NAME_WITH_PREFIX}'s Poison Puppeteer\nconfused {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_TailWindBlew[] = _("A tailwind started blowing on\n{B_ATK_TEAM2} side!");
...
static const u8 sText_PoisonSpikesScattered[] = _("Toxic Spikes were scattered all\naround {B_DEF_TEAM2} side!");
...
static const u8 sText_ProtectedTeam[] =_("{B_CURRENT_MOVE} now protects\n{B_ATK_TEAM2} side!");
...
static const u8 sText_TailwindEnds[] = _("{B_ATK_TEAM1} side's tailwind\npetered out!");
static const u8 sText_LuckyChantEnds[] = _("{B_ATK_TEAM1} side's Lucky Chant\nwore off!");
...
static const u8 sText_IonizeDmg[] = _("{B_DEF_NAME_WITH_PREFIX} was hurt by ionization!");
...
static const u8 sText_ToxicSpikesAbsorbed[] = _("The Toxic Spikes disappeared\nfrom around {B_DEF_TEAM2} side!");
...
static const u8 sText_SpikesDisappearedFromTeam[] = _("The spikes disappeared from\nthe ground around {B_ATK_TEAM2} side!");
static const u8 sText_ToxicSpikesDisappearedFromTeam[] = _("The Toxic Spikes disappeared from\nthe ground around {B_ATK_TEAM2} side!");
static const u8 sText_StealthRockDisappearedFromTeam[] = _("The pointed stones disappeared\nfrom {B_ATK_TEAM2} side!");
static const u8 sText_StickyWebDisappearedFromTeam[] = _("The sticky web disappeared from\nthe ground on {B_ATK_TEAM2} side!");
static const u8 sText_StickyWebUsed[] = _("A sticky web spreads out on the\nground on {B_DEF_TEAM2} side!");
...
static const u8 sText_BelchCantUse[] = _("It hasn't eaten a Berry,\nso Belch can't be used!\p");
...
static const u8 sText_BerryDmgReducing[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nlessened the damage it took!");
...
static const u8 sText_NoOneWillBeAbleToRun[] = _("No one can leave the battlefield\nduring the next turn!");
...
static const u8 sText_ClearArmorBlocksStats[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nprevents stat changes!");
...
static const u8 sText_MetronomeItemActivates[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncalled forth Metronome!");
static const u8 sText_EchoScepterActivates[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nechoed the attack!");
static const u8 sText_WonderShieldNullified[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nnullified the damage!");
static const u8 sText_BriarBracerActivates[] = _("{B_ATK_NAME_WITH_PREFIX} was seeded by\n{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!");
static const u8 sText_TrickyBoxActivates[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nanswered the move!");
static const u8 sText_EclipseOrbRevealed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ninverted its type matchups!");
static const u8 sText_PhantomStoneRevealed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nadded the Ghost type!");
static const u8 sText_DecoyDollCreated[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncreated a substitute!");
...
static const u8 sText_BoosterEnergyActivatedAbility[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Booster Energy\nactivated its {B_LAST_ABILITY}!");
...
static const u8 sText_DriveProtocolClearedHazards[] = _("{B_ATK_NAME_WITH_PREFIX}'s Drive Protocol\ncleared away the hazards!");
...
static const u8 sText_EmeraldAccordRestored[] = _("{B_ATK_NAME_WITH_PREFIX} restored the\nbattlefield to neutral!");
static const u8 sText_HornLockSwappedTypes[] = _("{B_ATK_NAME_WITH_PREFIX} swapped\nsecondary types with its target!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_METRONOMEITEMACTIVATES - BATTLESTRINGS_TABLE_START] = sText_MetronomeItemActivates,
    [STRINGID_ECHOSCEPTERACTIVATES - BATTLESTRINGS_TABLE_START] = sText_EchoScepterActivates,
    [STRINGID_WONDERSHIELDNULLIFIED - BATTLESTRINGS_TABLE_START] = sText_WonderShieldNullified,
    [STRINGID_BRIARBRACERACTIVATES - BATTLESTRINGS_TABLE_START] = sText_BriarBracerActivates,
    [STRINGID_TRICKYBOXACTIVATES - BATTLESTRINGS_TABLE_START] = sText_TrickyBoxActivates,
    [STRINGID_ECLIPSEORBREVEALED - BATTLESTRINGS_TABLE_START] = sText_EclipseOrbRevealed,
    [STRINGID_PHANTOMSTONEREVEALED - BATTLESTRINGS_TABLE_START] = sText_PhantomStoneRevealed,
    [STRINGID_DECOYDOLLCREATED - BATTLESTRINGS_TABLE_START] = sText_DecoyDollCreated,
    ...
    [STRINGID_DRIVEPROTOCOLCLEAREDHAZARDS - BATTLESTRINGS_TABLE_START] = sText_DriveProtocolClearedHazards,
    ...
    [STRINGID_BOOSTERENERGYACTIVATEDABILITY - BATTLESTRINGS_TABLE_START] = sText_BoosterEnergyActivatedAbility,
    ...
    [STRINGID_CLEARARMORBLOCKSSTATS - BATTLESTRINGS_TABLE_START] = sText_ClearArmorBlocksStats,
    ...
    [STRINGID_ACIDRAINHEALS - BATTLESTRINGS_TABLE_START] = sText_AcidRainHeals,
    ...
    [STRINGID_ITSEXTREMELYEFFECTIVE - BATTLESTRINGS_TABLE_START] = sText_ExtremelyEffective,
    [STRINGID_ITSMOSTLYINEFFECTIVE - BATTLESTRINGS_TABLE_START] = sText_MostlyIneffective,
    ...
    [STRINGID_TERRAINBECOMESPLAIN - BATTLESTRINGS_TABLE_START] = sText_TerrainBecomesPlain,
    [STRINGID_PLAINTERRAINENDS - BATTLESTRINGS_TABLE_START] = sText_PlainTerrainEnds,
    [STRINGID_SPLITINSTINCTSPEED - BATTLESTRINGS_TABLE_START] = sText_SplitInstinctSpeed,
    [STRINGID_SPLITINSTINCTHEAL - BATTLESTRINGS_TABLE_START] = sText_SplitInstinctHeal,
    [STRINGID_SPLITINSTINCTDEBUFF - BATTLESTRINGS_TABLE_START] = sText_SplitInstinctDebuff,
    ...
    [STRINGID_IONIZEDMG - BATTLESTRINGS_TABLE_START] = sText_IonizeDmg,
    [STRINGID_PASTURIZEDHEAL - BATTLESTRINGS_TABLE_START] = sText_PasturizedHeal,
    [STRINGID_TIDALFLOODWASHEDAWAY - BATTLESTRINGS_TABLE_START] = sText_TidalFloodWashedAway,
    [STRINGID_PICKUPCLEAREDHAZARDS - BATTLESTRINGS_TABLE_START] = sText_PickupClearedHazards,
    [STRINGID_DESERTSHROUDSOFTENED - BATTLESTRINGS_TABLE_START] = sText_DesertShroudSoftened,
    [STRINGID_PSYCHICPARRYREADY - BATTLESTRINGS_TABLE_START] = sText_PsychicParryReady,
    [STRINGID_PSYCHICPARRIED - BATTLESTRINGS_TABLE_START] = sText_PsychicParried,
    [STRINGID_ROOTNETWORKRESTORED - BATTLESTRINGS_TABLE_START] = sText_RootNetworkRestored,
    [STRINGID_SCORCHINGRELAYGUARDED - BATTLESTRINGS_TABLE_START] = sText_ScorchingRelayGuarded,
    [STRINGID_TIDALSWITCHCHARGED - BATTLESTRINGS_TABLE_START] = sText_TidalSwitchCharged,
    [STRINGID_RKSRELAYTRANSFERRED - BATTLESTRINGS_TABLE_START] = sText_RksRelayTransferred,
    [STRINGID_CONTROLMASKSTABILIZED - BATTLESTRINGS_TABLE_START] = sText_ControlMaskStabilized,
    [STRINGID_GEODEHEARTCHARGED - BATTLESTRINGS_TABLE_START] = sText_GeodeHeartCharged,
    [STRINGID_GEODEHEARTRELEASED - BATTLESTRINGS_TABLE_START] = sText_GeodeHeartReleased,
    [STRINGID_MOODSWINGELATED - BATTLESTRINGS_TABLE_START] = sText_MoodSwingElated,
    [STRINGID_MOODSWINGANXIOUS - BATTLESTRINGS_TABLE_START] = sText_MoodSwingAnxious,
    [STRINGID_PKMNMAINTYPECHANGED - BATTLESTRINGS_TABLE_START] = sText_PkmnMainTypeChanged,
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_TERRAIN_SET_PLAIN] = STRINGID_TERRAINBECOMESPLAIN,
    ...
    [B_MSG_TERRAIN_END_PLAIN] = STRINGID_PLAINTERRAINENDS,
};
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_ECLIPSE]            = STRINGID_ECLIPSESTARTED,
    [WEATHER_ACID_RAIN]          = STRINGID_ACIDRAINSTARTED,
};
