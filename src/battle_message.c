...
static const u8 sText_ScorchingRelayCharged[] = _("{B_DEF_NAME_WITH_PREFIX} was charged\nby {B_BUFF1}!");
static const u8 sText_TidalSwitchGuarded[] = _("{B_DEF_NAME_WITH_PREFIX} was guarded\nby {B_BUFF1}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_SCORCHINGRELAYCHARGED - BATTLESTRINGS_TABLE_START] = sText_ScorchingRelayCharged,
    [STRINGID_TIDALSWITCHGUARDED - BATTLESTRINGS_TABLE_START] = sText_TidalSwitchGuarded,
