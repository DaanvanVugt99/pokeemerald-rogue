...
static const u8
    sText_PkmnWasParalyzedBy[] = _(
        "{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nparalyzed {B_EFF_NAME_WITH_PREFIX}!\lIt may be "
        "unable " "to move!");
...
static const u8 sText_PkmnCantUseMoveTorment[] = _(
    "{B_ATK_NAME_WITH_PREFIX} can't use the same\nmove in a row due to the Torment!\p");
static const u8 sText_PkmnCantUseMoveTaunt[] = _(
    "{B_ATK_NAME_WITH_PREFIX} can't use\n{B_CURRENT_MOVE} after the Taunt!\p");
...
static const u8 sText_PkmnHurtsWith[] = _(
    "{B_ATK_NAME_WITH_PREFIX} was hurt by\n{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!");
...
static const u8
    sText_PkmnsAbilityPreventsAbility[] = _(
        "{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nprevents "
...
static const u8 sText_DownpourStarted[] = _(
    "A downpour started!");  // corresponds to DownpourText in pokegold and pokecrystal and is used by Rain Dance in GSC
...
const u8* const gStatNamesTable[NUM_BATTLE_STATS] = {sText_HP,       sText_Attack,     sText_Defense,
...
static const u8 sText_GotchaPkmnCaughtWally[] = _(
...
static const u8 sText_PkmnsItemHealedFrostbite[] = _(
    "{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nhealed its frostbite!");
...
static const u8 sText_PowerHerbActivation[] = _(
...
static const u8 sText_DrySkinHpDrop[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ncracks in the sunlight!");
...
static const u8 sText_SymbiosisItemPass[] = _(
    "{B_SCR_ACTIVE_NAME_WITH_PREFIX} passed its {B_LAST_ITEM}\nto {B_ATK_NAME_WITH_PREFIX} through {B_LAST_ABILITY}!");
...
static const u8 sText_SpikesDisappearedFromTeam[] = _(
    "The spikes disappeared from\nthe ground around {B_ATK_TEAM2} team!");
static const u8 sText_ToxicSpikesDisappearedFromTeam[] = _(
    "The poison spikes disappeared from\nthe ground around {B_ATK_TEAM2} team!");
static const u8 sText_StealthRockDisappearedFromTeam[] = _(
    "The pointed stones disappeared\nfrom around {B_ATK_TEAM2} team!");
static const u8 sText_StickyWebDisappearedFromTeam[] = _(
    "The sticky web has disappeared from\nthe ground around {B_ATK_TEAM2} team!");
...
static const u8 sText_ClearAmuletWontLowerStats[] = _(
    "{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM} prevents\nits stats from being lowered!");
...
static const u8 sText_PkmnMadeShellGleam[] = _(
    "{B_DEF_NAME_WITH_PREFIX} made its shell gleam!\nIt's distorting type matchups!");
static const u8 sText_CuriousMedicineEnters[] = _("All stat changes were\nreset!");
...
static const u8 sText_AttackerBrokeThroughParalysis[] = _(
    "{B_ATK_NAME_WITH_PREFIX} gathered all its energy\nto overcome its paralysis!");
static const u8 sText_AttackerHealedItsBurn[] = _(
    "{B_ATK_NAME_WITH_PREFIX} healed its burn with\nits sheer determination!");
static const u8 sText_AttackerHealedItsFrostbite[] = _(
    "{B_ATK_NAME_WITH_PREFIX} healed its frostbite with\nits sheer determination!");
static const u8 sText_AttackerMeltedTheIce[] = _(
    "{B_ATK_NAME_WITH_PREFIX} melted the ice with\nits fiery determination!");
...
static const u8 sText_AttackerSwitchedStatWithTarget[] = _(
    "{B_ATK_NAME_WITH_PREFIX} switched {B_BUFF1}\nwith its target!");
static const u8 sText_BeingHitChargedPkmnWithPower[] = _(
    "Being hit by {B_CURRENT_MOVE}\ncharged {B_DEF_NAME_WITH_PREFIX} with power!");
static const u8 sText_SunlightActivatedAbility[] = _(
    "The harsh sunlight activated\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!");
static const u8 sText_StatWasHeightened[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1} was heightened!");
static const u8 sText_ElectricTerrainActivatedAbility[] = _(
    "The Electric Terrain activated\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!");
static const u8 sText_AbilityWeakenedSurroundingMonsStat[] = _(
    "{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nweakened the {B_BUFF1} of\lall surrounding Pokémon!\p");
static const u8 sText_AttackerGainedStrengthFromTheFallen[] = _(
    "{B_ATK_NAME_WITH_PREFIX} gained strength\nfrom the fallen!");
...
static const u8 sText_SharpSteelDisappearedFromTeam[] = _(
    "The sharp steel disappeared from\nthe ground around {B_ATK_TEAM2} team!");
static const u8 sText_TeamTrappedWithVines[] = _("{B_DEF_TEAM1} team got trapped\nwith vines!");
static const u8 sText_PkmnHurtByVines[] = _(
    "{B_ATK_NAME_WITH_PREFIX} is hurt by\nG-Max Vine Lash's ferocious beating!");
...
static const u8 sText_PkmnHurtByRocksThrown[] = _(
    "{B_ATK_NAME_WITH_PREFIX} is hurt by\nrocks thrown out by G-Max Volcalith!");
static const u8 sText_CouldntFullyProtect[] = _(
    "{B_DEF_NAME_WITH_PREFIX} couldn't fully protect\nitself and got hurt!");
...
static const u8 sText_MirrorHerbCopied[] = _(
    "{B_SCR_ACTIVE_NAME_WITH_PREFIX} used its {B_LAST_ITEM}\nto mirror its opponent's stat changes!");
static const u8 sText_PkmnItemMelted[] = _(
    "{B_ATK_NAME_WITH_PREFIX} corroded\n{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!");
static const u8 sText_UltraBurstReacting[] = _("Bright light is about to\nburst out of {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_UltraBurstCompleted[] = _(
    "{B_ATK_NAME_WITH_PREFIX} regained its\ntrue power through Ultra Burst!");
...
static const u8 sText_PkmnTellChillingReceptionJoke[] = _(
    "{B_ATK_NAME_WITH_PREFIX} is preparing to tell a\nchillingly bad joke!");
...
static const u8 sText_WaitingForPartnersMove[] = _(
    "{B_ATK_NAME_WITH_PREFIX} is waiting\nfor {B_ATK_PARTNER_NAME}'s move…{PAUSE 16}");
...
static const u8 sText_HospitalityRestoration[] = _(
    "{B_ATK_PARTNER_NAME} drank down all the\nmatcha that {B_ATK_NAME_WITH_PREFIX} made!");
static const u8 sText_SupersweetAromaWafts[] = _(
...
static const u8 sText_PkmnsXCausedAcidRain[] = _(
...
static const u8 sText_AbilityRemovesHazards[] = _(
    "{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nremoved the hazards on its side!");
static const u8 sText_PkmnSheds[] = _("{B_DEF_NAME_WITH_PREFIX} shed its skin\nand recovered!");
...
const u8* const gBattleStringsTable[BATTLESTRINGS_COUNT] = {
    ...
    [STRINGID_DRYSKINHPDROP - BATTLESTRINGS_TABLE_START] = sText_DrySkinHpDrop,
    ...
    [STRINGID_PKMNSCORCHEDBYACIDRAIN - BATTLESTRINGS_TABLE_START] = sText_PkmnScorchedByAcidRain,
    [STRINGID_PKMNSXCAUSEDACIDRAIN - BATTLESTRINGS_TABLE_START] = sText_PkmnsXCausedAcidRain,
    ...
    [STRINGID_ABILITYREMOVESHAZARDS - BATTLESTRINGS_TABLE_START] = sText_AbilityRemovesHazards,
    [STRINGID_PKMNSHEDS - BATTLESTRINGS_TABLE_START] = sText_PkmnSheds,

};

const u16 gTrainerUsedItemStringIds[] = {STRINGID_PLAYERUSEDITEM, STRINGID_TRAINER1USEDITEM};

const u16 gZEffectStringIds[] = {
    [B_MSG_Z_RESET_STATS] = STRINGID_ZMOVERESETSSTATS, [B_MSG_Z_ALL_STATS_UP] = STRINGID_ZMOVEALLSTATSUP,
    [B_MSG_Z_BOOST_CRITS] = STRINGID_ZMOVEZBOOSTCRIT,  [B_MSG_Z_FOLLOW_ME] = STRINGID_PKMNCENTERATTENTION,
    [B_MSG_Z_RECOVER_HP] = STRINGID_ZMOVERESTOREHP,    [B_MSG_Z_STAT_UP] = STRINGID_ZMOVESTATUP,
...
const u16 gTerrainPreventsStringIds[] = {[B_MSG_TERRAINPREVENTS_MISTY] = STRINGID_MISTYTERRAINPREVENTS,
...
const u16 gDmgHazardsStringIds[] = {
    [B_MSG_PKMNHURTBYSPIKES] = STRINGID_PKMNHURTBYSPIKES, [B_MSG_STEALTHROCKDMG] = STRINGID_STEALTHROCKDMG,
    [B_MSG_SHARPSTEELDMG] = STRINGID_SHARPSTEELDMG,       [B_MSG_POINTEDSTONESFLOAT] = STRINGID_POINTEDSTONESFLOAT,
    [B_MSG_SPIKESSCATTERED] = STRINGID_SPIKESSCATTERED,   [B_MSG_SHARPSTEELFLOATS] = STRINGID_SHARPSTEELFLOATS,
};
...
const u16 gNoEscapeStringIds[] = {[B_MSG_CANT_ESCAPE] = STRINGID_CANTESCAPE,
...
const u16 gMoveWeatherChangeStringIds[] = {
    ...
    [B_MSG_WEATHER_FAILED] = STRINGID_BUTITFAILED,         [B_MSG_STARTED_SANDSTORM] = STRINGID_SANDSTORMBREWED,
    [B_MSG_STARTED_SUNLIGHT] = STRINGID_SUNLIGHTGOTBRIGHT, [B_MSG_STARTED_HAIL] = STRINGID_STARTEDHAIL,
    [B_MSG_STARTED_SNOW] = STRINGID_STARTEDSNOW,           [B_MSG_STARTED_ACID_RAIN] = STRINGID_STARTEDACIDRAIN,
};
...
const u16 gSandStormHailSnowAcidContinuesStringIds[] = {[B_MSG_SANDSTORM] = STRINGID_SANDSTORMRAGES,
                                                        [B_MSG_HAIL] = STRINGID_HAILCONTINUES,
                                                        [B_MSG_SNOW] = STRINGID_SNOWCONTINUES,
                                                        [B_MSG_ACID_RAIN] = STRINGID_ACIDRAINCONTINUES};

const u16 gSandStormHailAcidDmgStringIds[] = {[B_MSG_SANDSTORM] = STRINGID_PKMNBUFFETEDBYSANDSTORM,
                                              [B_MSG_HAIL] = STRINGID_PKMNPELTEDBYHAIL,
                                              [B_MSG_ACID_RAIN] = STRINGID_PKMNSCORCHEDBYACIDRAIN};

const u16 gSandStormHailSnowAcidEndStringIds[] = {[B_MSG_SANDSTORM] = STRINGID_SANDSTORMSUBSIDED,
                                                  [B_MSG_HAIL] = STRINGID_HAILSTOPPED,
                                                  [B_MSG_SNOW] = STRINGID_SNOWSTOPPED,
                                                  [B_MSG_ACID_RAIN] = STRINGID_ACIDRAINSTOPPED};

const u16 gRainContinuesStringIds[] = {[B_MSG_RAIN_CONTINUES] = STRINGID_RAINCONTINUES,
...
const u16 gLeechSeedStringIds[] = {
    [B_MSG_LEECH_SEED_SET] = STRINGID_PKMNSEEDED,          [B_MSG_LEECH_SEED_MISS] = STRINGID_PKMNEVADEDATTACK,
    [B_MSG_LEECH_SEED_FAIL] = STRINGID_ITDOESNTAFFECT,     [B_MSG_LEECH_SEED_DRAIN] = STRINGID_PKMNSAPPEDBYLEECHSEED,
    [B_MSG_LEECH_SEED_OOZE] = STRINGID_ITSUCKEDLIQUIDOOZE,
};

const u16 gRestUsedStringIds[] =
    {[B_MSG_REST] = STRINGID_PKMNWENTTOSLEEP, [B_MSG_REST_STATUSED] = STRINGID_PKMNSLEPTHEALTHY};

const u16 gUproarOverTurnStringIds[] =
    {[B_MSG_UPROAR_CONTINUES] = STRINGID_PKMNMAKINGUPROAR, [B_MSG_UPROAR_ENDS] = STRINGID_PKMNCALMEDDOWN};
...
const u16 gWokeUpStringIds[] =
    {[B_MSG_WOKE_UP] = STRINGID_PKMNWOKEUP, [B_MSG_WOKE_UP_UPROAR] = STRINGID_PKMNWOKEUPINUPROAR};

const u16 gSwallowFailStringIds[] =
    {[B_MSG_SWALLOW_FAILED] = STRINGID_FAILEDTOSWALLOW, [B_MSG_SWALLOW_FULL_HP] = STRINGID_PKMNHPFULL};
...
const u16 gStatUpStringIds[] = {
    [B_MSG_ATTACKER_STAT_ROSE] = STRINGID_ATTACKERSSTATROSE,   [B_MSG_DEFENDER_STAT_ROSE] = STRINGID_DEFENDERSSTATROSE,
    [B_MSG_STAT_WONT_INCREASE] = STRINGID_STATSWONTINCREASE,   [B_MSG_STAT_ROSE_EMPTY] = STRINGID_EMPTYSTRING3,
    [B_MSG_STAT_ROSE_ITEM] = STRINGID_USINGITEMSTATOFPKMNROSE, [B_MSG_USED_DIRE_HIT] = STRINGID_PKMNUSEDXTOGETPUMPED,
};
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] = {
    ...
    [B_MSG_WRAPPED_MOVE] = STRINGID_ABILITYTRAPPED,  // General Trapping string
};

const u16 gMistUsedStringIds[] =
    {[B_MSG_SET_MIST] = STRINGID_PKMNSHROUDEDINMIST, [B_MSG_MIST_FAILED] = STRINGID_BUTITFAILED};

const u16 gFocusEnergyUsedStringIds[] =
    {[B_MSG_GETTING_PUMPED] = STRINGID_PKMNGETTINGPUMPED, [B_MSG_FOCUS_ENERGY_FAILED] = STRINGID_BUTITFAILED};

const u16 gTransformUsedStringIds[] =
    {[B_MSG_TRANSFORMED] = STRINGID_PKMNTRANSFORMEDINTO, [B_MSG_TRANSFORM_FAILED] = STRINGID_BUTITFAILED};

const u16 gSubstituteUsedStringIds[] =
    {[B_MSG_SET_SUBSTITUTE] = STRINGID_PKMNMADESUBSTITUTE, [B_MSG_SUBSTITUTE_FAILED] = STRINGID_TOOWEAKFORSUBSTITUTE};

const u16 gGotPoisonedStringIds[] =
    {[B_MSG_STATUSED] = STRINGID_PKMNWASPOISONED, [B_MSG_STATUSED_BY_ABILITY] = STRINGID_PKMNPOISONEDBY};

const u16 gGotParalyzedStringIds[] =
    {[B_MSG_STATUSED] = STRINGID_PKMNWASPARALYZED, [B_MSG_STATUSED_BY_ABILITY] = STRINGID_PKMNWASPARALYZEDBY};
...
const u16 gGotBurnedStringIds[] =
    {[B_MSG_STATUSED] = STRINGID_PKMNWASBURNED, [B_MSG_STATUSED_BY_ABILITY] = STRINGID_PKMNBURNEDBY};

const u16 gGotFrostbiteStringIds[] = {[B_MSG_STATUSED] = STRINGID_PKMNGOTFROSTBITE};

const u16 gFrostbiteHealedStringIds[] = {[B_MSG_FROSTBITE_HEALED] = STRINGID_PKMNFROSTBITEHEALED2,
                                         [B_MSG_FROSTBITE_HEALED_BY_MOVE] = STRINGID_PKMNFROSTBITEHEALEDBY};

const u16 gGotFrozenStringIds[] =
    {[B_MSG_STATUSED] = STRINGID_PKMNWASFROZEN, [B_MSG_STATUSED_BY_ABILITY] = STRINGID_PKMNFROZENBY};

const u16 gGotDefrostedStringIds[] =
    {[B_MSG_DEFROSTED] = STRINGID_PKMNWASDEFROSTED2, [B_MSG_DEFROSTED_BY_MOVE] = STRINGID_PKMNWASDEFROSTEDBY};

const u16 gKOFailedStringIds[] =
    {[B_MSG_KO_MISS] = STRINGID_ATTACKMISSED, [B_MSG_KO_UNAFFECTED] = STRINGID_PKMNUNAFFECTED};

const u16 gAttractUsedStringIds[] =
    {[B_MSG_STATUSED] = STRINGID_PKMNFELLINLOVE, [B_MSG_STATUSED_BY_ABILITY] = STRINGID_PKMNSXINFATUATEDY};

const u16 gAbsorbDrainStringIds[] =
    {[B_MSG_ABSORB] = STRINGID_PKMNENERGYDRAINED, [B_MSG_ABSORB_OOZE] = STRINGID_ITSUCKEDLIQUIDOOZE};

const u16 gSportsUsedStringIds[] =
    {[B_MSG_WEAKEN_ELECTRIC] = STRINGID_ELECTRICITYWEAKENED, [B_MSG_WEAKEN_FIRE] = STRINGID_FIREWEAKENED};

const u16 gPartyStatusHealStringIds[] = {[B_MSG_BELL] = STRINGID_BELLCHIMED,
...
const u16 gFutureMoveUsedStringIds[] =
    {[B_MSG_FUTURE_SIGHT] = STRINGID_PKMNFORESAWATTACK, [B_MSG_DOOM_DESIRE] = STRINGID_PKMNCHOSEXASDESTINY};
...
const u16 gInobedientStringIds[] = {[B_MSG_LOAFING] = STRINGID_PKMNLOAFING,
...
const u16 gSafariGetNearStringIds[] =
    {[B_MSG_CREPT_CLOSER] = STRINGID_CREPTCLOSER, [B_MSG_CANT_GET_CLOSER] = STRINGID_CANTGETCLOSER};

const u16 gSafariPokeblockResultStringIds[] = {[B_MSG_MON_CURIOUS] = STRINGID_PKMNCURIOUSABOUTX,
...
const u16 gBRNPreventionStringIds[] = {[B_MSG_ABILITY_PREVENTS_MOVE_STATUS] = STRINGID_PKMNSXPREVENTSBURNS,
                                       [B_MSG_ABILITY_PREVENTS_ABILITY_STATUS] = STRINGID_PKMNSXPREVENTSYSZ,
                                       [B_MSG_STATUS_HAD_NO_EFFECT] = STRINGID_PKMNSXHADNOEFFECTONY};

const u16 gPRLZPreventionStringIds[] = {[B_MSG_ABILITY_PREVENTS_MOVE_STATUS] = STRINGID_PKMNPREVENTSPARALYSISWITH,
                                        [B_MSG_ABILITY_PREVENTS_ABILITY_STATUS] = STRINGID_PKMNSXPREVENTSYSZ,
                                        [B_MSG_STATUS_HAD_NO_EFFECT] = STRINGID_PKMNSXHADNOEFFECTONY};

const u16 gPSNPreventionStringIds[] = {[B_MSG_ABILITY_PREVENTS_MOVE_STATUS] = STRINGID_PKMNPREVENTSPOISONINGWITH,
                                       [B_MSG_ABILITY_PREVENTS_ABILITY_STATUS] = STRINGID_PKMNSXPREVENTSYSZ,
                                       [B_MSG_STATUS_HAD_NO_EFFECT] = STRINGID_PKMNSXHADNOEFFECTONY};

const u16 gItemSwapStringIds[] = {[B_MSG_ITEM_SWAP_TAKEN] = STRINGID_PKMNOBTAINEDX,
                                  [B_MSG_ITEM_SWAP_GIVEN] = STRINGID_PKMNOBTAINEDX2,
                                  [B_MSG_ITEM_SWAP_BOTH] = STRINGID_PKMNOBTAINEDXYOBTAINEDZ};

const u16 gFlashFireStringIds[] = {[B_MSG_FLASH_FIRE_BOOST] = STRINGID_PKMNRAISEDFIREPOWERWITH,
...
const u16 gRoomsStringIds[] = {STRINGID_PKMNTWISTEDDIMENSIONS,
...
const u16 gStatusConditionsStringIds[] = {STRINGID_PKMNWASPOISONED, STRINGID_PKMNBADLYPOISONED,
                                          STRINGID_PKMNWASBURNED,   STRINGID_PKMNWASPARALYZED,
                                          STRINGID_PKMNFELLASLEEP,  STRINGID_PKMNGOTFROSTBITE};

const u16 gStatus2StringIds[] = {STRINGID_PKMNWASCONFUSED, STRINGID_PKMNFELLINLOVE, STRINGID_TARGETCANTESCAPENOW,
...
const u8 gText_SafariZoneMenu[] = _(
    "Catch{CLEAR_TO 56}{FONT_SMALL_NARROW}Swap Ball\n{CLEAR_TO 56}{FONT_NORMAL}Run {B_BUTTON}");
const u8 gText_SafariZoneMenuNoBallSwap[] = _(
        "Catch{CLEAR_TO 56}{FONT_SMALL_NARROW}{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}Swap Ball\n"
...
// Unused
static const u8* const sStatNamesTable2[] = {gText_HP3,   gText_SpAtk,   gText_Attack,
...
static const u8
    sText_TwoTrainersSentPkmn[] =
        _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} sent\nout {B_OPPONENT_MON1_NAME}!\p{B_TRAINER2_CLASS} "
          "{B_TRAINER2_NAME} " "sent\nout {B_OPPONENT_MON2_NAME}!");
...
static const struct BattleWindowText* const sBattleTextOnWindowsInfo[] =
    {[B_WIN_TYPE_NORMAL] = sTextOnWindowsInfo_Normal, [B_WIN_TYPE_ARENA] = sTextOnWindowsInfo_Arena};
    ...
    case STRINGID_INTROSENDOUT:  // poke first send-out
      if (GetBattlerSide(battler) == B_SIDE_PLAYER)
      {
        if (gBattleTypeFlags & BATTLE_TYPE_DOUBLE &&
            IsValidForBattle(&gPlayerParty[gBattlerPartyIndexes[BATTLE_PARTNER(battler)]]))
        {
    ...
    if (*src == PLACEHOLDER_BEGIN)
    {
      ...
      switch (*src)
      {
        ...
        case B_TXT_TRAINER1_NAME:  // trainer1 name
          toCpy = BattleStringGetOpponentNameByTrainerId(gTrainerBattleOpponent_A, text, multiplayerId,
        ...
        case B_TXT_LINK_OPPONENT2_NAME:  // link opponent 2 name
          toCpy = gLinkPlayers[GetBattlerMultiplayerId(BATTLE_PARTNER(BATTLE_OPPOSITE(gLinkPlayers[multiplayerId].id)))]
                      .name;
          break;
        ...
        case B_TXT_TRAINER2_NAME:
          toCpy = BattleStringGetOpponentNameByTrainerId(gTrainerBattleOpponent_B, text, multiplayerId,
      ...
      if (*src == B_TXT_TRAINER1_LOSE_TEXT || *src == B_TXT_TRAINER2_LOSE_TEXT || *src == B_TXT_TRAINER1_WIN_TEXT ||
...
static void IllusionNickHack(u32 battler, u32 partyId, u8* dst)
{
  ...
  if (GetMonAbility(mon) == ABILITY_ILLUSION)
  {
    ...
    {
      id = i;
      if (GetMonData(&gEnemyParty[id], MON_DATA_SANITY_HAS_SPECIES) && GetMonData(&gEnemyParty[id], MON_DATA_HP) &&
          &gEnemyParty[id] != mon && &gEnemyParty[id] != partnerMon)
      {
...
void SetPpNumbersPaletteInMoveSelection(u32 battler)
{
  ...
  {
    var = GetCurrentPpToMaxPpState(chooseMoveStruct->currentPp[gMoveSelectionCursor[battler]],
                                   gBattleMoves[gMoveSelectionCursor[battler]].pp);
  }
         ...
         (!(gBattleTypeFlags & BATTLE_TYPE_FRONTIER) && !sTrainerSlides[i].isFrontierTrainer)))
    {
      ...
      switch (which)
      {
        ...
        case TRAINER_SLIDE_LAST_LOW_HP:
          if (sTrainerSlides[i].msgLastLowHp != NULL && GetEnemyMonCount(firstId, lastId, TRUE) == 1 &&
              BattlerHPPercentage(battler, GREATER_THAN_OR_EQUAL, 4) && !gBattleStruct->trainerSlideLowHpMsgDone)
          {
        ...
        case TRAINER_SLIDE_FIRST_DOWN:
          if (sTrainerSlides[i].msgFirstDown != NULL &&
        ...
        case TRAINER_SLIDE_FIRST_SUPER_EFFECTIVE_HIT:
          if (sTrainerSlides[i].msgFirstSuperEffectiveHit != NULL &&
              gBattleStruct->trainerSlideFirstSuperEffectiveHitMsgState == 1 && gBattleMons[battler].hp)
          {
        ...
        case TRAINER_SLIDE_FIRST_STAB_MOVE:
          if (sTrainerSlides[i].msgFirstSTABMove != NULL && gBattleStruct->trainerSlideFirstSTABMoveMsgState == 1 &&
