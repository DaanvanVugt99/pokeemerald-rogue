...
const u8 gText_CancelStarterChoice[] = _("Leave without choosing a new\nPartner Pokémon?");
...
const u8 gText_YouDontHaveEnoughVar1[] = _("You don't have enough\n{STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SwapWithWhichPokemon[] = _("Swap with which Pokémon?");
...
const u8 gText_DoWhatWithHeldItem[] = _("Do what with\n{STR_VAR_2}?");
...
const u8 gText_PkmnSwappedHeldItems[] = _("{STR_VAR_1} and {STR_VAR_2}\nswapped held items.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MoreSpeeds[] = _("More Speeds...");
const u8 gText_CutsceneSpeed[] = _("Cutscene Anims");
const u8 gText_EvolutionSpeed[] = _("Evolution Anims");
const u8 gText_CatchingSpeed[] = _("Catching Anims");
...
const u8 gText_NamePokemonHub[] = _("Name of the base?");
