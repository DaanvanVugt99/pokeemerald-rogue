...
#define SINGLES_DYNAMAX_TRIGGER_POS_X_OPTIMAL (38)
#define SINGLES_DYNAMAX_TRIGGER_POS_X_PRIORITY (39)
#define SINGLES_DYNAMAX_TRIGGER_POS_X_SLIDE (15)
#define SINGLES_DYNAMAX_TRIGGER_POS_Y_DIFF (-8)

#define DOUBLES_DYNAMAX_TRIGGER_POS_X_OPTIMAL (38)
#define DOUBLES_DYNAMAX_TRIGGER_POS_X_PRIORITY (39)
#define DOUBLES_DYNAMAX_TRIGGER_POS_X_SLIDE (15)
#define DOUBLES_DYNAMAX_TRIGGER_POS_Y_DIFF (-1)
