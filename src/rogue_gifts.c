...
#define DYNAMIC_UNIQUE_ABILITY_MAX ABILITY_FALSE_GROUND
...
STATIC_ASSERT(DYNAMIC_UNIQUE_ABILITY_COUNT == 565, DynamicUniqueAbilityPoolAuditCount);
...
static const u16 sDynamicUniqueAbilitySynergyMoves[ABILITIES_COUNT] =
{
    ...
    [ABILITY_SWORD_AND_BOARD] = MOVE_PROTECT,
    [ABILITY_WANDERING_HUNTER] = MOVE_BULK_UP,
    [ABILITY_SMOG_REFINERY] = MOVE_STRANGE_STEAM,
    ...
    [ABILITY_ROYAL_REBUKE] = MOVE_TAUNT,
    ...
    [ABILITY_BOUNTIFUL_REIGN] = MOVE_TAUNT,
    [ABILITY_FROZEN_REIGN] = MOVE_TAUNT,
    [ABILITY_DREAD_REIGN] = MOVE_TAUNT,
    [ABILITY_TUNDRA_REIGN] = MOVE_TAUNT,
    [ABILITY_ASTRAL_REIGN] = MOVE_TAUNT,
