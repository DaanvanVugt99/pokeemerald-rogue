...
#define DYNAMIC_SYNERGY_PROFILE_MOVE_COUNT 5
#define DYNAMIC_SYNERGY_CHOICE_NATURAL DYNAMIC_SYNERGY_PROFILE_MOVE_COUNT
...
{
    u16 moves[DYNAMIC_SYNERGY_PROFILE_MOVE_COUNT];
};
...
static const u16 sDynamicUniqueAbilitySynergyProfiles[ABILITIES_COUNT] =
{
    ...
    [ABILITY_TANTRUM] = DYNAMIC_SYNERGY_PROFILE_LOW_ACCURACY,
    ...
    [ABILITY_TOXIC_DELUGE] = DYNAMIC_SYNERGY_PROFILE_TYPE_ANY(TYPE_POISON),
    ...
    [ABILITY_MARKSMAN] = DYNAMIC_SYNERGY_PROFILE_LOW_ACCURACY,
    ...
    [ABILITY_MONSOON] = DYNAMIC_SYNERGY_PROFILE_LOW_ACCURACY,
    ...
    [ABILITY_INTENT] = DYNAMIC_SYNERGY_PROFILE_LOW_ACCURACY,
...
static struct DynamicSynergyProfile GetDynamicSynergyProfile(u16 profileId)
{
    ...
    case DYNAMIC_SYNERGY_PROFILE_LOW_ACCURACY:
        profile = (struct DynamicSynergyProfile){{
            MOVE_DYNAMIC_PUNCH, MOVE_ZAP_CANNON, MOVE_INFERNO, MOVE_SING, MOVE_FOCUS_BLAST
        }};
        break;
...
static bool8 DoesMoveMatchDynamicSynergyProfile(u16 profileId, u16 move)
{
    ...
    case DYNAMIC_SYNERGY_PROFILE_LOW_ACCURACY:
        return gBattleMoves[move].accuracy != 0 && gBattleMoves[move].accuracy <= 70;
...
static u16 GetDynamicUniqueAbilitySynergyMove(u16 ability, u8 choice)
{
    ...
    if(choice >= ARRAY_COUNT(profile.moves))
        return MOVE_NONE;
...
static struct SelectedDynamicSynergy SelectDynamicSynergyFromProfile(u16 species, u16 profileId, const u16* suppliedMoves, u8 suppliedMoveCount)
{
    ...
    struct DynamicSynergyProfile profile = GetDynamicSynergyProfile(profileId);
    u16 weights[ARRAY_COUNT(profile.moves)] = {0};
    u16 totalWeight = 0;
    u16 roll;
    u8 i;
