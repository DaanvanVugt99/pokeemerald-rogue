...
static const s32 sExperienceScalingFactors[] = {
    0,      0,      1,      3,      8,      13,     22,     32,     45,     60,     79,     100,    124,    152,
    183,    217,    256,    297,    343,    393,    447,    505,    567,    634,    705,    781,    861,    946,
    1037,   1132,   1232,   1337,   1448,   1563,   1685,   1811,   1944,   2081,   2225,   2374,   2529,   2690,
    2858,   3031,   3210,   3396,   3587,   3786,   3990,   4201,   4419,   4643,   4874,   5112,   5357,   5608,
    5866,   6132,   6404,   6684,   6971,   7265,   7566,   7875,   8192,   8515,   8847,   9186,   9532,   9886,
    10249,  10619,  10996,  11382,  11776,  12178,  12588,  13006,  13433,  13867,  14310,  14762,  15222,  15690,
    16167,  16652,  17146,  17649,  18161,  18681,  19210,  19748,  20295,  20851,  21417,  21991,  22574,  23166,
    23768,  24379,  25000,  25629,  26268,  26917,  27575,  28243,  28920,  29607,  30303,  31010,  31726,  32452,
    33188,  33934,  34689,  35455,  36231,  37017,  37813,  38619,  39436,  40262,  41099,  41947,  42804,  43673,
    44551,  45441,  46340,  47251,  48172,  49104,  50046,  50999,  51963,  52938,  53924,  54921,  55929,  56947,
    57977,  59018,  60070,  61133,  62208,  63293,  64390,  65498,  66618,  67749,  68891,  70045,  71211,  72388,
    73576,  74777,  75989,  77212,  78448,  79695,  80954,  82225,  83507,  84802,  86109,  87427,  88758,  90101,
    91456,  92823,  94202,  95593,  96997,  98413,  99841,  101282, 102735, 104201, 105679, 107169, 108672, 110188,
    111716, 113257, 114811, 116377, 117956, 119548, 121153, 122770, 124401, 126044, 127700, 129369, 131052, 132747,
    134456, 136177, 137912, 139660, 141421, 143195, 144983, 146784, 148598, 150426, 152267, 154122, 155990, 157872,
    159767,
};

static const u16 sTrappingMoves[NUM_TRAPPING_MOVES] = {
    MOVE_BIND,      MOVE_WRAP,        MOVE_FIRE_SPIN,   MOVE_CLAMP,     MOVE_WHIRLPOOL,
    MOVE_SAND_TOMB, MOVE_MAGMA_STORM, MOVE_INFESTATION, MOVE_SNAP_TRAP,
};
...
static const u8* const sMoveEffectBS_Ptrs[] = {
    [MOVE_EFFECT_SLEEP] = BattleScript_MoveEffectSleep,         [MOVE_EFFECT_POISON] = BattleScript_MoveEffectPoison,
    [MOVE_EFFECT_BURN] = BattleScript_MoveEffectBurn,           [MOVE_EFFECT_FREEZE] = BattleScript_MoveEffectFreeze,
    [MOVE_EFFECT_PARALYSIS] = BattleScript_MoveEffectParalysis, [MOVE_EFFECT_TOXIC] = BattleScript_MoveEffectToxic,
    [MOVE_EFFECT_CONFUSION] = BattleScript_MoveEffectConfusion, [MOVE_EFFECT_UPROAR] = BattleScript_MoveEffectUproar,
    [MOVE_EFFECT_PAYDAY] = BattleScript_MoveEffectPayDay,       [MOVE_EFFECT_WRAP] = BattleScript_MoveEffectWrap,
    [MOVE_EFFECT_FROSTBITE] = BattleScript_MoveEffectFrostbite,
};

static const struct WindowTemplate sUnusedWinTemplate =
    {.bg = 0, .tilemapLeft = 1, .tilemapTop = 3, .width = 7, .height = 15, .paletteNum = 31, .baseBlock = 0x3F};
...
static const struct SpriteTemplate sSpriteTemplate_MonIconOnLvlUpBanner = {.tileTag = TAG_LVLUP_BANNER_MON_ICON,
...
static const u16 sFinalStrikeOnlyEffects[] = {
    EFFECT_RELIC_SONG,         EFFECT_BUG_BITE,          EFFECT_THIEF,      EFFECT_BURN_UP,
    EFFECT_DOUBLE_SHOCK,       EFFECT_SECRET_POWER,      EFFECT_SMACK_DOWN, EFFECT_SPARKLING_ARIA,
    EFFECT_SMELLING_SALTS,     EFFECT_WAKE_UP_SLAP,      EFFECT_HIT_ESCAPE, EFFECT_RECOIL_HP_25,
    EFFECT_HIT_PREVENT_ESCAPE, EFFECT_HIT_SWITCH_TARGET,
};
...
static const struct PickupItem sPickupTable[] = {
    //   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+
    //   91+   Levels
    {ITEM_POTION,
     {
         35,
...
static const u8 sBattlePalaceNatureToFlavorTextId[NUM_NATURES] = {
    [NATURE_HARDY] = B_MSG_EAGER_FOR_MORE,   [NATURE_LONELY] = B_MSG_GLINT_IN_EYE,
    [NATURE_BRAVE] = B_MSG_GETTING_IN_POS,   [NATURE_ADAMANT] = B_MSG_GLINT_IN_EYE,
    [NATURE_NAUGHTY] = B_MSG_GLINT_IN_EYE,   [NATURE_BOLD] = B_MSG_GETTING_IN_POS,
    [NATURE_DOCILE] = B_MSG_EAGER_FOR_MORE,  [NATURE_RELAXED] = B_MSG_GLINT_IN_EYE,
    [NATURE_IMPISH] = B_MSG_GETTING_IN_POS,  [NATURE_LAX] = B_MSG_GROWL_DEEPLY,
    [NATURE_TIMID] = B_MSG_GROWL_DEEPLY,     [NATURE_HASTY] = B_MSG_GLINT_IN_EYE,
    [NATURE_SERIOUS] = B_MSG_EAGER_FOR_MORE, [NATURE_JOLLY] = B_MSG_GETTING_IN_POS,
    [NATURE_NAIVE] = B_MSG_EAGER_FOR_MORE,   [NATURE_MODEST] = B_MSG_GETTING_IN_POS,
    [NATURE_MILD] = B_MSG_GROWL_DEEPLY,      [NATURE_QUIET] = B_MSG_EAGER_FOR_MORE,
    [NATURE_BASHFUL] = B_MSG_EAGER_FOR_MORE, [NATURE_RASH] = B_MSG_GROWL_DEEPLY,
    [NATURE_CALM] = B_MSG_GETTING_IN_POS,    [NATURE_GENTLE] = B_MSG_GLINT_IN_EYE,
    [NATURE_SASSY] = B_MSG_GROWL_DEEPLY,     [NATURE_CAREFUL] = B_MSG_GROWL_DEEPLY,
...
static bool32 TryAegiFormChange(void)
{
  ...
  switch (gBattleMons[gBattlerAttacker].species)
  {
    ...
    case SPECIES_AEGISLASH_SHIELD:  // Shield -> Blade
      ...
      {
        gBattleStruct->changedSpecies[side][gBattlerPartyIndexes[gBattlerAttacker]] = gBattleMons[gBattlerAttacker]
                                                                                          .species;
      }
...
bool32 ProteanTryChangeType(u32 battler, u32 ability, u32 move, u32 moveType)
{
  if ((ability == ABILITY_PROTEAN || ability == ABILITY_LIBERO) &&
      ...
      move != MOVE_STRUGGLE && !IsTerastallized(battler))
  {
...
bool32 ShouldTeraShellDistortTypeMatchups(u32 move, u32 battlerDef)
{
  if (!(gBattleStruct->distortedTypeMatchups & gBitTable[battlerDef]) &&
      ...
      gBattleMons[battlerDef].species == SPECIES_TERAPAGOS_TERASTAL && !IS_MOVE_STATUS(move) &&
      !(gMoveResultFlags & MOVE_RESULT_NO_EFFECT) && gBattleMons[battlerDef].hp == gBattleMons[battlerDef].maxHP)
  {
    return TRUE;
  }
...
{
  return ((gBattleStruct->isSkyBattle) && (gBattleMoves[gCurrentMove].banMask & BAN_SKY_BATTLE));
}
...
static void Cmd_attackcanceler(void)
{
  ...
  gHitMarker |= HITMARKER_OBEYS;
  // Check if no available target present on the field or if Sky Battles ban the
  // move
  if ((NoTargetPresent(gBattlerAttacker, gCurrentMove) &&
       (!(gBattleMoves[gCurrentMove].flags2 & FLAG_TWO_TURN) ||
        (gBattleMons[gBattlerAttacker].status2 & STATUS2_MULTIPLETURNS))) ||
      (IsMoveNotAllowedInSkyBattles(gCurrentMove)))
  {
    if (gBattleMoves[gCurrentMove].effect == EFFECT_FLING)  // Edge case for removing a mon's item when there is
                                                            // no target available after using Fling.
    {
    ...
    if (!(gBattleMoves[gCurrentMove].flags2 & FLAG_TWO_TURN) ||
        (gBattleMons[gBattlerAttacker].status2 & STATUS2_MULTIPLETURNS))
    {
      ...
      !gProtectStructs[gBattlerAttacker].usesBouncedMove)
  {
    ...
    {
      // Opponent used a prankster'd magic coat -> reflected status move should
      // fail against a dark-type attacker
  ...
  // Z-moves and Max Moves bypass protection, but deal reduced damage (factored
  // in AccumulateOtherModifiers)
             ...
             gBattleMoves[gCurrentMove].effect != EFFECT_UPPER_HAND)
  {
    ...
    if (gSpecialStatuses[gBattlerAttacker].parentalBondState == PARENTAL_BOND_1ST_HIT)
    {
      gSpecialStatuses[gBattlerAttacker]
          .parentalBondState = PARENTAL_BOND_OFF;  // No second hit if first hit was blocked
...
static bool32 AccuracyCalcHelper(u16 move)
{
  if ((gStatuses3[gBattlerTarget] & STATUS3_ALWAYS_HITS &&
      ...
      (B_TOXIC_NEVER_MISS >= GEN_6 && gBattleMoves[move].effect == EFFECT_TOXIC &&
  ...
  // If the attacker has the ability No Guard and they aren't targeting a
  // Pokemon involved in a Sky Drop with the move Sky Drop, move hits.
  ...
  // If the target is under the effects of Telekinesis, and the move isn't a
  // OH-KO move, move hits.
  else if (gStatuses3[gBattlerTarget] & STATUS3_TELEKINESIS &&
           !(gStatuses3[gBattlerTarget] & STATUS3_SEMI_INVULNERABLE) && gBattleMoves[move].effect != EFFECT_OHKO)
  {
    JumpIfMoveFailed(7, move);
    return TRUE;
  }
  ...
  if ((gStatuses3[gBattlerTarget] & STATUS3_PHANTOM_FORCE) ||
      ((gStatuses3[gBattlerTarget] & STATUS3_ON_AIR) &&
       !((gBattleMoves[move].flags & FLAG_DMG_IN_AIR) || (gBattleMoves[move].flags & FLAG_DMG_2X_IN_AIR))) ||
  ...
  if (WEATHER_HAS_EFFECT)
  {
    ...
    {
      // thunder/hurricane/genie moves ignore acc checks in rain unless target
      // is holding utility umbrella
      JumpIfMoveFailed(7, move);
      return TRUE;
  ...
  if (B_MINIMIZE_DMG_ACC >= GEN_6 && (gStatuses3[gBattlerTarget] & STATUS3_MINIMIZED) &&
      (gBattleMoves[move].flags2 & FLAG_MINIMIZE_DOUBLE))
  {
    JumpIfMoveFailed(7, move);
    return TRUE;
  }
...
u32 GetTotalAccuracy(u32 battlerAtk,
                     u32 battlerDef,
                     u32 move,
                     u32 atkAbility,
                     u32 defAbility,
                     ...
                     u32 defHoldEffect)
{
  ...
  if (atkAbility == ABILITY_UNAWARE || ApplyUnawareCurse(battlerAtk, evasionStage) || atkAbility == ABILITY_KEEN_EYE ||
      atkAbility == ABILITY_MINDS_EYE || (B_ILLUMINATE_EFFECT >= GEN_9 && atkAbility == ABILITY_ILLUMINATE))
  {
  ...
  switch (atkAbility)
  {
    ...
    case ABILITY_HUSTLE:
      ...
      {
        calc = (calc * 90) / 100;  // 0.9 hustle loss
      }
      break;
  }
      ...
      gBattlescriptCurrInstr = cmd->nextInstr;
             ...
             (gSpecialStatuses[gBattlerAttacker].multiHitOn &&
              (abilityAtk == ABILITY_SKILL_LINK || holdEffectAtk == HOLD_EFFECT_LOADED_DICE ||
               !IsManuallyScriptedMultiHit(move))))
  {
    gBattlescriptCurrInstr = cmd->nextInstr;
  } else
  {
    ...
    accuracy = GetTotalAccuracy(gBattlerAttacker, gBattlerTarget, move, abilityAtk, abilityDef, holdEffectAtk,
...
static void Cmd_ppreduce(void)
{
  ...
  if (moveTarget == MOVE_TARGET_BOTH || moveTarget == MOVE_TARGET_FOES_AND_ALLY ||
      moveTarget == MOVE_TARGET_ALL_BATTLERS || (gBattleMoves[gCurrentMove].flags2 & FLAG_FORCE_PRESSURE))
  {
    for (i = 0; i < gBattlersCount; i++)
    {
...
s32 CalcCritChanceStageArgs(u32 battlerAtk,
                            u32 battlerDef,
                            u32 move,
                            bool32 recordAbility,
                            u32 abilityAtk,
                            u32 abilityDef,
                            u32 holdEffectAtk)
{
...
static void Cmd_damagecalc(void)
{
  ...
  GET_MOVE_TYPE(gCurrentMove, moveType);
  gBattleMoveDamage = CalculateMoveDamage(gCurrentMove, gBattlerAttacker, gBattlerTarget, moveType, movePower,
                                          gIsCriticalHit, TRUE, TRUE);
...
static void Cmd_typecalc(void)
{
  ...
  GET_MOVE_TYPE(gCurrentMove, moveType);
  CalcTypeEffectivenessMultiplier(gCurrentMove, moveType, gBattlerAttacker, gBattlerTarget,
                                  GetBattlerAbility(gBattlerTarget), TRUE);
...
static void Cmd_adjustdamage(void)
{
  ...
  if (GetBattlerAbility(gBattlerTarget) == ABILITY_ICE_FACE && IS_MOVE_PHYSICAL(gCurrentMove) &&
  ...
  } else if (B_AFFECTION_MECHANICS == TRUE && GetBattlerSide(gBattlerTarget) == B_SIDE_PLAYER &&
             affectionScore >= AFFECTION_THREE_HEARTS)
  {
  ...
  if (gBattleMoves[gCurrentMove].effect != EFFECT_FALSE_SWIPE && !gProtectStructs[gBattlerTarget].endured &&
      !gSpecialStatuses[gBattlerTarget].focusBanded && !gSpecialStatuses[gBattlerTarget].focusSashed &&
      (B_AFFECTION_MECHANICS == FALSE || !gSpecialStatuses[gBattlerTarget].affectionEndured) &&
      !gSpecialStatuses[gBattlerTarget].sturdied && !endureCharmActive)
  {
    goto END;
  }
...
END:
  ...
  if (gSpecialStatuses[gBattlerAttacker].gemBoost && !(gMoveResultFlags & MOVE_RESULT_NO_EFFECT) &&
      gBattleMons[gBattlerAttacker].item && gBattleMoves[gCurrentMove].effect != EFFECT_PLEDGE &&
...
static void Cmd_multihitresultmessage(void)
{
  ...
  if (!(gMoveResultFlags & MOVE_RESULT_FAILED) && !(gMoveResultFlags & MOVE_RESULT_FOE_ENDURED))
  {
    if (gMoveResultFlags & MOVE_RESULT_STURDIED)
    {
      ...
      gSpecialStatuses[gBattlerTarget].sturdied = FALSE;  // Delete this line to make Sturdy last for the duration of
                                                          // the whole move turn.
      BattleScriptPushCursor();
    ...
    } else if (gMoveResultFlags & MOVE_RESULT_FOE_HUNG_ON)
    {
      ...
      gPotentialItemEffectBattler = gBattlerTarget;
      gMoveResultFlags &= ~(MOVE_RESULT_STURDIED | MOVE_RESULT_FOE_HUNG_ON);
      gSpecialStatuses[gBattlerTarget].focusBanded = FALSE;  // Delete this line to make Focus Band last for the
                                                             // duration of the whole move turn.
      gSpecialStatuses[gBattlerTarget].focusSashed = FALSE;  // Delete this line to make Focus Sash last for the
                                                             // duration of the whole move turn.
      BattleScriptPushCursor();
...
static void Cmd_attackanimation(void)
{
  ...
  if ((gHitMarker & (HITMARKER_NO_ANIMATIONS | HITMARKER_DISABLE_ANIMATION)) && gCurrentMove != MOVE_TRANSFORM &&
      gCurrentMove != MOVE_SUBSTITUTE && gCurrentMove != MOVE_ALLY_SWITCH &&
  ...
  } else
  {
    ...
    if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
    {
      ...
      BtlController_EmitMoveAnimation(gBattlerAttacker, BUFFER_A, gCurrentMove, gBattleScripting.animTurn,
                                      gBattleMovePower, gBattleMoveDamage, gBattleMons[gBattlerAttacker].friendship,
...
static void Cmd_healthbarupdate(void)
{
  ...
  if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT) || (gHitMarker & HITMARKER_PASSIVE_DAMAGE))
  {
    ...
    if (DoesSubstituteBlockMove(gBattlerAttacker, battler, gCurrentMove) && gDisableStructs[battler].substituteHP &&
    ...
    {
      s16 healthValue = min(gBattleMoveDamage,
                            10000);  // Max damage (10000) not present in R/S, ensures that
                                     // huge damage values don't change sign
...
static void Cmd_datahpupdate(void)
{
  ...
  if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT) || (gHitMarker & HITMARKER_PASSIVE_DAMAGE))
  {
    ...
    } else
    {
      ...
      // Send updated HP
      BtlController_EmitSetMonData(battler, BUFFER_A, REQUEST_HP_BATTLE, 0, sizeof(gBattleMons[battler].hp),
...
static void Cmd_resultmessage(void)
{
  ...
  if (gMoveResultFlags & MOVE_RESULT_MISSED &&
      (!(gMoveResultFlags & MOVE_RESULT_DOESNT_AFFECT_FOE) || gBattleCommunication[MISS_TYPE] > B_MSG_AVOIDED_ATK))
  {
    if (gBattleCommunication[MISS_TYPE] > B_MSG_AVOIDED_ATK)  // Wonder Guard or Levitate - show the ability
                                                              // pop-up
    {
      CreateAbilityPopUp(gBattlerTarget, gBattleMons[gBattlerTarget].ability,
  ...
  } else
  {
    ...
    {
      case MOVE_RESULT_SUPER_EFFECTIVE:
        if (!gMultiHitCounter)  // Don't print effectiveness on each hit in a
                                // multi hit attack
        {
          // Signal for the trainer slide-in system.
          if (GetBattlerSide(gBattlerTarget) != B_SIDE_PLAYER &&
...
void StealTargetItem(u8 battlerStealer, u8 battlerItem)
{
  ...
  BtlController_EmitSetMonData(battlerStealer, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0, sizeof(gLastUsedItem),
                               &gLastUsedItem);  // set attacker item
  MarkBattlerForControllerExec(battlerStealer);

  BtlController_EmitSetMonData(battlerItem, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0,
                               sizeof(gBattleMons[gBattlerTarget].item),
                               &gBattleMons[battlerItem].item);  // remove target item
...
void SetMoveEffect(bool32 primary, u32 certain)
{
  ...
  if (gSpecialStatuses[gBattlerAttacker].parentalBondState == PARENTAL_BOND_1ST_HIT &&
      gBattleMons[gBattlerTarget].hp != 0 && IsFinalStrikeEffect(gCurrentMove))
  {
    gBattlescriptCurrInstr++;
    return;
  }
  ...
  if ((battlerAbility == ABILITY_SHIELD_DUST ||
      ...
      (gBattleScripting.moveEffect <= MOVE_EFFECT_TRI_ATTACK ||
       gBattleScripting.moveEffect >= MOVE_EFFECT_SMACK_DOWN))  // Exclude stat lowering effects
  {
    if (battlerAbility == ABILITY_SHIELD_DUST)
    {
  ...
  if (gSideStatuses[GetBattlerSide(gEffectBattler)] & SIDE_STATUS_SAFEGUARD &&
      !(gHitMarker & HITMARKER_STATUS_ABILITY_EFFECT) && !primary &&
  ...
  if (gBattleScripting.moveEffect <= PRIMARY_STATUS_MOVE_EFFECT)  // status change
  {
    ...
    switch (sStatusFlagsForMoveEffects[gBattleScripting.moveEffect])
    {
      ...
      case STATUS1_POISON:
        ...
        if (!CanPoisonType(gBattleScripting.battler, gEffectBattler) &&
            (gHitMarker & HITMARKER_STATUS_ABILITY_EFFECT) && (primary == TRUE || certain == MOVE_EFFECT_CERTAIN))
        {
          BattleScriptPush(gBattlescriptCurrInstr + 1);
          gBattlescriptCurrInstr = BattleScript_PSNPrevention;
      ...
      case STATUS1_BURN:
        ...
        if (IS_BATTLER_OF_TYPE(gEffectBattler, TYPE_FIRE) && (gHitMarker & HITMARKER_STATUS_ABILITY_EFFECT) &&
            (primary == TRUE || certain == MOVE_EFFECT_CERTAIN))
        {
          BattleScriptPush(gBattlescriptCurrInstr + 1);
          gBattlescriptCurrInstr = BattleScript_BRNPrevention;
      ...
      case STATUS1_TOXIC_POISON:
        ...
        if (CanBePoisoned(gBattleScripting.battler, gEffectBattler))
        {
          // It's redundant, because at this point we know the status1 value is
          // 0.
    ...
    if (statusChanged == TRUE)
    {
      ...
      BtlController_EmitSetMonData(gEffectBattler, BUFFER_A, REQUEST_STATUS_BATTLE, 0,
                                   sizeof(gBattleMons[gEffectBattler].status1), &gBattleMons[gEffectBattler].status1);
      ...
      switch (gBattleScripting.moveEffect)
      {
        case MOVE_EFFECT_CONFUSION:
          ...
          } else
          {
            ...
            // If the confusion is activating due to being released from Sky
            // Drop, go to "confused due to fatigue" script. Otherwise, do
            // normal confusion script.
        ...
        case MOVE_EFFECT_UPROAR:
          if (!(gBattleMons[gEffectBattler].status2 & STATUS2_UPROAR))
          {
            ...
            gBattleMons[gEffectBattler].status2 |= STATUS2_UPROAR_TURN(B_UPROAR_TURNS >= GEN_5 ? 3
                                                                                               : (Random() & 3) + 2);
        ...
        case MOVE_EFFECT_TRI_ATTACK:
          ...
          {
            static const u8 sTriAttackEffects[] = {MOVE_EFFECT_BURN,
        ...
        case MOVE_EFFECT_WRAP:
          ...
          } else
          {
            ...
            {
              gDisableStructs[gEffectBattler].wrapTurns = B_BINDING_TURNS >= GEN_5 ? (Random() % 2) + 4
                                                                                   : (Random() % 4) + 2;
            }
            ...
            for (gBattleCommunication[MULTISTRING_CHOOSER] = 0;
                 gBattleCommunication[MULTISTRING_CHOOSER] < NUM_TRAPPING_MOVES;
        ...
        case MOVE_EFFECT_EVS_PLUS_1:
          if (NoAliveMonsForEitherParty() ||
              ChangeStatBuffs(SET_STAT_BUFF_VALUE(1), gBattleScripting.moveEffect - MOVE_EFFECT_ATK_PLUS_1 + 1,
        ...
        case MOVE_EFFECT_EVS_PLUS_2:
          if (NoAliveMonsForEitherParty() ||
              ChangeStatBuffs(SET_STAT_BUFF_VALUE(2), gBattleScripting.moveEffect - MOVE_EFFECT_ATK_PLUS_2 + 1,
                              affectsUser | STAT_CHANGE_UPDATE_MOVE_EFFECT, 0))
          {
            gBattlescriptCurrInstr++;
          } else
        ...
        case MOVE_EFFECT_STEAL_ITEM: {
          ...
          {
            StealTargetItem(gBattlerAttacker,
                            gBattlerTarget);  // Attacker steals target item
            gBattleMons[gBattlerAttacker].item = ITEM_NONE;  // Item assigned later on with thief (see
        ...
        case MOVE_EFFECT_CLEAR_SMOG:
          ...
          if ((gSpecialStatuses[gEffectBattler].physicalDmg || gSpecialStatuses[gEffectBattler].specialDmg) &&
              i != NUM_BATTLE_STATS)
          {
            for (i = 0; i < NUM_BATTLE_STATS; i++)
            {
        ...
        case MOVE_EFFECT_INCINERATE:
          if ((gBattleMons[gEffectBattler].item >= FIRST_BERRY_INDEX &&
              ...
              (B_INCINERATE_GEMS >= GEN_6 && GetBattlerHoldEffect(gEffectBattler, FALSE) == HOLD_EFFECT_GEMS))
          {
            ...
            BtlController_EmitSetMonData(gEffectBattler, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0,
                                         sizeof(gBattleMons[gEffectBattler].item), &gBattleMons[gEffectBattler].item);
            MarkBattlerForControllerExec(gEffectBattler);
            BattleScriptPush(gBattlescriptCurrInstr + 1);
        ...
        case MOVE_EFFECT_BURN_UP:
          // This seems unnecessary but is done to make it work properly with
          // Parental Bond
          BattleScriptPush(gBattlescriptCurrInstr + 1);
        ...
        case MOVE_EFFECT_ROUND:
          TryUpdateRoundTurnOrder();  // If another Pokémon uses Round before
                                      // the user this turn, the user will use
                                      // Round directly after it
          gBattlescriptCurrInstr++;
          break;
        ...
        case MOVE_EFFECT_TRIPLE_ARROWS: {
          u8 randomLowerDefenseChance = RandomPercentage(RNG_TRIPLE_ARROWS_DEFENSE_DOWN,
                                                         CalcSecondaryEffectChance(gBattlerAttacker, 50,
                                                                                   EFFECT_DEFENSE_DOWN_HIT));
          u8 randomFlinchChance = RandomPercentage(RNG_TRIPLE_ARROWS_FLINCH,
                                                   CalcSecondaryEffectChance(gBattlerAttacker, 30, EFFECT_FLINCH_HIT));
        ...
        case MOVE_EFFECT_SYRUP_BOMB:
          if (!(gStatuses4[gEffectBattler] & STATUS4_SYRUP_BOMB))
          {
            ...
            gDisableStructs[gEffectBattler].syrupBombIsShiny = IsMonShiny(
                &party[gBattlerPartyIndexes[gBattlerAttacker]]);
        ...
        case MOVE_EFFECT_TERA_BLAST:
          if (IsTerastallized(gEffectBattler) && GetBattlerTeraType(gEffectBattler) == TYPE_STELLAR &&
              !NoAliveMonsForEitherParty())
          {
            BattleScriptPush(gBattlescriptCurrInstr + 1);
...
static void Cmd_seteffectwithchance(void)
{
  ...
  // Pyromancy boost
  if (GetBattlerAbility(gBattlerAttacker) == ABILITY_PYROMANCY && moveType == TYPE_FIRE &&
  ...
  } else
  {
    ...
    if (!(gAbsentBattlerFlags & gBitTable[battler]) && gBattleMons[battler].hp == 0)
    {
          ...
          gCurrentMove != MOVE_STRUGGLE)
      {
        ...
        BtlController_EmitSetMonData(gBattlerAttacker, BUFFER_A, moveIndex + REQUEST_PPMOVE1_BATTLE, 0,
                                     sizeof(gBattleMons[gBattlerAttacker].pp[moveIndex]),
...
static void Cmd_cleareffectsonfaint(void)
{
  ...
  if (gBattleControllerExecFlags == 0)
  {
    ...
    if (!(gBattleTypeFlags & BATTLE_TYPE_ARENA) || gBattleMons[battler].hp == 0)
    {
      ...
      BtlController_EmitSetMonData(battler, BUFFER_A, REQUEST_STATUS_BATTLE, 0, sizeof(gBattleMons[battler].status1),
...
static bool32 BattleTypeAllowsExp(void)
{
  if (RECORDED_WILD_BATTLE)
  {
    return TRUE;
             ...
             (BATTLE_TYPE_LINK | BATTLE_TYPE_RECORDED_LINK | BATTLE_TYPE_TRAINER_HILL | BATTLE_TYPE_FRONTIER |
...
static void Cmd_getexp(void)
{
  ...
  switch (gBattleScripting.getexpState)
  {
    ...
    case 1:  // calculate experience points to redistribute
    {
      ...
      // Get order of mons getting exp: 1. all mons via sent in, 2. all mons via
      // exp share
      for (i = 0; i < PARTY_SIZE; i++)
      {
        if (gBitTable[i] & sentInBits)
    ...
    case 2:  // set exp value to the poke in expgetter_id and print message
      if (gBattleControllerExecFlags == 0)
      {
        ...
        // Leveling up while Dynamaxed is a bit bugged with health atm so just
        ...
        } else
        {
          ...
          if (!(gBattleTypeFlags & BATTLE_TYPE_TRAINER) &&
              ...
              !IsBattlerAlive(GetBattlerAtPosition(B_POSITION_OPPONENT_RIGHT)) && !gBattleStruct->wildVictorySong)
          {
          ...
          if (IsValidForBattle(&gPlayerParty[*expMonId]))
          {
            ...
            if ((holdEffect == HOLD_EFFECT_EXP_SHARE || IsGen6ExpShareEnabled()) &&
                (B_SPLIT_EXP < GEN_6 || gBattleMoveDamage == 0))  // only give exp share bonus in later gens if
                                                                  // the mon wasn't sent out
            {
            ...
            // !gBattleStruct->teamGotExpMsgPrinted) // Print 'the rest of your
            // team got exp' message once, when all of the sent-in mons were
            // given experience
            //{
            //     gLastUsedItem = ITEM_EXP_SHARE;
            //     PrepareStringBattle(STRINGID_TEAMGAINEDEXP,
    ...
    case 4:  // lvl up if necessary
      if (gBattleControllerExecFlags == 0)
      {
        ...
        if (gBattleResources->bufferB[expBattler][0] == CONTROLLER_TWORETURNVALUES &&
            gBattleResources->bufferB[expBattler][1] == RET_VALUE_LEVELED_UP)
        {
          ...
          {
            battler = 0;
          } else if (gBattlerPartyIndexes[2] == *expMonId && gBattleMons[2].hp &&
    ...
    case 5:  // looper increment
      if (gBattleMoveDamage)  // there is exp to give, goto case 3 that gives
                              // exp
      {
...
static void PlayAnimation(u32 battler, u8 animId, const u16* argPtr, const u8* nextInstr)
{
  ...
  if (animId == B_ANIM_STATS_CHANGE || animId == B_ANIM_SNATCH_MOVE || animId == B_ANIM_MEGA_EVOLUTION ||
      animId == B_ANIM_ILLUSION_OFF || animId == B_ANIM_FORM_CHANGE || animId == B_ANIM_SUBSTITUTE_FADE ||
      animId == B_ANIM_PRIMAL_REVERSION || animId == B_ANIM_ULTRA_BURST || animId == B_ANIM_TERA_CHARGE ||
  ...
  } else if (gHitMarker & (HITMARKER_NO_ANIMATIONS | HITMARKER_DISABLE_ANIMATION) && animId != B_ANIM_RESTORE_BG)
  {
    ...
    gBattlescriptCurrInstr = BattleScript_Pausex20;
  } else if (animId == B_ANIM_RAIN_CONTINUES || animId == B_ANIM_SUN_CONTINUES ||
             animId == B_ANIM_SANDSTORM_CONTINUES || animId == B_ANIM_HAIL_CONTINUES ||
             animId == B_ANIM_SNOW_CONTINUES || animId == B_ANIM_ACID_RAIN_CONTINUES)
  {
    BtlController_EmitBattleAnimation(battler, BUFFER_A, animId, &gDisableStructs[battler], *argPtr);
    MarkBattlerForControllerExec(battler);
    gBattlescriptCurrInstr = nextInstr;
        ...
        if (flags & STAT_CHANGE_CANT_PREVENT)
        {
          if (gBattleMons[battler].statStages[currStat] > MIN_STAT_STAGE)
          {
            ...
            changeableStatsCount++;
                   ...
                   GetBattlerHoldEffect(battler, TRUE) != HOLD_EFFECT_CLEAR_AMULET && ability != ABILITY_CLEAR_BODY &&
...
{
  if (gBattleMons[battlerDef].item != 0 && CanBattlerGetOrLoseItem(battlerDef, gBattleMons[battlerDef].item) &&
      !NoAliveMonsForEitherParty())
  {
...
#define SYMBIOSIS_CHECK(battler, ally) \
  GetBattlerAbility(ally) == ABILITY_SYMBIOSIS&& gBattleMons[battler].item == ITEM_NONE&& gBattleMons[ally].item != \
          ITEM_NONE&& CanBattlerGetOrLoseItem(battler, gBattleMons[ally].item) && \
      CanBattlerGetOrLoseItem(ally, gBattleMons[ally].item) && gBattleMons[battler].hp != 0 && \
...
static void Cmd_moveend(void)
{
  ...
  do
  {
    ...
    {
      case MOVEEND_SUM_DAMAGE:  // Sum and store damage dealt for multi strike
                                // recoil
      ...
      case MOVEEND_PROTECT_LIKE_EFFECT:
        if (gProtectStructs[gBattlerAttacker].touchedProtectLike)
        {
          ...
          } else if (gProtectStructs[gBattlerTarget].kingsShielded)
          {
            ...
            gBattlerTarget = i;  // gBattlerTarget and gBattlerAttacker are swapped in order
                                 // to activate Defiant, if applicable
          ...
          else if (gProtectStructs[gBattlerTarget].beakBlastCharge && CanBeBurned(gBattlerAttacker) &&
                   !(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
          {
            gProtectStructs[gBattlerAttacker].touchedProtectLike = FALSE;
            gBattleMons[gBattlerAttacker].status1 = STATUS1_BURN;
            BtlController_EmitSetMonData(gBattlerAttacker, BUFFER_A, REQUEST_STATUS_BATTLE, 0,
      ...
      case MOVEEND_RAGE:  // rage check
        if (gBattleMons[gBattlerTarget].status2 & STATUS2_RAGE && gBattleMons[gBattlerTarget].hp != 0 &&
            gBattlerAttacker != gBattlerTarget && GetBattlerSide(gBattlerAttacker) != GetBattlerSide(gBattlerTarget) &&
      ...
      case MOVEEND_DEFROST:  // defrosting check
            ...
            !(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
        {
          ...
          BtlController_EmitSetMonData(gBattlerTarget, BUFFER_A, REQUEST_STATUS_BATTLE, 0,
        ...
        if (gBattleMons[gBattlerTarget].status1 & STATUS1_FROSTBITE && gBattleMons[gBattlerTarget].hp != 0 &&
            gBattlerAttacker != gBattlerTarget && (gBattleMoves[originallyUsedMove].flags & FLAG_THAW_USER) &&
            !(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
        {
            ...
            gBattleScripting.savedDmg != 0)  // Some checks may be redundant alongside this one
        {
          switch (gBattleMoves[gCurrentMove].effect)
          {
            ...
            case EFFECT_RECOIL_50:  // Head Smash, 50 % recoil
              ...
              effect = TRUE;
              break;
            case EFFECT_RECOIL_33_STATUS:  // Flare Blitz - can burn, Volt
                                           // Tackle - can paralyze
              gBattleMoveDamage = max(1, gBattleScripting.savedDmg / 3);
              BattleScriptPushCursor();
      ...
      case MOVEEND_SYNCHRONIZE_TARGET:  // target synchronize
        ...
        gBattleScripting.moveendState++;
        break;
      case MOVEEND_ABILITIES:  // Such as abilities activating on contact(Poison
                               // Spore, Rough Skin, etc.).
        ...
        gBattleScripting.moveendState++;
        break;
      case MOVEEND_ABILITIES_ATTACKER:  // Poison Touch, possibly other in the
                                        // future
      ...
      case MOVEEND_OPPORTUNIST:
        ...
        {
          effect = TRUE;  // it loops through all battlers, so we increment
                          // after its done with all battlers
        } else
        {
          gBattleScripting.moveendState++;
        }
      ...
      case MOVEEND_CHOICE_MOVE:  // update choice band move
        if (gHitMarker & HITMARKER_OBEYS &&
            ...
            gChosenMove != MOVE_STRUGGLE && (*choicedMoveAtk == MOVE_NONE || *choicedMoveAtk == MOVE_UNAVAILABLE))
        {
      ...
      case MOVEEND_ITEM_EFFECTS_TARGET:
        ...
        gBattleScripting.moveendState++;
        break;
      case MOVEEND_MOVE_EFFECTS2:  // For effects which should happen after
                                   // target items, for example Knock Off after
                                   // damage from Rocky Helmet.
      {
        switch (gBattleStruct->moveEffect2)
        {
          ...
          case MOVE_EFFECT_REMOVE_STATUS:  // Smelling salts, Wake-Up Slap,
                ...
                IsBattlerAlive(gBattlerTarget))
            {
              ...
              BtlController_EmitSetMonData(gBattlerTarget, 0, REQUEST_STATUS_BATTLE, 0, 4,
                                           &gBattleMons[gBattlerTarget].status1);
              MarkBattlerForControllerExec(gBattlerTarget);
              effect = TRUE;
              BattleScriptPush(gBattlescriptCurrInstr);
      ...
      case MOVEEND_NUM_HITS:
        if (gBattlerAttacker != gBattlerTarget && gBattleMoves[gCurrentMove].split != SPLIT_STATUS &&
            !(gMoveResultFlags & MOVE_RESULT_NO_EFFECT) && TARGET_TURN_DAMAGED)
        {
      ...
      case MOVEEND_SUBSTITUTE:  // update substitute
        ...
        gBattleScripting.moveendState++;
        break;
      case MOVEEND_SKY_DROP_CONFUSE:  // If a Pokemon was released from Sky Drop
                                      // and was in LOCK_CONFUSE, go to
                                      // "confused due to fatigue" scripts and
                                      // clear Sky Drop data.
        for (i = 0; i < gBattlersCount; i++)
        {
      ...
      case MOVEEND_UPDATE_LAST_MOVES:
        ...
        // Set ShellTrap to activate after the attacker's turn if target was hit
        // by a physical move.
        if (gBattleMoves[gChosenMoveByBattler[gBattlerTarget]].effect == EFFECT_SHELL_TRAP &&
            gBattlerTarget != gBattlerAttacker && GetBattlerSide(gBattlerTarget) != GetBattlerSide(gBattlerAttacker) &&
            ...
            !TestSheerForceFlag(gBattlerAttacker, gCurrentMove))
        {
          ...
          // Change move order in double battles, so the hit mon with shell trap
          // moves immediately after being hit.
          if (IsDoubleBattle())
          {
      ...
      case MOVEEND_MIRROR_MOVE:  // mirror move
        if (!(gAbsentBattlerFlags & gBitTable[gBattlerAttacker]) &&
            !(gBattleStruct->absentBattlerFlags & gBitTable[gBattlerAttacker]) &&
            !(gBattleMoves[originallyUsedMove].banMask & BAN_MIRROR_MOVE) && gHitMarker & HITMARKER_OBEYS &&
      ...
      case MOVEEND_MAGICIAN:
        if (GetBattlerAbility(gBattlerAttacker) == ABILITY_MAGICIAN && gCurrentMove != MOVE_FLING &&
            gCurrentMove != MOVE_NATURAL_GIFT && gBattleMons[gBattlerAttacker].item == ITEM_NONE &&
            gBattleMons[gBattlerTarget].item != ITEM_NONE && IsBattlerAlive(gBattlerAttacker) && TARGET_TURN_DAMAGED &&
            CanStealItem(gBattlerAttacker, gBattlerTarget,
                         gBattleMons[gBattlerTarget].item) &&
            !gSpecialStatuses[gBattlerAttacker].gemBoost  // In base game, gems are consumed after magician
                                                          // would activate.
            && !(gWishFutureKnock.knockedOffMons[GetBattlerSide(gBattlerTarget)] &
      ...
      {
        u16 moveTarget = GetBattlerMoveTargetType(gBattlerAttacker, gCurrentMove);
        // Set a flag if move hits either target (for throat spray that can't
        // check damage)
            ...
            !(gHitMarker & HITMARKER_NO_ATTACKSTRING))
        {
          ...
          // Check if the move used was actually a bounced move. If so, we need
          // to go back to the original attacker and make sure, its move hits
          // all 2 or 3 pokemon.
            ...
            !(gCurrentMove == MOVE_PRESENT && gBattleStruct->presentBasePower == 0))  // Silly edge case
        {
          ...
          } else
          {
                ...
                !(gBattleMons[gBattlerAttacker].status1 & STATUS1_FREEZE))
            {
              ...
              gSpecialStatuses[gBattlerTarget].focusBanded = 0;  // Delete this line to make Focus Band last for the
                                                                 // duration of the whole move turn.
              gSpecialStatuses[gBattlerTarget].focusSashed = 0;  // Delete this line to make Focus Sash last for the
                                                                 // duration of the whole move turn.
      ...
      case MOVEEND_EJECT_BUTTON:
        ...
        {
          // Since we check if battler was damaged, we don't need to check move
          // result. In fact, doing so actually prevents multi-target moves from
          // activating eject button properly
          ...
          for (i = 0; i < gBattlersCount; i++)
          {
            ...
            if (IsBattlerAlive(battler) && gBattlerAttacker != battler &&
                GetBattlerHoldEffect(battler, TRUE) == HOLD_EFFECT_EJECT_BUTTON && BATTLER_TURN_DAMAGED(battler) &&
      ...
      case MOVEEND_RED_CARD:
        if ((gBattleMoves[gCurrentMove].effect != EFFECT_HIT_SWITCH_TARGET || gBattleStruct->hitSwitchTargetFailed) &&
            IsBattlerAlive(gBattlerAttacker) && !TestSheerForceFlag(gBattlerAttacker, gCurrentMove) &&
            GetBattlerAbility(gBattlerAttacker) != ABILITY_GUARD_DOG)
        {
          // Since we check if battler was damaged, we don't need to check move
          // result. In fact, doing so actually prevents multi-target moves from
          // activating red card properly
          u8 battlers[4] = {0, 1, 2, 3};
          SortBattlersBySpeed(battlers, FALSE);
          for (i = 0; i < gBattlersCount; i++)
          {
            ...
            // Attacker is the one to be switched out, battler is one with red
            // card
            if (battler != gBattlerAttacker && IsBattlerAlive(battler) &&
                !DoesSubstituteBlockMove(gBattlerAttacker, battler, gCurrentMove) &&
                GetBattlerHoldEffect(battler, TRUE) == HOLD_EFFECT_RED_CARD && BATTLER_TURN_DAMAGED(battler) &&
      ...
      case MOVEEND_EJECT_PACK: {
        ...
        {
          u8 battler = battlers[i];
          if (IsBattlerAlive(battler) && gProtectStructs[battler].statFell &&
              gProtectStructs[battler].disableEjectPack == 0 &&
              GetBattlerHoldEffect(battler, TRUE) == HOLD_EFFECT_EJECT_PACK &&
              !(gCurrentMove == MOVE_PARTING_SHOT &&
                CanBattlerSwitch(gBattlerAttacker))  // Does not activate if attacker used
                                                     // Parting Shot and can switch out
              && CountUsablePartyMons(battler) > 0)  // Has mon to switch into
          {
      ...
      case MOVEEND_PICKPOCKET:
        if (IsBattlerAlive(gBattlerAttacker) &&
            ...
            && !(gWishFutureKnock.knockedOffMons[GetBattlerSide(gBattlerAttacker)] &
                 gBitTable[gBattlerPartyIndexes[gBattlerAttacker]])  // But not
                                                                     // knocked
                                                                     // off
            && !(TestSheerForceFlag(gBattlerAttacker,
                                    gCurrentMove))  // Pickpocket doesn't activate for sheer force
            && IsMoveMakingContact(gCurrentMove, gBattlerAttacker)  // Pickpocket requires contact
            && !(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))  // Obviously attack needs to have
                                                             // worked
        {
          u8 battlers[4] = {0, 1, 2, 3};
          SortBattlersBySpeed(battlers,
                              FALSE);  // Pickpocket activates for fastest mon without item
          for (i = 0; i < gBattlersCount; i++)
          {
            u8 battler = battlers[i];
            // Attacker is mon who made contact, battler is mon with pickpocket
            if (battler != gBattlerAttacker  // Cannot pickpocket yourself
                && GetBattlerAbility(battler) == ABILITY_PICKPOCKET  // Target must have pickpocket
                                                                     // ability
                && BATTLER_TURN_DAMAGED(battler)  // Target needs to have been damaged
                && !DoesSubstituteBlockMove(gBattlerAttacker, battler,
                                            gCurrentMove)  // Subsitute unaffected
                && IsBattlerAlive(battler)  // Battler must be alive to pickpocket
                && gBattleMons[battler].item == ITEM_NONE  // Pickpocketer can't have an item already
                && CanStealItem(battler, gBattlerAttacker,
                                gBattleMons[gBattlerAttacker].item))  // Cannot steal plates, mega stones, etc
            {
              gBattlerTarget = gBattlerAbility = battler;
              // Battle scripting is super brittle so we shall do the item
              // exchange now (if possible)
              if (GetBattlerAbility(gBattlerAttacker) != ABILITY_STICKY_HOLD)
              {
                StealTargetItem(gBattlerTarget,
                                gBattlerAttacker);  // Target takes attacker's item
              }

              gEffectBattler = gBattlerAttacker;
              BattleScriptPushCursor();
              gBattlescriptCurrInstr = BattleScript_Pickpocket;  // Includes sticky hold check to
      ...
      case MOVEEND_DANCER:  // Special case because it's so annoying
        if (gBattleMoves[gCurrentMove].flags & FLAG_DANCE_BASED)
        {
          ...
          if (!(gBattleStruct->lastMoveFailed & gBitTable[gBattlerAttacker] ||
                (!gSpecialStatuses[gBattlerAttacker].dancerUsedMove &&
                 gProtectStructs[gBattlerAttacker].usesBouncedMove)))
          {  // Dance move succeeds
            // Set target for other Dancer mons; set bit so that mon cannot
            // activate Dancer off of its own move
            if (!gSpecialStatuses[gBattlerAttacker].dancerUsedMove)
            {
        ...
        gBattleScripting.moveendState++;
        break;
      case MOVEEND_EMERGENCY_EXIT:  // Special case, because moves hitting
                                    // multiple opponents stop after switching
                                    // out
        for (i = 0; i < gBattlersCount; i++)
        {
      ...
      case MOVEEND_SYMBIOSIS:
        for (i = 0; i < gBattlersCount; i++)
        {
          if ((gSpecialStatuses[i].berryReduced || (B_SYMBIOSIS_GEMS >= GEN_7 && gSpecialStatuses[i].gemBoost)) &&
      ...
      case MOVEEND_SAME_MOVE_TURNS:
        ...
        gBattleScripting.moveendState++;
        break;
      case MOVEEND_CLEAR_BITS:  // Clear/Set bits for things like using a move
                                // for all targets and all hits.
        if (gSpecialStatuses[gBattlerAttacker].instructedChosenTarget)
        {
          *(gBattleStruct->moveTarget + gBattlerAttacker) = gSpecialStatuses[gBattlerAttacker].instructedChosenTarget &
              0x3;
        }
        if (gSpecialStatuses[gBattlerAttacker].dancerOriginalTarget)
        {
          *(gBattleStruct->moveTarget + gBattlerAttacker) = gSpecialStatuses[gBattlerAttacker].dancerOriginalTarget &
              0x3;
        }
        ...
        if (B_RAMPAGE_CANCELLING >= GEN_5 && gBattleMoves[gCurrentMove].effect == EFFECT_RAMPAGE  // If we're rampaging
            ...
            && (gBattleMons[gBattlerAttacker].status2 & STATUS2_LOCK_CONFUSE) !=
                STATUS2_LOCK_CONFUSE_TURN(1))  // And won't end this turn
        {
...
static void Cmd_switchindataupdate(void)
{
  ...
  if (gBattleTypeFlags & BATTLE_TYPE_PALACE && gBattleMons[battler].maxHP / 2 >= gBattleMons[battler].hp &&
      gBattleMons[battler].hp != 0 && !(gBattleMons[battler].status1 & STATUS1_SLEEP))
  {
...
static void Cmd_switchinanim(void)
{
  ...
  if (GetBattlerSide(battler) == B_SIDE_OPPONENT &&
      !(gBattleTypeFlags &
        (BATTLE_TYPE_LINK | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_RECORDED_LINK | BATTLE_TYPE_TRAINER_HILL |
  ...
  } else if (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER)
  {
    ...
    for (i = lastMonId; i < lastMonId + MULTI_PARTY_SIZE; i++)
    {
      if (GetMonData(&party[i], MON_DATA_SPECIES) != SPECIES_NONE && !GetMonData(&party[i], MON_DATA_IS_EGG) &&
          GetMonData(&party[i], MON_DATA_HP) != 0 && gBattlerPartyIndexes[battler] != i)
      {
        break;
      }
    }
...
static void ChooseMonToSendOut(u32 battler, u8 slotId)
{
  ...
  BtlController_EmitChoosePokemon(battler, BUFFER_A, PARTY_ACTION_SEND_OUT, slotId, ABILITY_NONE,
                                  gBattleStruct->battlerPartyOrders[battler]);
  MarkBattlerForControllerExec(battler);
}
...
static void Cmd_openpartyscreen(void)
{
  ...
  } else
  {
    ...
    {
      hitmarkerFaintBits = PARTY_ACTION_CHOOSE_MON;  // Used here as the caseId for the
                                                     // EmitChoose function.
    } else
    {
    ...
    } else
    {
      ...
      *(gBattleStruct->monToSwitchIntoId + battler) = PARTY_SIZE;
      ...
      BtlController_EmitChoosePokemon(battler, BUFFER_A, hitmarkerFaintBits,
                                      *(gBattleStruct->monToSwitchIntoId + BATTLE_PARTNER(battler)), ABILITY_NONE,
                                      gBattleStruct->battlerPartyOrders[battler]);
      MarkBattlerForControllerExec(battler);
    ...
    case 3:
      ...
      *(gBattleStruct->monToSwitchIntoId + battler) = gBattleResources->bufferB[battler][1];
      ...
      if (gBattleTypeFlags & BATTLE_TYPE_LINK && gBattleTypeFlags & BATTLE_TYPE_MULTI)
      {
        ...
        *((BATTLE_PARTNER(battler)) * 3 + (u8*)(gBattleStruct->battlerPartyOrders) +
          0) |= (gBattleResources->bufferB[battler][2] & 0xF0) >> 4;
        *((BATTLE_PARTNER(battler)) * 3 + (u8*)(gBattleStruct->battlerPartyOrders) +
          2) = gBattleResources->bufferB[battler][3];
      } else if (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER)
      {
...
{
  return (
      TryPrimalReversion(battler) || AbilityBattleEffects(ABILITYEFFECT_ON_SWITCHIN, battler, 0, 0, 0) ||
      (gBattleWeather & B_WEATHER_ANY && WEATHER_HAS_EFFECT &&
...
static void Cmd_switchineffects(void)
{
  ...
  if (gBattleMons[battler].ability == ABILITY_NEUTRALIZING_GAS &&
      gSpecialStatuses[battler].announceNeutralizingGas == 0)
  {
  ...
  // Starting from Gen8 - it heals only pokemon which can be healed. In gens
  // 5,6,7 the effect activates anyways.
  ...
  } else if (!(gDisableStructs[battler].spikesDone) && (gSideStatuses[GetBattlerSide(battler)] & SIDE_STATUS_SPIKES) &&
             GetBattlerAbility(battler) != ABILITY_MAGIC_GUARD && IsBattlerAffectedByHazards(battler, FALSE) &&
             IsBattlerGrounded(battler))
  {
    ...
    SetDmgHazardsBattlescript(battler, B_MSG_PKMNHURTBYSPIKES);
             ...
             IsBattlerAffectedByHazards(battler, FALSE) && GetBattlerAbility(battler) != ABILITY_MAGIC_GUARD)
  {
    ...
    if (gBattleMoveDamage != 0)
    {
      SetDmgHazardsBattlescript(battler, B_MSG_STEALTHROCKDMG);
             ...
             (gSideStatuses[GetBattlerSide(battler)] & SIDE_STATUS_TOXIC_SPIKES) && IsBattlerGrounded(battler))
  {
    ...
    {
      if (!(gBattleMons[battler].status1 & STATUS1_ANY) && !IS_BATTLER_OF_TYPE(battler, TYPE_STEEL) &&
          GetBattlerAbility(battler) != ABILITY_IMMUNITY && !IsAbilityOnSide(battler, ABILITY_PASTEL_VEIL) &&
          ...
          !(gFieldStatuses & STATUS_FIELD_MISTY_TERRAIN))
      {
        ...
        gBattlescriptCurrInstr = BattleScript_ToxicSpikesPoisoned;
             ...
             IsBattlerAffectedByHazards(battler, FALSE) && IsBattlerGrounded(battler))
  {
  ...
  } else
  {
    ...
    if (battlerAbility == ABILITY_TRUANT && gCurrentActionFuncId != B_ACTION_USE_MOVE &&
...
static void Cmd_statusanimation(void)
{
  ...
  {
    u32 battler = GetBattlerForBattleScript(cmd->battler);
    if (!(gStatuses3[battler] & STATUS3_SEMI_INVULNERABLE) && gDisableStructs[battler].substituteHP == 0 &&
        !(gHitMarker & (HITMARKER_NO_ANIMATIONS | HITMARKER_DISABLE_ANIMATION)))
    {
...
// Used by Bestow and Symbiosis to take an item from one battler and give to
// another.
static void BestowItem(u32 battlerAtk, u32 battlerDef)
{
  ...
  BtlController_EmitSetMonData(battlerAtk, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0, sizeof(gBattleMons[battlerAtk].item),
                               &gBattleMons[battlerAtk].item);
  MarkBattlerForControllerExec(battlerAtk);
  CheckSetUnburden(battlerAtk);

  gBattleMons[battlerDef].item = gLastUsedItem;
  BtlController_EmitSetMonData(battlerDef, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0, sizeof(gBattleMons[battlerDef].item),
                               &gBattleMons[battlerDef].item);
  MarkBattlerForControllerExec(battlerDef);
  gBattleResources->flags->flags[battlerDef] &= ~RESOURCE_FLAG_UNBURDEN;
}

// Called by Cmd_removeitem. itemId represents the item that was removed, not
// being given.
static bool32 TrySymbiosis(u32 battler, u32 itemId)
{
  if (!gBattleStruct->itemLost[gBattlerPartyIndexes[battler]].stolen &&
      ...
      gCurrentMove != MOVE_FLING  // Fling and damage-reducing berries are
                                  // handled separately.
...
static void Cmd_removeitem(void)
{
  ...
  {
    gBattleStruct
        ->usedHeldItems[gBattlerPartyIndexes[battler]][GetBattlerSide(battler)] = itemId;  // Remember if switched out
  }

  gBattleMons[battler].item = ITEM_NONE;
  CheckSetUnburden(battler);

  BtlController_EmitSetMonData(battler, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0, sizeof(gBattleMons[battler].item),
                               &gBattleMons[battler].item);
  MarkBattlerForControllerExec(battler);
...
static void DrawLevelUpWindow1(void)
{
  ...
  DrawLevelUpWindowPg1(B_WIN_LEVEL_UP_BOX, gBattleResources->beforeLvlUp->stats, currStats, TEXT_DYNAMIC_COLOR_5,
...
static void Cmd_useitemonopponent(void)
{
  ...
  PokemonUseItemEffects(&gEnemyParty[gBattlerPartyIndexes[gBattlerAttacker]], gLastUsedItem,
                        gBattlerPartyIndexes[gBattlerAttacker], 0, TRUE);
  gBattlescriptCurrInstr = cmd->nextInstr;
}
...
static bool32 HasAttackerFaintedTarget(void)
{
  if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT) && gBattleMoves[gCurrentMove].power != 0 &&
      ...
      gBattleStruct->moveTarget[gBattlerAttacker] == gBattlerTarget && gBattlerTarget != gBattlerAttacker &&
      gCurrentTurnActionNumber == GetBattlerTurnOrderNum(gBattlerAttacker) &&
      (gChosenMove == gChosenMoveByBattler[gBattlerAttacker] ||
       gChosenMove == gBattleMons[gBattlerAttacker].moves[gChosenMovePos]))
  {
    return TRUE;
  } else
  {
...
bool32 CanUseLastResort(u8 battler)
{
  ...
  for (i = 0; i < 4; i++)
  {
    ...
    if (i != gCurrMovePos && gDisableStructs[battler].usedMoves & gBitTable[i])  // Increment used move count for all
                                                                                 // moves except current Last Resort.
    {
      usedMovesCount++;
    }
  }
...
bool32 IsShieldsDownProtected(u32 battler)
{
  return (GetBattlerAbility(battler) == ABILITY_SHIELDS_DOWN &&
          GetFormIdFromFormSpeciesId(gBattleMons[battler].species) <
              GetFormIdFromFormSpeciesId(SPECIES_MINIOR_CORE_RED));  // Minior is not in core form
}
...
static void CourtChangeSwapSideStatuses(void)
{
  ...
  // Lucky Chant doesn't exist in gen 8, but seems like it should be affected by
  // Court Change
  ...
  // Change battler IDs of swapped effects. Needed for the correct string when
  // they expire E.g. "Foe's Reflect wore off!"
...
static void HandleScriptMegaPrimalBurst(u32 caseId, u32 battler, u32 type)
{
  ...
  if (caseId == 0)
  {
    ...
    BtlController_EmitSetMonData(battler, BUFFER_A, REQUEST_SPECIES_BATTLE, gBitTable[gBattlerPartyIndexes[battler]],
                                 sizeof(gBattleMons[battler].species), &gBattleMons[battler].species);
    MarkBattlerForControllerExec(battler);
  }
...
// Return True if the order was changed, and false if the order was not
// changed(for example because the target would move after the attacker anyway).
static bool32 ChangeOrderTargetAfterAttacker(void)
{
  u32 i;
...
static void Cmd_various(void)
{
  ...
  switch (cmd->id)
  {
    // Roar will fail in a double wild battle when used by the player against
    // one of the two alive wild mons. Also when an opposing wild mon uses it
    // againt its partner.
    case VARIOUS_JUMP_IF_ROAR_FAILS: {
      VARIOUS_ARGS(const u8* jumpInstr);
      if (WILD_DOUBLE_BATTLE && GetBattlerSide(gBattlerAttacker) == B_SIDE_PLAYER &&
          GetBattlerSide(gBattlerTarget) == B_SIDE_OPPONENT && IS_WHOLE_SIDE_ALIVE(gBattlerTarget))
      {
        gBattlescriptCurrInstr = cmd->jumpInstr;
      } else if (WILD_DOUBLE_BATTLE && GetBattlerSide(gBattlerAttacker) == B_SIDE_OPPONENT &&
    ...
    case VARIOUS_TRY_FRISK: {
      ...
      while (gBattleStruct->friskedBattler < gBattlersCount)
      {
        ...
        if (GetBattlerSide(battler) != GetBattlerSide(gBattlerTarget) && IsBattlerAlive(gBattlerTarget) &&
            gBattleMons[gBattlerTarget].item != ITEM_NONE)
        {
          gLastUsedItem = gBattleMons[gBattlerTarget].item;
    ...
    case VARIOUS_TRACE_ABILITY: {
      VARIOUS_ARGS();
      gBattleMons[battler].ability = gBattleStruct->overwrittenAbilities[battler] = gBattleStruct
                                                                                        ->tracedAbility[battler];
      break;
    }
    ...
    case VARIOUS_CHECK_IF_GRASSY_TERRAIN_HEALS: {
      VARIOUS_ARGS(const u8* failInstr);
      if ((gStatuses3[battler] & (STATUS3_SEMI_INVULNERABLE | STATUS3_HEAL_BLOCK)) || BATTLER_MAX_HP(battler) ||
          !gBattleMons[battler].hp ||
    ...
    case VARIOUS_GRAVITY_ON_AIRBORNE_MONS: {
      VARIOUS_ARGS();
      // Cancel all multiturn moves of IN_AIR Pokemon except those being
      // targeted by Sky Drop.
    ...
    case VARIOUS_SPECTRAL_THIEF: {
      ...
      for (i = STAT_ATK; i < NUM_BATTLE_STATS; i++)
      {
        if (gBattleStruct->stolenStats[0] & gBitTable[i])
        {
          ...
          if (ChangeStatBuffs(GET_STAT_BUFF_VALUE_WITH_SIGN(gBattleScripting.statChanger), i,
    ...
    case VARIOUS_PALACE_FLAVOR_TEXT: {
      ...
      if (!(gBattleStruct->palaceFlags & gBitTable[battler]) &&
          gBattleMons[battler].maxHP / 2 >= gBattleMons[battler].hp && gBattleMons[battler].hp != 0 &&
    ...
    case VARIOUS_SET_TELEPORT_OUTCOME: {
      VARIOUS_ARGS();
      // Don't end the battle if one of the wild mons teleported from the wild
      // double battle and its partner is still alive.
    ...
    case VARIOUS_RESTORE_PP: {
      ...
      for (i = 0; i < 4; i++)
      {
        gBattleMons[battler].pp[i] = CalculatePPWithBonus(gBattleMons[battler].moves[i], gBattleMons[battler].ppBonuses,
                                                          i);
    ...
    case VARIOUS_TRY_ACTIVATE_MOXIE:  // and chilling neigh + as one ice rider
    {
      ...
      if ((battlerAbility == ABILITY_MOXIE || battlerAbility == ABILITY_CHILLING_NEIGH ||
           battlerAbility == ABILITY_AS_ONE_ICE_RIDER) &&
          HasAttackerFaintedTarget() && !NoAliveMonsForEitherParty() &&
    ...
    case VARIOUS_TRY_ACTIVATE_GRIM_NEIGH:  // and as one shadow rider
    {
      ...
      if ((battlerAbility == ABILITY_GRIM_NEIGH || battlerAbility == ABILITY_AS_ONE_SHADOW_RIDER) &&
          HasAttackerFaintedTarget() && !NoAliveMonsForEitherParty() &&
        ...
        {  // Can't copy these abilities.
          ...
          default:
            gBattleStruct->tracedAbility[gBattlerAbility] = gBattleMons[battler]
                                                                .ability;  // re-using the variable for trace
            gBattleScripting.battler = battler;
            BattleScriptPush(cmd->nextInstr);
    ...
    case VARIOUS_TRY_ACTIVATE_BEAST_BOOST: {
      ...
      if (GetBattlerAbility(battler) == ABILITY_BEAST_BOOST && HasAttackerFaintedTarget() &&
          !NoAliveMonsForEitherParty() && CompareStat(gBattlerAttacker, i, MAX_STAT_STAGE, CMP_LESS_THAN))
      {
    ...
    case VARIOUS_TRY_ACTIVATE_SOULHEART: {
      ...
      while (gBattleStruct->soulheartBattlerId < gBattlersCount)
      {
        ...
        if (GetBattlerAbility(gBattleScripting.battler) == ABILITY_SOUL_HEART &&
            IsBattlerAlive(gBattleScripting.battler) && !NoAliveMonsForEitherParty() &&
    ...
    case VARIOUS_TRY_ACTIVATE_FELL_STINGER: {
      ...
      if (gBattleMoves[gCurrentMove].effect == EFFECT_FELL_STINGER && HasAttackerFaintedTarget() &&
          !NoAliveMonsForEitherParty() && CompareStat(gBattlerAttacker, STAT_ATK, MAX_STAT_STAGE, CMP_LESS_THAN))
      {
    ...
    case VARIOUS_TRY_ACTIVATE_SCAVENGER: {
      ...
      // Count the number of fainted Pokémon in this event that have not been
      // processed
    ...
    case VARIOUS_TRY_ACTIVATE_FEAST: {
      ...
      if (GetBattlerAbility(gBattlerAttacker) == ABILITY_FEAST && HasAttackerFaintedTarget() &&
          !NoAliveMonsForEitherParty())
      {
        // Heal 1/2 of max HP
    ...
    case VARIOUS_PLAY_MOVE_ANIMATION: {
      ...
      BtlController_EmitMoveAnimation(battler, BUFFER_A, cmd->move, gBattleScripting.animTurn, 0, 0,
                                      gBattleMons[battler].friendship, &gDisableStructs[battler], gMultiHitCounter);
      MarkBattlerForControllerExec(battler);
      gBattlescriptCurrInstr = cmd->nextInstr;
      return;
    }
      ...
      } else
      {
        ...
        } else
        {
          gBattleMons[gBattlerTarget]
              .ability = gBattleStruct->overwrittenAbilities[gBattlerTarget] = gBattleMons[gBattlerAttacker].ability;
          gBattlescriptCurrInstr = cmd->nextInstr;
        }
      }
      return;
    ...
    case VARIOUS_TRY_QUASH: {
      ...
      if (GetBattlerTurnOrderNum(gBattlerAttacker) >
          GetBattlerTurnOrderNum(gBattlerTarget))  // It's true if foe is faster, has a bigger
                                                   // priority, or switches
      {
        gBattlescriptCurrInstr = cmd->failInstr;  // This replaces the current battlescript with the
                                                  // "fail" script.
      } else  // If the condition is not true, it means we are faster than the
              // foe, so we can set the quash bit
      {
        gProtectStructs[gBattlerTarget].quash = TRUE;
        gBattlescriptCurrInstr = cmd->nextInstr;  // and then we proceed with the rest of our
                                                  // battlescript
      }
      return;
    }
      ...
      for (i = 0; i < NUM_BATTLE_STATS; i++)
      {
        if (gBattleMons[battler].statStages[i] < DEFAULT_STAT_STAGE)  // Negative becomes positive.
        {
          gBattleMons[battler].statStages[i] = DEFAULT_STAT_STAGE +
              (DEFAULT_STAT_STAGE - gBattleMons[battler].statStages[i]);
    ...
    case VARIOUS_TRY_ME_FIRST: {
      ...
      if (IS_MOVE_STATUS(move) || (gBattleMoves[move].banMask & BAN_ME_FIRST) ||
    ...
    case VARIOUS_HANDLE_FORM_CHANGE: {
      ...
      if (cmd->case_ == 0)
      {
        ...
        */
        BtlController_EmitSetMonData(battler, BUFFER_A, REQUEST_SPECIES_BATTLE,
                                     gBitTable[gBattlerPartyIndexes[battler]], sizeof(gBattleMons[battler].species),
                                     &gBattleMons[battler].species);
        MarkBattlerForControllerExec(battler);
      }
      // Change stats.
    ...
    case VARIOUS_TRY_HIT_SWITCH_TARGET: {
      VARIOUS_ARGS(const u8* failInstr);
      if (IsBattlerAlive(gBattlerAttacker) && IsBattlerAlive(gBattlerTarget) &&
          !(gMoveResultFlags & MOVE_RESULT_NO_EFFECT) && TARGET_TURN_DAMAGED &&
    ...
    case VARIOUS_TRY_INSTRUCT: {
      ...
      if (move == MOVE_NONE || move == MOVE_UNAVAILABLE || gBattleMoves[move].effect == EFFECT_RECHARGE ||
          (gBattleMoves[move].banMask & BAN_INSTRUCT) || (gBattleMoves[move].flags2 & FLAG_TWO_TURN) ||
    ...
    case VARIOUS_HANDLE_TRAINER_SLIDE_MSG: {
      ...
      if (cmd->case_ == 0)
      {
        // Save sprite IDs, because trainer slide in will overwrite
        // gBattlerSpriteIds variable.
        gBattleScripting.savedDmg = (gBattlerSpriteIds[battler] & 0xFF) |
            (gBattlerSpriteIds[BATTLE_PARTNER(battler)] << 8);
    ...
    case VARIOUS_EERIE_SPELL_PP_REDUCE: {
      ...
      if (gLastMoves[battler] != 0 && gLastMoves[battler] != 0xFFFF)
      {
        ...
        if (i != MAX_MON_MOVES && gBattleMons[battler].pp[i] != 0)
        {
          ...
          {
            BtlController_EmitSetMonData(battler, BUFFER_A, REQUEST_PPMOVE1_BATTLE + i, 0,
                                         sizeof(gBattleMons[battler].pp[i]), &gBattleMons[battler].pp[i]);
            MarkBattlerForControllerExec(battler);
          }
    ...
    case VARIOUS_JUMP_IF_UNDER_200: {
      VARIOUS_ARGS(const u8* jumpInstr);
      // If the Pokemon is less than 200 kg, or weighing less than 441 lbs, then
      // Sky Drop will work. Otherwise, it will fail.
    ...
    case VARIOUS_SET_SKY_DROP: {
      ...
      /* skyDropTargets holds the information of who is in a particular instance
         of Sky Drop. This is needed in the case that multiple Pokemon use Sky
         Drop in the same turn or if the target of a Sky Drop faints while in
         the air.*/
      gBattleStruct->skyDropTargets[gBattlerAttacker] = gBattlerTarget;
      gBattleStruct->skyDropTargets[gBattlerTarget] = gBattlerAttacker;

      // End any multiturn effects caused by the target except
      ...
      if (gSideTimers[GetBattlerSide(gBattlerTarget)].followmeTimer != 0 &&
    ...
    case VARIOUS_CLEAR_SKY_DROP: {
      VARIOUS_ARGS(const u8* failInstr);
      // Check to see if the initial target of this Sky Drop fainted before the
      // 2nd turn of Sky Drop. If so, make the move fail. If not, clear all of
      // the statuses and continue the move.
      ...
      // Confuse target if they were in the middle of Petal Dance/Outrage/Thrash
      // when targeted.
    ...
    case VARIOUS_SKY_DROP_YAWN:  // If the mon that's sleeping due to Yawn was
                                 // holding a Pokemon in Sky Drop, release the
                                 // target and clear Sky Drop data.
    {
      VARIOUS_ARGS();
      if (gBattleStruct->skyDropTargets[gEffectBattler] != 0xFF && !(gStatuses3[gEffectBattler] & STATUS3_SKY_DROPPED))
      {
        ...
        // If the target was in the middle of Outrage/Thrash/etc. when targeted
        // by Sky Drop, confuse them on release and do proper animation
    ...
    case VARIOUS_GET_ROTOTILLER_TARGETS: {
      VARIOUS_ARGS(const u8* failInstr);
      // Gets the battlers to be affected by rototiller. If there are none,
      // print 'But it failed!'
      {
        u32 count = 0;
        for (i = 0; i < gBattlersCount; i++)
    ...
    case VARIOUS_JUMP_IF_NOT_ROTOTILLER_AFFECTED: {
      ...
      {
        gBattlescriptCurrInstr = cmd->jumpInstr;  // Unaffected by rototiller - print
    ...
    case VARIOUS_TRY_ACTIVATE_BATTLE_BOND: {
      VARIOUS_ARGS();
      if (gBattleMons[gBattlerAttacker].species == SPECIES_GRENINJA_BATTLE_BOND && HasAttackerFaintedTarget() &&
          CalculateBattlerPartyCount(gBattlerTarget) > 1 &&
          !(gBattleStruct->battleBondTransformed[GetBattlerSide(gBattlerAttacker)] &
            gBitTable[gBattlerPartyIndexes[gBattlerAttacker]]))
      {
        gBattleStruct->battleBondTransformed[GetBattlerSide(
            gBattlerAttacker)] |= gBitTable[gBattlerPartyIndexes[gBattlerAttacker]];
        PREPARE_SPECIES_BUFFER(gBattleTextBuff1, gBattleMons[gBattlerAttacker].species);
        gBattleStruct->changedSpecies[GetBattlerSide(gBattlerAttacker)]
                                     [gBattlerPartyIndexes[gBattlerAttacker]] = gBattleMons[gBattlerAttacker].species;
    ...
    case VARIOUS_CONSUME_BERRY: {
      ...
      gBattleScripting.battler = gEffectBattler = gBattlerTarget = battler;  // Cover all berry effect battler cases.
                                                                             // e.g. ChangeStatBuffs uses target ID
    ...
    case VARIOUS_SHELL_SIDE_ARM_CHECK:  // 0% chance GameFreak actually checks
                                        // this way according to DaWobblefet,
                                        // but this is the only functional
                                        // explanation at the moment
    {
      ...
      physical = ((((2 * gBattleMons[gBattlerAttacker].level / 5 + 2) * gBattleMoves[gCurrentMove].power *
                    attackerAtkStat) /
                   targetDefStat) /
                  50);
      ...
      special = ((((2 * gBattleMons[gBattlerAttacker].level / 5 + 2) * gBattleMoves[gCurrentMove].power *
                   attackerSpAtkStat) /
                  targetSpDefStat) /
                 50);
    ...
    case VARIOUS_SET_ATTACKER_STICKY_WEB_USER: {
      VARIOUS_ARGS();
      // For Mirror Armor: "If the Pokémon with this Ability is affected by
      // Sticky Web, the effect is reflected back to the Pokémon which set it
      // up.
      //  If Pokémon which set up Sticky Web is not on the field, no Pokémon
      //  have their Speed lowered."
    ...
    case VARIOUS_CHECK_POLTERGEIST: {
      VARIOUS_ARGS(const u8* failInstr);
      if (gBattleMons[battler].item == ITEM_NONE || gFieldStatuses & STATUS_FIELD_MAGIC_ROOM ||
    ...
    case VARIOUS_CAN_TAR_SHOT_WORK: {
      VARIOUS_ARGS(const u8* failInstr);
      // Tar Shot will fail if it's already been used on the target and its
      // speed can't be lowered further
    ...
    case VARIOUS_CURE_CERTAIN_STATUSES: {
      ...
      if (gBattleMons[battler].status2 & STATUS2_INFATUATION)
      {
        ...
        gBattleCommunication[MULTISTRING_CHOOSER] =
            B_MSG_MENTALHERBCURE_INFATUATION;  // STRINGID_TARGETGOTOVERINFATUATION
    ...
    case VARIOUS_TRY_REVIVAL_BLESSING: {
      ...
      if (gSelectedMonPartyId != PARTY_SIZE)
      {
        ...
        BtlController_EmitSetMonData(gBattlerAttacker, BUFFER_A, REQUEST_HP_BATTLE, gBitTable[gSelectedMonPartyId],
                                     sizeof(hp), &hp);
        MarkBattlerForControllerExec(gBattlerAttacker);
      ...
      {
        BtlController_EmitChoosePokemon(gBattlerAttacker, BUFFER_A, PARTY_ACTION_CHOOSE_FAINTED_MON, PARTY_SIZE,
                                        ABILITY_NONE, gBattleStruct->battlerPartyOrders[gBattlerAttacker]);
        MarkBattlerForControllerExec(gBattlerAttacker);
      }
      return;
    }
...
static void Cmd_setprotectlike(void)
{
  ...
  if (lastMove == MOVE_UNAVAILABLE || !(gBattleMoves[lastMove].flags & FLAG_PROTECT_BASED))
  {
...
static void Cmd_setatkhptozero(void)
{
  ...
  BtlController_EmitSetMonData(gBattlerAttacker, BUFFER_A, REQUEST_HP_BATTLE, 0,
...
static void Cmd_trysetrest(void)
{
  ...
  } else
  {
    ...
    BtlController_EmitSetMonData(gBattlerTarget, BUFFER_A, REQUEST_STATUS_BATTLE, 0,
                                 sizeof(gBattleMons[gBattlerTarget].status1), &gBattleMons[gBattlerTarget].status1);
    MarkBattlerForControllerExec(gBattlerTarget);
    gBattlescriptCurrInstr = cmd->nextInstr;
  }
}
...
static void Cmd_stockpile(void)
{
  ...
  switch (cmd->id)
  {
    ...
    case 1:  // Save def/sp def stats.
      if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
      {
        gDisableStructs[gBattlerAttacker].stockpileDef += gBattleMons[gBattlerAttacker].statStages[STAT_DEF] -
            gDisableStructs[gBattlerAttacker].stockpileBeforeDef;
        gDisableStructs[gBattlerAttacker].stockpileSpDef += gBattleMons[gBattlerAttacker].statStages[STAT_SPDEF] -
...
static u32 ChangeStatBuffs(s8 statValue, u32 statId, u32 flags, const u8* BS_ptr)
{
  ...
  } else if (battlerAbility == ABILITY_SIMPLE)
  {
    statValue = (SET_STAT_BUFF_VALUE(GET_STAT_BUFF_VALUE(statValue) * 2)) |
        ((statValue <= -1) ? STAT_BUFF_NEGATIVE : 0);
  }
  ...
  {
    if (gSideTimers[GetBattlerSide(battler)].mistTimer && !certain && gCurrentMove != MOVE_CURSE &&
                ...
                (battlerAbility == ABILITY_BIG_PECKS && statId == STAT_DEF)))
    {
      ...
      return STAT_CHANGE_DIDNT_WORK;
    } else if (battlerAbility == ABILITY_MIRROR_ARMOR && !affectsUser && !mirrorArmored &&
               gBattlerAttacker != gBattlerTarget && battler == gBattlerTarget)
    {
      if (flags == STAT_CHANGE_ALLOW_PTR)
      {
    ...
    } else  // try to decrease
    {
      ...
      } else
      {
        ...
        gBattleCommunication[MULTISTRING_CHOOSER] = (gBattlerTarget == battler);  // B_MSG_ATTACKER_STAT_FELL or
    ...
    } else
    {
      ...
      for (index = 0; index < gBattlersCount; index++)
      {
        ...
        if (GetBattlerAbility(index) == ABILITY_OPPORTUNIST &&
            gProtectStructs[battler].activateOpportunist == 0)  // don't activate opportunist on other mon's opportunist
                                                                // raises
        {
          gProtectStructs[index].activateOpportunist = 2;  // set stats to copy
          gQueuedStatBoosts[index].stats |= (1 << (statId - 1));  // -1 to start at atk
          gQueuedStatBoosts[index]
              .statChanges[statId - 1] += statValue;  // cumulative in case of multiple opponent boosts
...
static void Cmd_statbuffchange(void)
{
  ...
  if (ChangeStatBuffs(GET_STAT_BUFF_VALUE_WITH_SIGN(gBattleScripting.statChanger),
                      GET_STAT_BUFF_ID(gBattleScripting.statChanger), flags, failInstr) == STAT_CHANGE_WORKED)
  {
    gBattlescriptCurrInstr = cmd->nextInstr;
...
static void Cmd_forcerandomswitch(void)
{
  ...
  // Red card checks against wild pokemon. If we have reached here, the player
  // has a mon to switch into Red card swaps attacker with target to get the
  // animation correct, so here we check attacker which is really the target.
  // Thanks GF...
      ...
      GetBattlerSide(gBattlerAttacker) == B_SIDE_OPPONENT)  // Check opponent's red card activating
  {
    ...
    } else
    {
      ...
      {
        // Player has only one mon alive -> force red card switch before
        // manually switching to other mon
  ...
  // trainer battles
  // wild double battles when an opposing pokemon uses it against one of the two
  // alive player mons wild double battle when a player pokemon uses it against
  // its partner
  if ((gBattleTypeFlags & BATTLE_TYPE_TRAINER) ||
      (WILD_DOUBLE_BATTLE && GetBattlerSide(gBattlerAttacker) == B_SIDE_OPPONENT &&
       GetBattlerSide(gBattlerTarget) == B_SIDE_PLAYER && IS_WHOLE_SIDE_ALIVE(gBattlerTarget)) ||
      (WILD_DOUBLE_BATTLE && GetBattlerSide(gBattlerAttacker) == B_SIDE_PLAYER &&
      ...
      redCardForcedSwitch)
  {
    ...
    } else
    {
      firstMonId = 0;
      lastMonId = PARTY_SIZE;
      battler2PartyId = gBattlerPartyIndexes[gBattlerTarget];  // there is only one pokemon
                                                               // out in single battles
    ...
    {
      if (GetMonData(&party[i], MON_DATA_SPECIES) != SPECIES_NONE && !GetMonData(&party[i], MON_DATA_IS_EGG) &&
          GetMonData(&party[i], MON_DATA_HP) != 0 && i != battler1PartyId && i != battler2PartyId)
      {
    ...
    } else
    {
      ...
      *(gBattleStruct->monToSwitchIntoId +
        gBattlerTarget) = validMons[RandomUniform(RNG_FORCE_RANDOM_SWITCH, 0, validMonsCount - 1)];
  ...
  {
    // In normal wild doubles, Roar will always fail if the user's level is less
    // than the target's.
...
static void Cmd_tryKO(void)
{
  ...
  } else
  {
    if ((((gStatuses3[gBattlerTarget] & STATUS3_ALWAYS_HITS) &&
          gDisableStructs[gBattlerTarget].battlerWithSureHit == gBattlerAttacker) ||
         GetBattlerAbility(gBattlerAttacker) == ABILITY_NO_GUARD || targetAbility == ABILITY_NO_GUARD) &&
    ...
    } else
    {
      u16 odds = gBattleMoves[gCurrentMove].accuracy +
          (gBattleMons[gBattlerAttacker].level - gBattleMons[gBattlerTarget].level);
      if (B_SHEER_COLD_ACC >= GEN_7 && gCurrentMove == MOVE_SHEER_COLD &&
  ...
  if (IsBattlerAlive(gBattlerAttacker) && WEATHER_HAS_EFFECT && ability != ABILITY_MAGIC_GUARD)
  {
    if (gBattleWeather & B_WEATHER_SANDSTORM)
    {
      if (!IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_ROCK) && !IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_GROUND) &&
          !IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_STEEL) && ability != ABILITY_SAND_VEIL &&
          ability != ABILITY_SAND_FORCE && ability != ABILITY_SAND_RUSH && ability != ABILITY_OVERCOAT &&
    ...
    {
      if (ability == ABILITY_ICE_BODY && !(gStatuses3[gBattlerAttacker] & (STATUS3_UNDERGROUND | STATUS3_UNDERWATER)) &&
          !BATTLER_MAX_HP(gBattlerAttacker) && !(gStatuses3[gBattlerAttacker] & STATUS3_HEAL_BLOCK))
      {
        gBattlerAbility = gBattlerAttacker;
        gBattleMoveDamage = GetNonDynamaxMaxHP(gBattlerAttacker) / 16;
        if (gBattleMoveDamage == 0)
        ...
        gBattleMoveDamage *= -1;
      } else if (!IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_ICE) && ability != ABILITY_SNOW_CLOAK &&
                 ability != ABILITY_OVERCOAT && ability != ABILITY_ICE_BODY &&
                 !(gStatuses3[gBattlerAttacker] & (STATUS3_UNDERGROUND | STATUS3_UNDERWATER)) &&
                 GetBattlerHoldEffect(gBattlerAttacker, TRUE) != HOLD_EFFECT_SAFETY_GOGGLES)
      {
        gBattleMoveDamage = GetNonDynamaxMaxHP(gBattlerAttacker) / 16;
    ...
    {
      if (!(ability == ABILITY_IMMUNITY) && !IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_POISON) &&
...
static void Cmd_setfocusenergy(void)
{
  ...
  if ((gBattleMoves[gCurrentMove].effect == EFFECT_DRAGON_CHEER &&
       (!(gBattleTypeFlags & BATTLE_TYPE_DOUBLE) || (gAbsentBattlerFlags & gBitTable[gBattlerTarget]))) ||
      gBattleMons[gBattlerTarget].status2 & STATUS2_FOCUS_ENERGY_ANY)
  {
    gMoveResultFlags |= MOVE_RESULT_FAILED;
    gBattleCommunication[MULTISTRING_CHOOSER] = B_MSG_FOCUS_ENERGY_FAILED;
  } else if (gBattleMoves[gCurrentMove].effect == EFFECT_DRAGON_CHEER &&
             !IS_BATTLER_OF_TYPE(gBattlerTarget, TYPE_DRAGON))
  {
...
static void Cmd_setsubstitute(void)
{
  ...
  {
    gBattleMoveDamage = GetNonDynamaxMaxHP(gBattlerAttacker) /
        factor;  // one bit value will only work for Pokémon which max hp can
                 // go to 1020(which is more than possible in games)
    if (gBattleMoveDamage == 0)
    {
      gBattleMoveDamage = 1;
    }
...
static void Cmd_mimicattackcopy(void)
{
  ...
  if ((gBattleMoves[gLastMoves[gBattlerTarget]].banMask & BAN_MIMIC) ||
      (gBattleMons[gBattlerAttacker].status2 & STATUS2_TRANSFORMED) || gLastMoves[gBattlerTarget] == MOVE_NONE ||
...
{
  return (gBattleMoves[move].effect == EFFECT_PLACEHOLDER) || (gBattleMoves[move].banMask & BAN_METRONOME);
}
...
static void Cmd_disablelastusedattack(void)
{
  ...
  if (gDisableStructs[gBattlerTarget].disabledMove == MOVE_NONE && i != MAX_MON_MOVES &&
...
static void Cmd_trysetencore(void)
{
  ...
  if ((gBattleMoves[gLastMoves[gBattlerTarget]].banMask & BAN_ENCORE) || gLastMoves[gBattlerTarget] == MOVE_NONE ||
      gLastMoves[gBattlerTarget] == MOVE_UNAVAILABLE)
  {
    i = MAX_MON_MOVES;
  }

  if (gDisableStructs[gBattlerTarget].encoredMove == MOVE_NONE && i != MAX_MON_MOVES &&
      gBattleMons[gBattlerTarget].pp[i] != 0)
  {
...
static void Cmd_settypetorandomresistance(void)
{
  ...
  {
    gBattlescriptCurrInstr = cmd->failInstr;
  } else if ((gBattleMoves[gLastLandedMoves[gBattlerAttacker]].flags2 & FLAG_TWO_TURN) &&
  ...
  } else
  {
    ...
    while (resistTypes != 0)
    {
      ...
      if (resistTypes & gBitTable[i])
      {
        ...
        {
          resistTypes &= ~(gBitTable[i]);  // Type resists, but the user is
...
static void Cmd_copymovepermanently(void)
{
  ...
  if (!(gBattleMons[gBattlerAttacker].status2 & STATUS2_TRANSFORMED) &&
      ...
      !(gBattleMoves[gLastPrintedMoves[gBattlerTarget]].banMask & BAN_SKETCH))
  {
    s32 i;
    ...
    } else  // sketch worked
    {
      ...
      BtlController_EmitSetMonData(gBattlerAttacker, BUFFER_A, REQUEST_MOVES_PP_BATTLE, 0, sizeof(movePpData),
                                   &movePpData);
      MarkBattlerForControllerExec(gBattlerAttacker);
...
static void Cmd_trychoosesleeptalkmove(void)
{
  ...
  for (i = 0; i < MAX_MON_MOVES; i++)
  {
    if ((gBattleMoves[gBattleMons[gBattlerAttacker].moves[i]].banMask & BAN_SLEEP_TALK) ||
        (gBattleMoves[gBattleMons[gBattlerAttacker].moves[i]].flags2 & FLAG_TWO_TURN))
    {
...
static void Cmd_tryspiteppreduce(void)
{
  ...
  if (gLastMoves[gBattlerTarget] != MOVE_NONE && gLastMoves[gBattlerTarget] != MOVE_UNAVAILABLE)
  {
    ...
    if (i != MAX_MON_MOVES && gBattleMons[gBattlerTarget].pp[i] > (B_CAN_SPITE_FAIL >= GEN_4 ? 0 : 1))
    {
      ...
      {
        BtlController_EmitSetMonData(gBattlerTarget, BUFFER_A, REQUEST_PPMOVE1_BATTLE + i, 0,
                                     sizeof(gBattleMons[gBattlerTarget].pp[i]), &gBattleMons[gBattlerTarget].pp[i]);
        MarkBattlerForControllerExec(gBattlerTarget);
      }
  ...
  if (gCurrentMove == MOVE_HEAL_BELL)
  {
    ...
    for (i = 0; i < PARTY_SIZE; i++)
    {
      ...
      if (species != SPECIES_NONE && species != SPECIES_EGG)
      {
        ...
        } else if (gBattleTypeFlags & BATTLE_TYPE_DOUBLE && gBattlerPartyIndexes[battler] == i &&
                   !(gAbsentBattlerFlags & gBitTable[battler]))
        {
...
static void Cmd_handlefurycutter(void)
{
  ...
  } else
  {
    if (gDisableStructs[gBattlerAttacker].furyCutterCounter != 5 &&
        gSpecialStatuses[gBattlerAttacker].parentalBondState !=
            PARENTAL_BOND_1ST_HIT)  // Don't increment counter on first hit
    {
...
static void Cmd_copyfoestats(void)
{
  ...
  gBattlescriptCurrInstr = cmd->nextInstr;  // Has an unused jump ptr(possibly
                                            // for a failed attempt) parameter.
}
...
static void Cmd_setstickyweb(void)
{
  ...
  } else
  {
    ...
    gSideTimers[targetSide].stickyWebBattlerSide = GetBattlerSide(gBattlerAttacker);  // For Court Change/Defiant - set
                                                                                      // this to the user's side
...
static void Cmd_trymemento(void)
{
  ...
  if (B_MEMENTO_FAIL >= GEN_4 &&
      (gBattleCommunication[MISS_TYPE] == B_MSG_PROTECTED || gStatuses3[gBattlerTarget] & STATUS3_SEMI_INVULNERABLE ||
       IsBattlerProtected(gBattlerTarget, gCurrentMove) ||
       DoesSubstituteBlockMove(gBattlerAttacker, gBattlerTarget, gCurrentMove)))
  {
    // Failed, target was protected.
    gBattlescriptCurrInstr = cmd->failInstr;
  } else if (B_MEMENTO_FAIL < GEN_4 && gBattleMons[gBattlerTarget].statStages[STAT_ATK] == MIN_STAT_STAGE &&
...
static void Cmd_setforcedtarget(void)
{
  ...
  gSideTimers[GetBattlerSide(gBattlerTarget)].followmeTarget = gBattlerTarget;
  gSideTimers[GetBattlerSide(gBattlerTarget)].followmePowder = (gBattleMoves[gCurrentMove].flags & FLAG_POWDER_BASED);
  gBattlescriptCurrInstr = cmd->nextInstr;
}
...
static void Cmd_cureifburnedparalysedorpoisoned(void)
{
  ...
  if (gBattleMons[gBattlerAttacker].status1 &
      (STATUS1_POISON | STATUS1_BURN | STATUS1_PARALYSIS | STATUS1_TOXIC_POISON | STATUS1_FROSTBITE))
  {
    gBattleMons[gBattlerAttacker].status1 = 0;
    gBattlescriptCurrInstr = cmd->nextInstr;
    BtlController_EmitSetMonData(gBattlerAttacker, BUFFER_A, REQUEST_STATUS_BATTLE, 0,
                                 sizeof(gBattleMons[gBattlerAttacker].status1), &gBattleMons[gBattlerAttacker].status1);
    MarkBattlerForControllerExec(gBattlerAttacker);
  } else
  {
    gBattlescriptCurrInstr = cmd->failInstr;
...
static void Cmd_settaunt(void)
{
  ...
  } else if (gDisableStructs[gBattlerTarget].tauntTimer == 0)
  {
    ...
    if (B_TAUNT_TURNS >= GEN_5)
    {
      ...
      {
        turns--;  // If the target hasn't yet moved this turn, Taunt lasts for
                  // only three turns (source: Bulbapedia)
      }
...
static void Cmd_tryswapitems(void)
{
  ...
  if (gBattleTypeFlags & BATTLE_TYPE_TRAINER_HILL ||
      (GetBattlerSide(gBattlerAttacker) == B_SIDE_OPPONENT &&
       !(gBattleTypeFlags &
         (BATTLE_TYPE_LINK | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_FRONTIER | BATTLE_TYPE_SECRET_BASE |
          BATTLE_TYPE_RECORDED_LINK | (B_TRAINERS_KNOCK_OFF_ITEMS == TRUE ? BATTLE_TYPE_TRAINER : 0)))))
  {
    gBattlescriptCurrInstr = cmd->failInstr;
  } else
  {
    ...
    else
    {
      ...
      *newItemAtk = gBattleMons[gBattlerTarget].item;
      ...
      BtlController_EmitSetMonData(gBattlerAttacker, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0, sizeof(*newItemAtk),
                                   newItemAtk);
      MarkBattlerForControllerExec(gBattlerAttacker);

      BtlController_EmitSetMonData(gBattlerTarget, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0,
                                   sizeof(gBattleMons[gBattlerTarget].item), &gBattleMons[gBattlerTarget].item);
      MarkBattlerForControllerExec(gBattlerTarget);
      ...
      {
        // if targeting your own side and you aren't in a multi battle, don't
        // save items as stolen
        if (GetBattlerSide(gBattlerAttacker) == B_SIDE_PLAYER)
        {
...
static void Cmd_trycopyability(void)
{
  ...
  if (gBattleMons[battler].ability == defAbility || defAbility == ABILITY_NONE ||
      IsRolePlayBannedAbilityAtk(gBattleMons[battler].ability) || IsRolePlayBannedAbility(defAbility))
  {
    gBattlescriptCurrInstr = cmd->failInstr;
  } else
  {
  ...
  switch (cmd->turnNumber)
  {
    ...
    case 1:  // heal effect
      PREPARE_MON_NICK_WITH_PREFIX_BUFFER(gBattleTextBuff1, gBattlerTarget,
                                          gWishFutureKnock.wishPartyId[gBattlerTarget])
      if (B_WISH_HP_SOURCE >= GEN_5)
      {
        if (GetBattlerSide(gBattlerTarget) == B_SIDE_PLAYER)
        {
          gBattleMoveDamage = max(1,
                                  GetMonData(&gPlayerParty[gWishFutureKnock.wishPartyId[gBattlerTarget]],
                                             MON_DATA_MAX_HP) /
                                      2);
        } else
        {
          gBattleMoveDamage = max(1,
                                  GetMonData(&gEnemyParty[gWishFutureKnock.wishPartyId[gBattlerTarget]],
                                             MON_DATA_MAX_HP) /
                                      2);
        }
      } else
...
static void Cmd_setyawn(void)
{
  ...
  {
    // When Yawn is used while Electric Terrain is set and drowsiness is set
    // from Yawn being used against target in the previous turn: "But it failed"
    // will display first.
    gBattlescriptCurrInstr = BattleScript_ElectricTerrainPrevents;
  } else if (IsBattlerTerrainAffected(gBattlerTarget, STATUS_FIELD_MISTY_TERRAIN))
  {
    // When Yawn is used while Misty Terrain is set and drowsiness is set from
    // Yawn being used against target in the previous turn: "But it failed" will
    // display first.
    gBattlescriptCurrInstr = BattleScript_MistyTerrainPrevents;
  } else
  {
  ...
  } else
  {
    ...
    } else
    {
      ...
      gBattleMons[gBattlerAttacker]
          .ability = gBattleStruct->overwrittenAbilities[gBattlerAttacker] = gBattleMons[gBattlerTarget].ability;
...
static void Cmd_tryimprison(void)
{
  ...
  } else
  {
    ...
    if (battler == gBattlersCount)  // In Generation 3 games, Imprison fails if the user
  ...
  if (validMoves != NULL)
  {
    ...
    for (monId = 0; monId < PARTY_SIZE; monId++)
    {
      ...
      for (moveId = 0; moveId < MAX_MON_MOVES; moveId++)
      {
        ...
        if (gBattleMoves[move].banMask & BAN_ASSIST)
        {
          continue;
        }
    ...
    switch (GetBattlerAbility(battler))
    {
      ...
      case ABILITY_REGENERATOR:
        ...
        BtlController_EmitSetMonData(battler, BUFFER_A, REQUEST_HP_BATTLE,
                                     gBitTable[*(gBattleStruct->battlerPartyIndexes + battler)],
                                     sizeof(gBattleMoveDamage), &gBattleMoveDamage);
        MarkBattlerForControllerExec(battler);
        break;
    }
...
static void Cmd_pickup(void)
{
  ...
  if (!InBattlePike())  // No items in Battle Pike.
  {
    for (i = 0; i < PARTY_SIZE; i++)
    {
      ...
      lvlDivBy10 = (GetMonData(&gPlayerParty[i], MON_DATA_LEVEL) - 1) / 10;  // Moving this here makes it easier to add
                                                                             // in abilities like Honey Gather.
      if (lvlDivBy10 > 9)
      {
        lvlDivBy10 = 9;
      }
...
bool32 DoesSubstituteBlockMove(u32 battlerAtk, u32 battlerDef, u32 move)
{
  ...
  {
    return FALSE;
  } else if (gBattleMoves[move].flags & FLAG_IGNORES_SUBSTITUTE)
  {
    return FALSE;
...
bool32 DoesDisguiseBlockMove(u32 battlerAtk, u32 battlerDef, u32 move)
{
  if (gBattleMons[battlerDef].species != SPECIES_MIMIKYU_DISGUISED ||
      ...
      gHitMarker & HITMARKER_IGNORE_DISGUISE || GetBattlerAbility(battlerDef) != ABILITY_DISGUISE)
  {
    return FALSE;
  } else
  {
...
static void Cmd_tryrecycleitem(void)
{
  ...
  usedHeldItem = &gBattleStruct
                      ->usedHeldItems[gBattlerPartyIndexes[gBattlerAttacker]][GetBattlerSide(gBattlerAttacker)];
  if (*usedHeldItem != ITEM_NONE && gBattleMons[gBattlerAttacker].item == ITEM_NONE)
  {
    ...
    *usedHeldItem = ITEM_NONE;
    ...
    BtlController_EmitSetMonData(gBattlerAttacker, BUFFER_A, REQUEST_HELDITEM_BATTLE, 0,
                                 sizeof(gBattleMons[gBattlerAttacker].item), &gBattleMons[gBattlerAttacker].item);
    MarkBattlerForControllerExec(gBattlerAttacker);
...
static void Cmd_removelightscreenreflect(void)
{
  ...
  {
    side = GetBattlerSide(gBattlerTarget);  // From Gen 4 onwards, Brick Break can remove screens
                                            // on the user's side if used on an ally
  } else
  {
...
static void Cmd_handleballthrow(void)
{
  ...
  } else
  {
    ...
    } else
    {
      switch (gLastUsedItem)
      {
        ...
        case ITEM_NEST_BALL:
          ...
          {
            //((41 - Pokémon's level) ÷ 10)× if Pokémon's level is between 1 and
            // 29, 1× otherwise.
        ...
        case ITEM_MOON_BALL: {
          ...
          for (i = 0; i < evoCount; i++)
          {
            ...
            if (evo.method == EVO_ITEM && evo.param == ITEM_MOON_STONE)
            {
              ballMultiplier = 400;
            }
          }
    ...
    // catchRate is unsigned, which means that it may potentially overflow if
    // sum is applied directly.
    ...
    {
      BtlController_EmitBallThrowAnim(gBattlerAttacker, BUFFER_A,
                                      Rogue_UseSafariBattle() ? BALL_1_SHAKE : BALL_3_SHAKES_SUCCESS);
      MarkBattlerForControllerExec(gBattlerAttacker);
...
static void Cmd_givecaughtmon(void)
{
  ...
  gBattleResults.caughtMonSpecies = GetMonData(&gEnemyParty[gBattlerPartyIndexes[GetCatchingBattler()]],
  ...
  gBattleResults.caughtMonBall = GetMonData(&gEnemyParty[gBattlerPartyIndexes[GetCatchingBattler()]], MON_DATA_POKEBALL,
                                            NULL);
...
static void Cmd_displaydexinfo(void)
{
  ...
  switch (gBattleCommunication[0])
  {
    ...
    case 1:
      ...
      {
        FreeAllWindowBuffers();
        gBattleCommunication[TASK_ID] = DisplayCaughtMonDexPage(species, gBattleMons[GetCatchingBattler()].otId,
...
static const u16 sTelekinesisBanList[] = {
    SPECIES_DIGLETT,   SPECIES_DUGTRIO,   SPECIES_DIGLETT_ALOLAN, SPECIES_DUGTRIO_ALOLAN,
    SPECIES_SANDYGAST, SPECIES_PALOSSAND, SPECIES_GENGAR_MEGA,
};
...
static void Cmd_settelekinesis(void)
{
  ...
  if (gStatuses3[gBattlerTarget] & (STATUS3_TELEKINESIS | STATUS3_ROOTED | STATUS3_SMACKED_DOWN) ||
      gFieldStatuses & STATUS_FIELD_GRAVITY || IsTelekinesisBannedSpecies(gBattleMons[gBattlerTarget].species))
  {
    gBattlescriptCurrInstr = cmd->failInstr;
  } else
  {
...
bool32 IsMoveAffectedByParentalBond(u32 move, u32 battler)
{
  if (move != MOVE_NONE && move != MOVE_UNAVAILABLE && move != MOVE_STRUGGLE &&
      !(gBattleMoves[move].banMask & BAN_PARENTAL_BOND) && gBattleMoves[move].split != SPLIT_STATUS &&
      !IsMultiHitMove(move))
  {
    if (gBattleTypeFlags & BATTLE_TYPE_DOUBLE)
    {
...
void BS_CheckParentalBondCounter(void)
{
  ...
  // Some effects should only happen on the first or second strike of Parental
  // Bond, so a way to check this in battle scripts is useful
...
{
  NATIVE_ARGS();
  // called by Bestow, Fling, and Bug Bite, which don't work with
  // Cmd_removeitem.
...
void ApplyExperienceMultipliers(s32* expAmount, u8 expGetterMonId, u8 faintedBattler)
{
  ...
  if (CheckBagHasItem(ITEM_EXP_CHARM,
                      1))  // is also for other exp boosting Powers if/when implemented
  {
    *expAmount = (*expAmount * 150) / 100;
  }
  ...
  if (B_SCALED_EXP >= GEN_5 && B_SCALED_EXP != GEN_6)
  {
    // Note: There is an edge case where if a pokemon receives a large amount of
    // exp, it wouldn't be properly calculated
    //       because of multiplying by scaling factor(the value would simply be
    //       larger than an u32 can hold). Hence u64 is needed.
    u64 value = *expAmount;
  ...
  } else
  {
    ...
    if (gBattleStruct->itemPartyIndex[gBattlerAttacker] == gBattlerPartyIndexes[gBattlerAttacker])
    {
      battler = gBattlerAttacker;
               ...
               gBattleStruct->itemPartyIndex[gBattlerAttacker] ==
                   gBattlerPartyIndexes[BATTLE_PARTNER(gBattlerAttacker)])
    {
    ...
    gBattleScripting.battler = battler;
    PREPARE_SPECIES_BUFFER(gBattleTextBuff1,
                           GetMonData(&party[gBattleStruct->itemPartyIndex[gBattlerAttacker]], MON_DATA_SPECIES));
...
void BS_ItemCureStatus(void)
{
  ...
  if (!HealStatusConditions(&party[gBattleStruct->itemPartyIndex[gBattlerAttacker]], GetItemStatus1Mask(gLastUsedItem),
                            battler))
  {
    statusChanged = TRUE;
...
void BS_ItemRestorePP(void)
{
  ...
  u32 battler = MAX_BATTLERS_COUNT;
  struct Pokemon* mon = (GetBattlerSide(gBattlerAttacker) == B_SIDE_PLAYER)
      ? &gPlayerParty[gBattleStruct->itemPartyIndex[gBattlerAttacker]]
      : &gEnemyParty[gBattleStruct->itemPartyIndex[gBattlerAttacker]];
...
void BS_SetPledge(void)
{
  ...
  if (gBattleStruct->pledgeMove)
  {
    ...
    gBattleCommunication[MSG_DISPLAY] = 0;
  } else if ((gChosenActionByBattler[partner] == B_ACTION_USE_MOVE) && gBattleTypeFlags & BATTLE_TYPE_DOUBLE &&
             IsBattlerAlive(partner) && gCurrentMove != partnerMove &&
...
void BS_TryHealPulse(void)
{
  ...
  } else
  {
    if (GetBattlerAbility(gBattlerAttacker) == ABILITY_MEGA_LAUNCHER &&
        (gBattleMoves[gCurrentMove].flags & FLAG_LAUNCHER_BASED))
    {
      gBattleMoveDamage = -(GetNonDynamaxMaxHP(gBattlerTarget) * 75 / 100);
    } else if (gFieldStatuses & STATUS_FIELD_GRASSY_TERRAIN &&
               gBattleMoves[gCurrentMove].argument == MOVE_EFFECT_FLORAL_HEALING)
    {
...
void BS_TryCopycat(void)
{
  ...
  if (gLastUsedMove == MOVE_NONE || gLastUsedMove == MOVE_UNAVAILABLE ||
      (gBattleMoves[gLastUsedMove].banMask & BAN_COPYCAT))
  {
    gBattlescriptCurrInstr = cmd->failInstr;
  } else
  {
...
void BS_TryUpperHand(void)
{
  ...
  if (GetBattlerTurnOrderNum(gBattlerAttacker) > GetBattlerTurnOrderNum(gBattlerTarget) ||
      gChosenMoveByBattler[gBattlerTarget] == MOVE_NONE || IS_MOVE_STATUS(gChosenMoveByBattler[gBattlerTarget]) ||
      GetChosenMovePriority(gBattlerTarget) < 1 ||
      GetChosenMovePriority(gBattlerTarget) > 3)  // Fails if priority is less than 1 or greater than 3, if target
                                                  // already moved, or if using a status
  {
    gBattlescriptCurrInstr = cmd->failInstr;
  } else
  {
...
void BS_SetPhotonGeyserCategory(void)
{
  ...
  if (!(gBattleMoves[gCurrentMove].effect == EFFECT_TERA_BLAST && !IsTerastallized(gBattlerAttacker)) &&
      !(gBattleMoves[gCurrentMove].effect == EFFECT_TERA_STARSTORM &&
