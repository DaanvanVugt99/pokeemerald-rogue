...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_ACID_RAIN, B_WEATHER_ACID_RAIN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, B_WEATHER_STRONG_WINDS, ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_ACID_RAIN, B_WEATHER_ACID_RAIN},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, B_WEATHER_STRONG_WINDS},
...
static const struct FormChange sMagearnaOriginalColorFormChangeTable[] = {
