...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        #else
            .abilities = { ABILITY_TORRENT, ABILITY_VITAL_SPIRIT, ABILITY_DEFIANT },
        #endif
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_SWARM, ABILITY_SHED_SKIN, ABILITY_RUN_AWAY },
...
#define WORMADAM_MISC_INFO(secondAbility)                                       \
        .catchRate = 45,                                                        \
        .expYield = 148,                                                        \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                       \
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },                          \
        .abilities = { ABILITY_ANTICIPATION, secondAbility, ABILITY_OVERCOAT }, \
    ...
    {
        WORMADAM_MISC_INFO(ABILITY_SHIELD_DUST),
        .baseHP        = 60,
        .baseAttack    = 50,
        .baseDefense   = 90,
        .baseSpeed     = 30,
    ...
    {
        WORMADAM_MISC_INFO(ABILITY_ROUGH_SKIN),
        .baseHP        = 80,
        .baseAttack    = 85,
        .baseDefense   = 105,
        .baseSpeed     = 36,
    ...
    {
        WORMADAM_MISC_INFO(ABILITY_WONDER_SKIN),
        .baseHP        = 80,
        .baseAttack    = 72,
        .baseDefense   = 95,
        .baseSpeed     = 36,
...
#define GASTRODON_MISC_INFO                                                             \
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_WIND_RIDER, ABILITY_UNBURDEN, ABILITY_FLARE_BOOST },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define LUCARIO_MISC_INFO                                       \
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_GRASS },
        .abilities = { ABILITY_GRASS_PELT, ABILITY_NONE, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_WHITE,
...
#define ROTOM_MISC_INFO                                             \
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_CURSED_BODY },
        .expYield = 154,
        .description = POKEDEX_DESC_STRING(
...
#define ROTOM_APPLIANCE_INFO(form)                                  \
    ...
    [SPECIES_ROTOM_HEAT] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_FLASH_FIRE },
    ...
    [SPECIES_ROTOM_WASH] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_WATER_ABSORB },
        .noFlip = TRUE,
    ...
    [SPECIES_ROTOM_FROST] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_SNOW_WARNING },
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_GRASSY_SURGE },
