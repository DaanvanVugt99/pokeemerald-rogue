...
#define TYPHLOSION_MISC_INFO                                            \
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_INSOMNIA, ABILITY_GALE_WINGS, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BROWN,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_OVERCOAT, ABILITY_COTTON_DOWN },
        .bodyColor = BODY_COLOR_WHITE,
...
#define QWILFISH_MISC_INFO(defense, specialAttack)                                      \
        .baseHP        = 65,                                                            \
        .baseAttack    = 95,                                                            \
        .baseDefense   = defense,                                                       \
        .baseSpeed     = 85,                                                            \
        .baseSpAttack  = specialAttack,                                                 \
        .baseSpDefense = 55,                                                            \
        .catchRate = 45,                                                                \
        .expYield = 88,                                                                 \
        .evYield_Attack = 1,                                                            \
    ...
    [SPECIES_QWILFISH] =
    {
        QWILFISH_MISC_INFO(P_UPDATED_STATS >= GEN_7 ? 95 : 85, 45),
    ...
    {
        QWILFISH_MISC_INFO(P_UPDATED_STATS >= GEN_7 ? 85 : 75, 55),
