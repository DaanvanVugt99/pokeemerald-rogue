...
#define SAMUROTT_MISC_INFO                                                  \
    ...
    [SPECIES_GIGALITH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = { ABILITY_STURDY, ABILITY_STAMINA, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define DARMANITAN_GALARIAN_MISC_INFO                                           \
    ...
    [SPECIES_MARACTUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_ROUGH_SKIN, ABILITY_SEED_SOWER },
        .bodyColor = BODY_COLOR_GREEN,
...
#define STUNFISK_MISC_INFO                                          \
    ...
    [SPECIES_STUNFISK_GALARIAN] =
    {
        ...
        .types = { TYPE_GROUND, TYPE_STEEL },
        .friendship = STANDARD_FRIENDSHIP,
        .abilities = { ABILITY_MIMICRY, ABILITY_DRY_SKIN, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        .weight = 205,
        .description = POKEDEX_DESC_STRING(
