...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
    {
        ...
        [MOVE_TWISTER] = _("Twister"),
        [MOVE_RAIN_DANCE] = _("Rain Dance"),
        [MOVE_CORROSIVE_CLOUDS] = _("CorrosClouds"),
        [MOVE_SUNNY_DAY] = _("Sunny Day"),
        [MOVE_CRUNCH] = _("Crunch"),
        [MOVE_MIRROR_COAT] = _("Mirror Coat"),
        [MOVE_PSYCH_UP] = _("Psych Up"),
...
const u8 *const gZMoveNames[] =
    {
        ...
        [MOVE_ALL_OUT_PUMMELING -
            FIRST_Z_MOVE] = sText_All_Out_Pummeling,
        [MOVE_SUPERSONIC_SKYSTRIKE -
            FIRST_Z_MOVE] = sText_Supersonic_Skystrike,
        [MOVE_ACID_DOWNPOUR -
            FIRST_Z_MOVE] = sText_Acid_Downpour,
        [MOVE_TECTONIC_RAGE -
            FIRST_Z_MOVE] = sText_Tectonic_Rage,
        [MOVE_CONTINENTAL_CRUSH -
            FIRST_Z_MOVE] = sText_Continental_Crush,
        [MOVE_SAVAGE_SPIN_OUT -
            FIRST_Z_MOVE] = sText_Savage_Spin_Out,
        [MOVE_NEVER_ENDING_NIGHTMARE -
            FIRST_Z_MOVE] = sText_Never_Ending_Nightmare,
        [MOVE_CORKSCREW_CRASH -
            FIRST_Z_MOVE] = sText_Corkscrew_Crash,
        [MOVE_INFERNO_OVERDRIVE -
            FIRST_Z_MOVE] = sText_Inferno_Overdrive,
        [MOVE_HYDRO_VORTEX -
            FIRST_Z_MOVE] = sText_Hydro_Vortex,
        [MOVE_BLOOM_DOOM -
            FIRST_Z_MOVE] = sText_Bloom_Doom,
        [MOVE_GIGAVOLT_HAVOC -
            FIRST_Z_MOVE] = sText_Gigavolt_Havoc,
        [MOVE_SHATTERED_PSYCHE -
            FIRST_Z_MOVE] = sText_Shattered_Psyche,
        [MOVE_SUBZERO_SLAMMER -
            FIRST_Z_MOVE] = sText_Subzero_Slammer,
        [MOVE_DEVASTATING_DRAKE -
            FIRST_Z_MOVE] = sText_Devastating_Drake,
        [MOVE_BLACK_HOLE_ECLIPSE -
            FIRST_Z_MOVE] = sText_Black_Hole_Eclipse,
        [MOVE_TWINKLE_TACKLE -
            FIRST_Z_MOVE] = sText_Twinkle_Tackle,
        [MOVE_CATASTROPIKA -
            FIRST_Z_MOVE] = sText_Catastropika,
        [MOVE_10000000_VOLT_THUNDERBOLT -
            FIRST_Z_MOVE] = sText_10000000_Volt_Thunderbolt,
        [MOVE_STOKED_SPARKSURFER -
            FIRST_Z_MOVE] = sText_Stoked_Sparksurfer,
        [MOVE_EXTREME_EVOBOOST -
            FIRST_Z_MOVE] = sText_Extreme_Evoboost,
        [MOVE_PULVERIZING_PANCAKE -
            FIRST_Z_MOVE] = sText_Pulverizing_Pancake,
        [MOVE_GENESIS_SUPERNOVA -
            FIRST_Z_MOVE] = sText_Genesis_Supernova,
        [MOVE_SINISTER_ARROW_RAID -
            FIRST_Z_MOVE] = sText_Sinister_Arrow_Raid,
        [MOVE_MALICIOUS_MOONSAULT -
            FIRST_Z_MOVE] = sText_Malicious_Moonsault,
        [MOVE_OCEANIC_OPERETTA -
            FIRST_Z_MOVE] = sText_Oceanic_Operetta,
        [MOVE_SPLINTERED_STORMSHARDS -
            FIRST_Z_MOVE] = sText_Splintered_Stormshards,
        [MOVE_LETS_SNUGGLE_FOREVER -
            FIRST_Z_MOVE] = sText_Lets_Snuggle_Forever,
        [MOVE_CLANGOROUS_SOULBLAZE -
            FIRST_Z_MOVE] = sText_Clangorous_Soulblaze,
        [MOVE_GUARDIAN_OF_ALOLA -
            FIRST_Z_MOVE] = sText_Guardian_Of_Alola,
        [MOVE_SEARING_SUNRAZE_SMASH -
            FIRST_Z_MOVE] = sText_Searing_Sunraze_Smash,
        [MOVE_MENACING_MOONRAZE_MAELSTROM -
            FIRST_Z_MOVE] = sText_Menacing_Moonraze_Maelstrom,
        [MOVE_LIGHT_THAT_BURNS_THE_SKY -
            FIRST_Z_MOVE] = sText_Light_That_Burns_The_Sky,
        [MOVE_SOUL_STEALING_7_STAR_STRIKE -
            FIRST_Z_MOVE] = sText_Soul_Stealing_7_Star_Strike,
};
...
const u8 *const gMaxMoveNames[] =
    {
        ...
        [MOVE_MAX_STRIKE -
            FIRST_MAX_MOVE] = sText_Max_Strike,
        [MOVE_MAX_KNUCKLE -
            FIRST_MAX_MOVE] = sText_Max_Knuckle,
        [MOVE_MAX_AIRSTREAM -
            FIRST_MAX_MOVE] = sText_Max_Airstream,
        [MOVE_MAX_OOZE -
            FIRST_MAX_MOVE] = sText_Max_Ooze,
        [MOVE_MAX_QUAKE -
            FIRST_MAX_MOVE] = sText_Max_Quake,
        [MOVE_MAX_ROCKFALL -
            FIRST_MAX_MOVE] = sText_Max_Rockfall,
        [MOVE_MAX_FLUTTERBY -
            FIRST_MAX_MOVE] = sText_Max_Flutterby,
        [MOVE_MAX_PHANTASM -
            FIRST_MAX_MOVE] = sText_Max_Phantasm,
        [MOVE_MAX_STEELSPIKE -
            FIRST_MAX_MOVE] = sText_Max_Steelspike,
        [MOVE_MAX_FLARE -
            FIRST_MAX_MOVE] = sText_Max_Flare,
        [MOVE_MAX_GEYSER -
            FIRST_MAX_MOVE] = sText_Max_Geyser,
        [MOVE_MAX_OVERGROWTH -
            FIRST_MAX_MOVE] = sText_Max_Overgrowth,
        [MOVE_MAX_LIGHTNING -
            FIRST_MAX_MOVE] = sText_Max_Lightning,
        [MOVE_MAX_HAILSTORM -
            FIRST_MAX_MOVE] = sText_Max_Hailstorm,
        [MOVE_MAX_MINDSTORM -
            FIRST_MAX_MOVE] = sText_Max_Mindstorm,
        [MOVE_MAX_WYRMWIND -
            FIRST_MAX_MOVE] = sText_Max_Wyrmwind,
        [MOVE_MAX_DARKNESS -
            FIRST_MAX_MOVE] = sText_Max_Darkness,
        [MOVE_MAX_STARFALL -
            FIRST_MAX_MOVE] = sText_Max_Starfall,
        [MOVE_G_MAX_VINE_LASH -
            FIRST_MAX_MOVE] = sText_G_Max_Vine_Lash,
        [MOVE_G_MAX_WILDFIRE -
            FIRST_MAX_MOVE] = sText_G_Max_Wildfire,
        [MOVE_G_MAX_CANNONADE -
            FIRST_MAX_MOVE] = sText_G_Max_Cannonade,
        [MOVE_G_MAX_BEFUDDLE -
            FIRST_MAX_MOVE] = sText_G_Max_Befuddle,
        [MOVE_G_MAX_VOLT_CRASH -
            FIRST_MAX_MOVE] = sText_G_Max_Volt_Crash,
        [MOVE_G_MAX_GOLD_RUSH -
            FIRST_MAX_MOVE] = sText_G_Max_Gold_Rush,
        [MOVE_G_MAX_CHI_STRIKE -
            FIRST_MAX_MOVE] = sText_G_Max_Chi_Strike,
        [MOVE_G_MAX_TERROR -
            FIRST_MAX_MOVE] = sText_G_Max_Terror,
        [MOVE_G_MAX_FOAM_BURST -
            FIRST_MAX_MOVE] = sText_G_Max_Foam_Burst,
        [MOVE_G_MAX_RESONANCE -
            FIRST_MAX_MOVE] = sText_G_Max_Resonance,
        [MOVE_G_MAX_CUDDLE -
            FIRST_MAX_MOVE] = sText_G_Max_Cuddle,
        [MOVE_G_MAX_REPLENISH -
            FIRST_MAX_MOVE] = sText_G_Max_Replenish,
        [MOVE_G_MAX_MALODOR -
            FIRST_MAX_MOVE] = sText_G_Max_Malodor,
        [MOVE_G_MAX_MELTDOWN -
            FIRST_MAX_MOVE] = sText_G_Max_Meltdown,
        [MOVE_G_MAX_DRUM_SOLO -
            FIRST_MAX_MOVE] = sText_G_Max_Drum_Solo,
        [MOVE_G_MAX_FIREBALL -
            FIRST_MAX_MOVE] = sText_G_Max_Fireball,
        [MOVE_G_MAX_HYDROSNIPE -
            FIRST_MAX_MOVE] = sText_G_Max_Hydrosnipe,
        [MOVE_G_MAX_WIND_RAGE -
            FIRST_MAX_MOVE] = sText_G_Max_Wind_Rage,
        [MOVE_G_MAX_GRAVITAS -
            FIRST_MAX_MOVE] = sText_G_Max_Gravitas,
        [MOVE_G_MAX_STONESURGE -
            FIRST_MAX_MOVE] = sText_G_Max_Stonesurge,
        [MOVE_G_MAX_VOLCALITH -
            FIRST_MAX_MOVE] = sText_G_Max_Volcalith,
        [MOVE_G_MAX_TARTNESS -
            FIRST_MAX_MOVE] = sText_G_Max_Tartness,
        [MOVE_G_MAX_SWEETNESS -
            FIRST_MAX_MOVE] = sText_G_Max_Sweetness,
        [MOVE_G_MAX_SANDBLAST -
            FIRST_MAX_MOVE] = sText_G_Max_Sandblast,
        [MOVE_G_MAX_STUN_SHOCK -
            FIRST_MAX_MOVE] = sText_G_Max_Stun_Shock,
        [MOVE_G_MAX_CENTIFERNO -
            FIRST_MAX_MOVE] = sText_G_Max_Centiferno,
        [MOVE_G_MAX_SMITE -
            FIRST_MAX_MOVE] = sText_G_Max_Smite,
        [MOVE_G_MAX_SNOOZE -
            FIRST_MAX_MOVE] = sText_G_Max_Snooze,
        [MOVE_G_MAX_FINALE -
            FIRST_MAX_MOVE] = sText_G_Max_Finale,
        [MOVE_G_MAX_STEELSURGE -
            FIRST_MAX_MOVE] = sText_G_Max_Steelsurge,
        [MOVE_G_MAX_DEPLETION -
            FIRST_MAX_MOVE] = sText_G_Max_Depletion,
        [MOVE_G_MAX_ONE_BLOW -
            FIRST_MAX_MOVE] = sText_G_Max_One_Blow,
        [MOVE_G_MAX_RAPID_FLOW -
            FIRST_MAX_MOVE] = sText_G_Max_Rapid_Flow,
};
