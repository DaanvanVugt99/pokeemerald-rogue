...
static const u8 sTemporalLockDescription[] = _("First Roar of Time each battle uses a random time move.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_TEMPORAL_LOCK] = _("Time Rift"),
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_IRON_WILL] = _("Iron Will"),
    [ABILITY_TEMPORAL_LOCK] = _("TimeRift"),
