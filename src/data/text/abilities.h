...
static const u8 sUpdraftDescription[] = _("First Fire move on switch-in also uses Tailwind.");
static const u8 sRootsnareDescription[] = _("First Grass move on switch-in also uses Smack Down.");
static const u8 sShellFormationDescription[] = _("First Water move on switch-in also uses Iron Defense.");
