...
static const u8 sVerdantHavenDescription[] = _("The first healing move also uses Leech Seed.");
static const u8 sEruptionDescription[] = _("The first Fire move also uses Smokescreen.");
static const u8 sDeathRollDescription[] = _("The first biting move also traps the target.");
