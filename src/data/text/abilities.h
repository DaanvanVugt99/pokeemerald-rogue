...
static const u8 sWebTrapDescription[] = _("When lowering a target's Speed, uses a random web move.");
...
static const u8 sWorkCrewDescription[] = _("First Ground move each switch-in also uses a random work move.");
