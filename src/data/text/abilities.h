...
static const u8 sStenchDescription[] = _("May switch foe on contact.");
...
static const u8 sHugePowerDescription[] = _("Doubles highest offensive stat.");
...
static const u8 sChlorofumesDescription[] = _("Grass-type moves lower attack\nand during sun apply poison.");
