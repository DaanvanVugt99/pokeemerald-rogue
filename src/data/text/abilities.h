...
static const u8 sTerritorialDescription[] = _("Deal double damage to targets affected by terrain.");
...
static const u8 sMultitaskDescription[] = _("After using a status move, also use a 30 BP Confusion.");
...
static const u8 sFinalLessonDescription[] = _("Using a status move lets the next Water/Fighting move bypass protection and barriers.");
...
static const u8 sEncoreAriaDescription[] = _("First sound move each switch-in also uses Encore.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_FINAL_LESSON] = sFinalLessonDescription,
    ...
    [ABILITY_ENCORE_ARIA] = sEncoreAriaDescription,
