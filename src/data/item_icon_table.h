const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_ACID_ROCK] = {gItemIcon_DampRock, gItemIconPalette_DampRock},
    [ITEM_DIM_ROCK] = {gItemIcon_HeatRock, gItemIconPalette_HeatRock},
    // Terrain Seeds
    ...
    [ITEM_ROTTEN_BERRY] = {gItemIcon_SitrusBerry, gItemIconPalette_SitrusBerry},
