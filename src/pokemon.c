...
static const u16 sUniqueAbilityBySpecies[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_MR_MIME_GALARIAN] = ABILITY_IMPROV,
    [SPECIES_MR_RIME] = ABILITY_IMPROV,
    ...
    [SPECIES_ZIGZAGOON_GALARIAN] = ABILITY_SWITCHSTEP,
    [SPECIES_LINOONE_GALARIAN] = ABILITY_SWITCHSTEP,
    [SPECIES_OBSTAGOON] = ABILITY_SWITCHSTEP,
