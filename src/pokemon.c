...
static const u16 sUniqueAbilityBySpecies[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_NIDORAN_F] = ABILITY_MATRIARCHY,
    [SPECIES_NIDORINA] = ABILITY_MATRIARCHY,
    [SPECIES_NIDOQUEEN] = ABILITY_MATRIARCHY,

    [SPECIES_NIDORAN_M] = ABILITY_PATRIARCHY,
    [SPECIES_NIDORINO] = ABILITY_PATRIARCHY,
    [SPECIES_NIDOKING] = ABILITY_PATRIARCHY,
    ...
    [SPECIES_KELDEO] = ABILITY_FINAL_LESSON,
    [SPECIES_KELDEO_RESOLUTE] = ABILITY_FINAL_LESSON,
    ...
    [SPECIES_MELOETTA_ARIA] = ABILITY_ENCORE_ARIA,
    [SPECIES_MELOETTA_PIROUETTE] = ABILITY_ENCORE_ARIA,
