...
static const u16 sUniqueAbilityBySpecies[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_CHARMANDER] = ABILITY_DRACONIC,
    [SPECIES_CHARMELEON] = ABILITY_DRACONIC,
    [SPECIES_CHARIZARD] = ABILITY_DRACONIC,
    [SPECIES_SQUIRTLE] = ABILITY_PRESSURE_SHELL,
    [SPECIES_WARTORTLE] = ABILITY_PRESSURE_SHELL,
    [SPECIES_BLASTOISE] = ABILITY_PRESSURE_SHELL,
    ...
    [SPECIES_EKANS] = ABILITY_AMBUSH,
    [SPECIES_ARBOK] = ABILITY_AMBUSH,
    ...
    [SPECIES_MEOWTH] = ABILITY_FATAL_GRACE,
    [SPECIES_PERSIAN] = ABILITY_FATAL_GRACE,
