...
static const u16 sUniqueAbilityBySpecies[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_WEEDLE] = ABILITY_VENOM_RUSH,
    [SPECIES_KAKUNA] = ABILITY_VENOM_RUSH,
    [SPECIES_BEEDRILL] = ABILITY_VENOM_RUSH,
    [SPECIES_BEEDRILL_MEGA] = ABILITY_VENOM_RUSH,
    ...
    [SPECIES_CHINGLING] = ABILITY_INSIGHT,
    [SPECIES_CHIMECHO] = ABILITY_INSIGHT,
