...
const u32 gBattleAnimSpritePal_EclipseRay[] = INCBIN_U32("graphics/battle_anims/sprites/eclipse_ray.gbapal.lz");
...
const u32 gSummaryPage_InfoAbilityExpanded_Tilemap[] = INCBIN_U32("graphics/summary_screen/page_info_ability_expanded.bin.lz");
...
const u32 gSummaryPage_UniqueAbility_Tilemap[] = INCBIN_U32("graphics/summary_screen/page_unique_ability.bin.lz");
