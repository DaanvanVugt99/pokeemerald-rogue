...
static const u8 sText_HoldEffectAcidRock[] = _("Acid Rock");
static const u8 sText_HoldEffectDimRock[] = _("Dim Rock");
...
static const u8 *const sHoldEffectNames[] =
{
    ...
    [HOLD_EFFECT_ACID_ROCK] = sText_HoldEffectAcidRock,
    [HOLD_EFFECT_DIM_ROCK] = sText_HoldEffectDimRock,
